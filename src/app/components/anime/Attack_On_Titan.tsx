...
const ANIME_SLUG = "attack_on_titan";
...
const THEME: ThemeTokens = {
  ...
  btnPrimary:     'bg-[#4B5563] text-white hover:bg-[#374151]',
  btnOutline:     'border-white/20 text-white hover:bg-white/5',
  itemBg:         'bg-white/5 border-white/10',
  itemBgAnswered: 'bg-[#4B5563]/20 border-[#4B5563]/40',
  ratingSelected: 'bg-[#4B5563] text-white scale-105 shadow-lg shadow-gray-900/50',
  ratingDefault:  'bg-white/10 text-white hover:bg-white/20',
  ...
  'Introduction':                                         '/images/Characters/Attack_On_Titan/anka_rheinberger.png',
  'Machiavellianism':                                     '/images/Characters/Attack_On_Titan/annie_leonhart.png',
  'Narcissism':                                           '/images/Characters/Attack_On_Titan/armin_arlelt.png',
  'Psychopathy':                                          '/images/Characters/Attack_On_Titan/bertholdt_hoover.png',
  'Sadism':                                               '/images/Characters/Attack_On_Titan/boris_feulner.png',
  'BFI-2-XS: Extraversion & Agreeableness':              '/images/Attack_On_Titan/AoT_Berthold_Hoover.png',
  'Conscientiousness, Neuroticism & Openness':            '/images/Attack_On_Titan/AoT_Colossal_Titan.png',
  'UPPS-P Impulsivity':                                   '/images/Attack_On_Titan/AoT_Connie_Springer.png',
  'Need for Cognition (NFC-18)':                          '/images/Attack_On_Titan/AoT_Dot_Pixis.png',
  'Maladaptive Daydreaming (MDS-16)':                     '/images/Attack_On_Titan/AoT_Eren_Yeager.png',
  'Cognitive Emotion Regulation (CERQ)':                  '/images/Attack_On_Titan/AoT_Erwin_Smith_and_Levy_Ackerman.png',
  'Psychological Pain Scale (PPS-13)':                    '/images/Attack_On_Titan/AoT_Erwin_Smith.png',
  'Depression & Stress (DASS-21)':                        '/images/Attack_On_Titan/AoT_Hange_Zoe.png',
  'Anxiety & Insomnia (DASS-21 + ISI)':                   '/images/Attack_On_Titan/AoT_Hannes.png',
  'Self-Esteem & Life Satisfaction (RSES + SWLS)':        '/images/Attack_On_Titan/AoT_Levy_Ackerman.png',
  'Anhedonia (SHAPS-14)':                                 '/images/Attack_On_Titan/AoT_Jean_Kirstein.png',
  'Multidimensional State Boredom (MSBM)':                '/images/Attack_On_Titan/AoT_Survey_Corps.png',
  'Basic Psychological Needs (BPNS)':                     '/images/Attack_On_Titan/AoT_Wall_Rose.png',
  'Social Media & Smartphone Addiction (BSMAS + SAS-SV)': '/images/Attack_On_Titan/AoT_Wings_of_Freedom.png',
  'Gaming Addiction & Emotion Regulation (GAS-7 + ERQ)':  '/images/Attack_On_Titan/AoT_Hitch_Dreyse.png',
  'Anime Addiction Scale (CLC)':                          '/images/Attack_On_Titan/AoT_Mikasa_Eren_Levy.png',
  'Heartland Forgiveness Scale (HFS)':                    '/images/Attack_On_Titan/AoT_Zeke_Yeager.png',
  'Self-Compassion Scale (SCS-SF)':                       '/images/Attack_On_Titan/AoT_Ymir.png',
  'Compassion for Others (CS)':                           '/images/Attack_On_Titan/AoT_Reiner_Braun.png',
  'Brief COPE (28 items)':                                '/images/Attack_On_Titan/AoT_Pieck_Finger.png',
  'Self-Expansion, Self-Suppression & Financial Stress':  '/images/Attack_On_Titan/AoT_Marco_Bodt.png',
  'Benevolent Childhood Experiences (BCE)':               '/images/Attack_On_Titan/AoT_Historia_Reiss.png',
  'Hikikomori & Social Avoidance Scale':                  '/images/Attack_On_Titan/AoT_Attack_Titan.png',
  'Need to Belong (NTB)':                                 '/images/Attack_On_Titan/AoT_Colossal_Titan.png',
  'Anime Story World Engagement (ASWE)':                  '/images/Attack_On_Titan/AoT_Armin_Arlerlt_Adult.png',
  'Narrative Identity in Anime (NISE-20)':                '/images/Attack_On_Titan/AoT_Mikasa_Eren_Levy.png',
};

export const AoT_IMAGES: Record<number, string> = {
0:"/images/Attack_On_Titan/AOT_1.png",
1:"/images/Attack_On_Titan/AoT_Armin_Arlerlt_Adult.png",
2:"/images/Attack_On_Titan/AoT_Assault.png",
3:"/images/Attack_On_Titan/AoT_Annie_Leonhardt.png",
4:"/images/Attack_On_Titan/AoT_Armin_Arlerlt.png",
5:"/images/Attack_On_Titan/AoT_Armored_Titan.png",
6:"/images/Attack_On_Titan/AoT_Attack_Titan.png",
7:"/images/Attack_On_Titan/AoT_Berthold_Hoover.png",
8:"/images/Attack_On_Titan/AoT_Colossal_Titan.png",
9:"/images/Characters/Attack_On_Titan/conny_springer.png",
10:"/images/Characters/Attack_On_Titan/dot_pyxis.png",
11:"/images/Attack_On_Titan/AoT_Eren_Yeager.png",
12:"/images/Attack_On_Titan/AoT_Erwin_Smith_and_Levy_Ackerman.png",
13:"/images/Characters/Attack_On_Titan/erwin_smith.png",
14:"/images/Attack_On_Titan/AoT_Hange_Zoe.png",
15:"/images/Characters/Attack_On_Titan/grisha_yeager.png",
16:"/images/Characters/Attack_On_Titan/historia_reiss.png",
17:"/images/Characters/Attack_On_Titan/hitch_dreyse.png",
18:"/images/Characters/Attack_On_Titan/jean_kirchstein.png",
19:"/images/Characters/Attack_On_Titan/kenny_ackermann.png",
20:"/images/Characters/Attack_On_Titan/levi_ackermann.png",
21:"/images/Characters/Attack_On_Titan/lara_tybur.png",
22:"/images/Attack_On_Titan/AoT_Armored_Titan.png",
23:"/images/Characters/Attack_On_Titan/miche-zacharius.png",
24:"/images/Characters/Attack_On_Titan/mikasa_ackermann.png",
25:"/images/Attack_On_Titan/AoT_Colossal_Titan.png",
26:"/images/Characters/Attack_On_Titan/pieck_finger.png",
27:"/images/Characters/Attack_On_Titan/porco_galliard.png",
28:"/images/Attack_On_Titan/AoT_Reiner_Braun.png",
29:"/images/Attack_On_Titan/AoT_Attack_Titan.png",
30:"/images/Attack_On_Titan/AoT_Wall_Rose.png",
31:"/images/Attack_On_Titan/Aot_Wings_Of_Freedom.png",
32:"/images/Attack_On_Titan/Aot_Ymir.png",
33:"/images/Characters/Attack_On_Titan/kiyomi_azumabito.png",
34:"/images/Characters/Attack_On_Titan/rico_brzenska.png",
35:"/images/Attack_On_Titan/AoT_Mikasa_Eren_Levy.png",
36:"/images/Characters/Attack_On_Titan/erwin_smith.png",
};


const FALLBACK_IMAGE = '/images/Attack_On_Titan/AoT_Levy_Ackerman.png';
function getEpisodeImage(title: string): string {
  const match = title.match(/\d+/);
  if (!match) return FALLBACK_IMAGE;
  const episodeNumber = Number(match[0]);
  return AoT_IMAGES[episodeNumber] ?? FALLBACK_IMAGE;
}
...
// ── Likert-uri reutilizabile (identice ca la Naruto) ────────────────────
...
const L6_INSTA: LikertConfig = {min:1, max:6, step:1, type:"buttons", values:[
  {value:1, label:"Never"},{value:2, label:"Rarely"},{value:3, label:"Occasionally"},{value:4, label:"Often"},{value:5, label:"Very often"},{value:6, label:"Always"}
]};
const L6_RAD: LikertConfig = {min:0, max:6, step:1, type:"buttons", values:[
  {value:0, label:"Does not describe me at all"},{value:1, label:"1"},{value:2, label:"2"},{value:3, label:"Describe me somewhat"},{value:4, label:"4"},{value:5, label:"5"},{value:6, label:"Describes me very well"}
]};
...
const CATALOG: Arc[] = [
  {
    ...
    episodes: [
      ...
      },
      {
        ...
        subscales: [
          {
            label: 'Night of Disbanding Ceremony',
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items: [
      ...
      },
      {
        ...
        subscales: [
          {
            label: 'A Dull Glow in the Midst of Despair',
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items: [
      ...
      },
      {
        ...
        subscales: [
          {
            label:"The World that the Girl Saw",
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items:[
  ...
  {
    title:"Arc 2 - What is takes to be a ninja",
     episodes: [
  
      {
        ...
        subscales: [
          {
            label:"The Beating of a Heart can be Heard",
  ...
  {
    title:"Arc 3 - First Hokage mission",
     episodes: [
      {
        title:"Episode 18",
        subscales:[{
          label:"Still Can't See",
          items:[
      ...
      },
      {
        title:"Episode 19",
        subscales:[{
          label:"Special Operations Squad",
          items:[
      ...
      },
      {
        title:"Episode 21",
        subscales:[{
          label:"Long-Distance Enemy Scouting Formation",
          items:[
  ...
  {
   title:"Arc 4 - Loose Ends on the Ninja way",
     episodes: [
  ...
  {
   title:"Arc 5 - Master and Apprentice",
     episodes: [
  ...
  interface AttackOnTitanQuizProps {
  onFinish: (sessionId: string) => void;
  onBack: () => void;
  demographics?: DemographicPayload;
}

export default function Attack_On_Titan({ onFinish, onBack, demographics }: AttackOnTitanQuizProps) {
