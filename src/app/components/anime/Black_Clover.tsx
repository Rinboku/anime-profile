...
const THEME: ThemeTokens = {
  ...
  text:           'text-[#E5C158]',
  subText:        'text-[#D2C4B1]',
  btnPrimary:     'bg-[#E5C158] text-black font-bold hover:bg-[#c9a647]',
  btnOutline:     'border-[#E5C158]/20 text-[#E5C158] hover:bg-[#E5C158]/10',
  itemBg:         'bg-[#E5C158]/5 border-[#E5C158]/10',
  itemBgAnswered: 'bg-[#E5C158]/20 border-[#E5C158]/40',
  ratingSelected: 'bg-[#E5C158] text-black font-bold scale-105 shadow-lg shadow-yellow-600/30',
  ratingDefault:  'bg-[#E5C158]/10 text-[#E5C158] hover:bg-[#E5C158]/20',
  headerBorder:   'border-[#E5C158]/10',
  footerBorder:   'border-[#E5C158]/10',
  labelColor:     'text-[#E5C158]',
  accentColor:    '#E5C158',
  ...
  'Introduction':                                         '/images/Black_Clover/BC_Alecdora_Sandler.png',
  'Machiavellianism':                                     '/images/Black_Clover/BC_Asta.png',
  'Narcissism':                                           '/images/Black_Clover/BC_Charlotte_Roselei.png',
  'Psychopathy':                                          '/images/Black_Clover/BC_Charmy_Pappitson.png',
  'Sadism':                                               '/images/Black_Clover/BC_David_Swallow.png',
  'BFI-2-XS: Extraversion & Agreeableness':               '/images/Black_Clover/BC_Finral_Roulacasse.png',
  'Conscientiousness, Neuroticism & Openness':            '/images/Black_Clover/BC_Fuegoleon_Silva.png',
  'UPPS-P Impulsivity':                                   '/images/Black_Clover/BC_Gauche.png',
  'Need for Cognition (NFC-18)':                          '/images/Black_Clover/BC_Gordon_Agrippa.png',
  'Maladaptive Daydreaming (MDS-16)':                     '/images/Black_Clover/BC_Grey_Whiteley.png',
  'Cognitive Emotion Regulation (CERQ)':                  '/images/Black_Clover/BC_Hamon_Caseus.png',
  'Psychological Pain Scale (PPS-13)':                    '/images/Black_Clover/BC_Henry_Legolant.png',
  'Depression & Stress (DASS-21)':                        '/images/Black_Clover/BC_Jack_The_Ripper.png',
  'Anxiety & Insomnia (DASS-21 + ISI)':                   '/images/Black_Clover/BC_Kaiser_Granvorka.png',
  'Self-Esteem & Life Satisfaction (RSES + SWLS)':        '/images/Black_Clover/BC_Klaus_Lunettes.png',
  'Anhedonia (SHAPS-14)':                                 '/images/Black_Clover/BC_Langris_Vaude.png',
  'Multidimensional State Boredom (MSBM)':                '/images/Black_Clover/BC_Leopold_Vermillion.png',
  'Basic Psychological Needs (BPNS)':                     '/images/Black_Clover/BC_Letoille_Becquerel.png',
  'Social Media & Smartphone Addiction (BSMAS + SAS-SV)': '/images/Black_Clover/BC_Luck_Voltia.png',
  'Gaming Addiction & Emotion Regulation (GAS-7 + ERQ)':  '/images/Black_Clover/BC_Magna_Swing.png',
  'Anime Addiction Scale (CLC)':                          '/images/Black_Clover/BC_Mereoleona_Vermillion.png',
  'Heartland Forgiveness Scale (HFS)':                    '/images/Black_Clover/BC_Mimosa_Vermillion.png',
  'Self-Compassion Scale (SCS-SF)':                       '/images/Black_Clover/BC_Nacht_Faust.png',
  'Compassion for Others (CS)':                           '/images/Black_Clover/BC_Nebra_Silva.png',
  'Brief COPE (28 items)':                                '/images/Black_Clover/BC_Noelle_Silva.png',
  'Self-Expansion, Self-Suppression & Financial Stress':  '/images/Black_Clover/BC_Nozel_Silva.png',
  'Benevolent Childhood Experiences (BCE)':               '/images/Black_Clover/BC_Secre_Swallowtail.png',
  'Hikikomori & Social Avoidance Scale':                  '/images/Black_Clover/BC_Sekke_Bronzzazza.png',
  'Need to Belong (NTB)':                                 '/images/Black_Clover/BC_Vanessa_Enoteca.png',
  'Anime Story World Engagement (ASWE)':                  '/images/Black_Clover/BC_William_Vengeance.png',
  'Narrative Identity in Anime (NISE-20)':                '/images/Black_Clover/BC_Yami_Sukehiro.png',
};

export const Black_Clover_IMAGES: Record<number, string> = {
0:"/images/Black_Clover/BC_Mimosa_Vermillion.png",
1:"/images/Black_Clover/BC_Nebra_Silva.png",
2: "/images/Black_Clover/BC_Alecdora_Sandler.png",
3:"/images/Black_Clover/BC_Asta.png",
4:"/images/Black_Clover/BC_Charlotte_Roselei.png",
5:"/images/Black_Clover/BC_Charmy_Pappitson.png",
6:"/images/Black_Clover/BC_David_Swallow.png",
7:"/images/Black_Clover/BC_Finral_Roulacase.png",
8:"/images/Black_Clover/BC_Fuegoleon_Silva.png",
9:"/images/Black_Clover/BC_Gauche.png",
10:"/images/Black_Clover/BC_Gordon_Agrippa.png",
11:"/images/Black_Clover/BC_Grey_Whiteley.png",
12:"/images/Black_Clover/BC_Hamon_Caseus.png",
13:"/images/Black_Clover/BC_Henry_Legolant.png",
14:"/images/Black_Clover/BC_Jack_the_Ripper.png",
15:"/images/Black_Clover/BC_Kaiser_Granvorka.png",
16:"/images/Black_Clover/BC_Klaus_Lunettes.png",
17:"/images/Black_Clover/BC_Langris_Vaude.png",
18:"/images/Black_Clover/BC_Leopold_Vermillion.png",
19:"/images/Black_Clover/BC_Letoile_Becquerel.png",
20:"/images/Black_Clover/BC_Luck_Voltia.png",
21:"/images/Black_Clover/BC_Magna_Swing.png",
22:"/images/Black_Clover/BC_Mereoleona_Vermillion.png",
23:"/images/Black_Clover/BC_Mimosa_Vermillion.png",
24:"/images/Black_Clover/BC_Nacht_Faust.png",
25:"/images/Black_Clover/BC_Nebra_Silva.png",
26:"/images/Black_Clover/BC_Noelle_Silva.png",
27:"/images/Black_Clover/BC_Nozel_Silva.png",
28:"/images/Black_Clover/BC_Secre_Swallowtail.png",
29:"/images/Black_Clover/BC_Sekke_Bronzzazza.png",
30:"/images/Black_Clover/BC_Siren_Tium.png",
31:"/images/Black_Clover/BC_Solid_Silva.png",
32:"/images/Black_Clover/BC_Vanessa_Enoteca.png",
33:"/images/Black_Clover/BC_William_Vangeance.png",
34:"/images/Black_Clover/BC_Yami_Sukehiro.png",
35:"/images/Black_Clover/BC_Yuno_Grinberryal.png",
36:"/images/Black_Clover/BC_Zora_Ideale.png"
}

const FALLBACK_IMAGE = '/images/Black_Clover/BC_Yami_Sukehiro.png';
function getEpisodeImage(title: string): string {
  const match = title.match(/\d+/);
  if (!match) return FALLBACK_IMAGE;
  const episodeNumber = Number(match[0]);
  return Black_Clover_IMAGES[episodeNumber] ?? FALLBACK_IMAGE;
}
...
const CATALOG: Arc[] = [
  {
    ...
    episodes: [
      ...
      },
      {
        ...
        subscales: [
          {
            label: 'Trouble on a Foreign Road',
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items: [
  ...
  },
  {
    ...
    },
    {
      title:"Episode 14",
      subscales:[{
        label:"The Holy Woman's Confession",
        items:[
...

  {
    title:"Episode 15",
    subscales:[{
      label:"With the Shogun of the Hino Country",
  ...
  },
  {
    title:"Episode 17",
    subscales:[{
      label:"Banquet in the Full Swing!",
     ...
     episodes: [
      {
       title:"Episode 23",
       subscales:[{
        label:"The Dancing Princess of the Battlefield Returns",
   ...
   title:"Arc 5 - Master and Apprentice",
     episodes: [
      ...
      },
      {
        title:"Episode 29",
        subscales:[{
          label:"Five Hundred Years of Solitude",
  ...
  interface BlackCloverQuizProps {
  onFinish: (sessionId: string) => void;
  onBack: () => void;
  demographics?:DemographicPayload
}

export default function Black_Clover({ onFinish, onBack, demographics }: BlackCloverQuizProps) {
