...
const THEME: ThemeTokens = {
  ...
  text:           'text-white',
  subText:        'text-[#CBD5E1]',
  btnPrimary:     'bg-[#3B82F6] text-white hover:bg-[#2563EB]',
  btnOutline:     'border-white/20 text-white hover:bg-white/5',
  itemBg:         'bg-white/5 border-white/10',
  itemBgAnswered: 'bg-[#3B82F6]/20 border-[#3B82F6]/40',
  ratingSelected: 'bg-[#3B82F6] text-white scale-105 shadow-lg shadow-blue-500/30',
  ...
  // ARC 1
  'Introduction':                                         '/images/Bleach/Bleach_Akon.png',
  'Machiavellianism':                                     '/images/Bleach/Bleach_Bleach_Hirako.png',
  'Narcissism':                                           '/images/Bleach/Bleach_Byakuya_Kuchiki.png',
  'Psychopathy':                                          '/images/Bleach/Bleach_Genshiro_Okikiba.png',
  'Sadism':                                               '/images/Bleach/Bleach_Hanatarou_Yamada.png',
  'BFI-2-XS: Extraversion & Agreeableness':               '/images/Bleach/Bleach_Ichigo_Kurosaki.png',
  'Conscientiousness, Neuroticism & Openness':            '/images/Bleach/Bleach_Ikkaku_Madarame.png',
  'UPPS-P Impulsivity':                                   '/images/Bleach/Bleach_Isane_Kotetsu.png',
  'Need for Cognition (NFC-18)':                          '/images/Bleach/Bleach_Izuru_Kira.png',
  // ARC 2
  'Maladaptive Daydreaming (MDS-16)':                     '/images/Bleach/Bleach_Kenpachi_Zaraki.png',
  'Cognitive Emotion Regulation (CERQ)':                  '/images/Bleach/Bleach_Kensei_Muguruma.png',
  'Psychological Pain Scale (PPS-13)':                    '/images/Bleach/Bleach_Kiyone_Kotetsu.png',
  'Depression & Stress (DASS-21)':                        '/images/Bleach/Bleach_Lisa_Yodomaro.png',
  'Anxiety & Insomnia (DASS-21 + ISI)':                   '/images/Bleach/Bleach_Marechiyo_Omaeda.png',
  'Self-Esteem & Life Satisfaction (RSES + SWLS)':        '/images/Bleach/Bleach_Mashiro_Kuna.png',
  'Anhedonia (SHAPS-14)':                                 '/images/Bleach/Bleach_Mayuri_Kurotsuchi.png',
  'Multidimensional State Boredom (MSBM)':                '/images/Bleach/Bleach_Yamamoto.png',
  'Basic Psychological Needs (BPNS)':                     '/images/Bleach/Bleach_Toshiro_Hitsugaya.png',
  // ARC 3
  'Social Media & Smartphone Addiction (BSMAS + SAS-SV)': '/images/Bleach/Bleach_Shunsui_Kyoraku.png',
  'Gaming Addiction & Emotion Regulation (GAS-7 + ERQ)':  '/images/Bleach/Bleach_Nanao_Ise.png',
  'Anime Addiction Scale (CLC)':                          '/images/Bleach/Bleach_Rukia_Kuchiki.png',
  // ARC 4
  'Heartland Forgiveness Scale (HFS)':                    '/images/Bleach/Bleach_Shinji_Hirako.png',
  'Self-Compassion Scale (SCS-SF)':                       '/images/Bleach/Bleach_Sui_Feng.png',
  'Compassion for Others (CS)':                           '/images/Bleach/Bleach_Ichigo_Kurosaki.png',
  // ARC 5
  'Brief COPE (28 items)':                                '/images/Bleach/Bleach_Yamamoto.png',
  'Self-Expansion, Self-Suppression & Financial Stress':  '/images/Bleach/Bleach_Rojuro_Otoribashi.png',
  'Benevolent Childhood Experiences (BCE)':               '/images/Bleach/Bleach_Renji_Abarai.png',
  'Hikikomori & Social Avoidance Scale':                  '/images/Bleach/Bleach_Toshiro_Hitsugaya.png',
  'Need to Belong (NTB)':                                 '/images/Bleach/Bleach_Yamamoto.png',
  // EPILOGUE
  'Anime Story World Engagement (ASWE)':                  '/images/Bleach/Bleach_Shuhei_Hisagi.png',
  'Narrative Identity in Anime (NISE-20)':                '/images/Bleach/Bleach_Ichigo_Kurosaki.png',
};



export const BLEACH_IMAGES: Record<number, string> = {
  0: "/images/Characters/Bleach/ichigo_kurosaki.png",
  1: "/images/Characters/Bleach/marechiyo_omaeda.png",
  2: "/images/Characters/Bleach/orihime_inoue.png",   
  3: '/images/Bleach/Bleach_Bleach_Hirako.png',        
  4: '/images/Bleach/Bleach_Byakuya_Kuchiki.png',            
  5: '/images/Bleach/Bleach_Genshiro_Okikiba.png',
  6: "/images/Bleach/Bleach_Hanatarou_Yamada.png",
  7: "/images/Bleach/Bleach_Ichigo_Kurosaki.png",
  8: "/images/Characters/Bleach/isshin_kurosaki.png",
  9: "/images/Bleach/Bleach_Isane_Kotetsu.png",
  10: "/images/Bleach/Bleach_Izuru_Kira.png",
  11: "/images/Bleach/Bleach_Kenpachi_Zaraki.png",
  12: "/images/Bleach/Bleach_Kensei_Muguruma.png",
  13: "/images/Bleach/Bleach_Kiyone_Kotetsu.png",
  14: "/images/Bleach/Bleach_Lisa_Yodomaro.png",
  15: "/images/Bleach/Bleach_Marechiyo_Omaeda.png",
  16: "/images/Characters/Bleach/rojuro_otoribashi.png",
  17: "/images/Bleach/Bleach_Mayuri_Kurotsuchi.png",
  18: "/images/Bleach/Bleach_Nanao_Ise.png",
  19: "/images/Bleach/Bleach_Rangiku_Matsumoto.png",
  20: "/images/Bleach/Bleach_Renji_Abarai.png",
  21: "/images/Bleach/Bleach_Rojuro_Otoribashi.png",
  22: "/images/Bleach/Bleach_Rukia_Kuchiki.png",
  23: "/images/Bleach/Bleach_Shinji_Hirako.png",
  24: "/images/Bleach/Bleach_Shunsui_Kyoraku.png",
  25: "/images/Bleach/Bleach_Sui_Feng.png",
  26: "/images/Characters/Bleach/nnoitra_gilga.png",
  27: "/images/Bleach/Bleach_Toshiro_Hitsugaya.png",
  28: "/images/Bleach/Bleach_Yamamoto.png",
  29: "/images/Bleach/Bleach_Yasochika_Lemura.png",
  30: "/images/Bleach/Bleach_Yumichika_Ayasegawa.png",
  31: "/images/Bleach/Bleach_Yuyu_Yayahara.png",
  32: "/images/Bleach/Blech_Shuhei_Hisagi.png"
};


const FALLBACK_IMAGE = '/images/Characters/Bleach/ichigo_kurosaki.png';
function getEpisodeImage(title: string): string {
  const match = title.match(/\d+/);
  if (!match) return FALLBACK_IMAGE;
  const episodeNumber = Number(match[0]);
  return BLEACH_IMAGES[episodeNumber] ?? FALLBACK_IMAGE;
}
...
const CATALOG: Arc[] = [
  ...
  interface BleachQuizProps {
  onFinish: (sessionId:string ) => void;
  onBack: () => void;
  demographics?:DemographicPayload
}
 
export default function BleachQuiz({ onFinish, onBack, demographics }: BleachQuizProps) {
