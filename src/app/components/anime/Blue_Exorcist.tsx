...
const ANIME_SLUG = "blue-exorcist";
...
const THEME: ThemeTokens = {
  ...
  text:           'text-[#38BDF8]',
  subText:        'text-[#FBCFE8]',
  btnPrimary:     'bg-[#38BDF8] text-[#0B172A] font-bold hover:bg-[#0284c7]',
  btnOutline:     'border-[#38BDF8]/30 text-[#38BDF8] hover:bg-[#38BDF8]/10',
  itemBg:         'bg-[#38BDF8]/5 border-[#38BDF8]/10',
  itemBgAnswered: 'bg-[#FBCFE8]/20 border-[#FBCFE8]/40',
  ratingSelected: 'bg-[#38BDF8] text-[#0B172A] font-bold scale-105 shadow-lg shadow-blue-500/40',
  ratingDefault:  'bg-[#38BDF8]/10 text-[#38BDF8] hover:bg-[#38BDF8]/20',
  headerBorder:   'border-[#38BDF8]/10',
  footerBorder:   'border-[#38BDF8]/10',
  ...
  // ARC 1
  'Introduction':                                         '/images/Blue_Exorcist/BE_Arthur_Angel.png',
  'Machiavellianism':                                     '/images/Blue_Exorcist/BE_Blue_Exorcist_2.png',
  'Narcissism':                                           '/images/Blue_Exorcist/BE_Blue_Exorcist_3.png',
  'Psychopathy':                                          '/images/Blue_Exorcist/BE_Blue_Exorcist_4.png',
  'Sadism':                                               '/images/Blue_Exorcist/BE_Blue_Exorcist_5.png',
  'BFI-2-XS: Extraversion & Agreeableness':               '/images/Blue_Exorcist/BE_Blue_Exorcist_6.png',
  'Conscientiousness, Neuroticism & Openness':            '/images/Blue_Exorcist/BE_Blue_Exorcist.png',
  'UPPS-P Impulsivity':                                   '/images/Blue_Exorcist/BE_Cheng_Long_liu.png',
  'Need for Cognition (NFC-18)':                          '/images/Blue_Exorcist/BE_Eminescu_Nicholas.png',
  // ARC 2
  'Maladaptive Daydreaming (MDS-16)':                     '/images/Blue_Exorcist/BE_Igor_Neuhas.png',
  'Cognitive Emotion Regulation (CERQ)':                  '/images/Blue_Exorcist/BE_Izumo.png',
  'Psychological Pain Scale (PPS-13)':                    '/images/Blue_Exorcist/BE_Juzo_Shima.png',
  'Depression & Stress (DASS-21)':                        '/images/Blue_Exorcist/BE_Kaoru_Tsubaki.png',
  'Anxiety & Insomnia (DASS-21 + ISI)':                   '/images/Blue_Exorcist/BE_Lewin_Light.png',
  'Self-Esteem & Life Satisfaction (RSES + SWLS)':        '/images/Blue_Exorcist/BE_Mamushi_Hojo.png',
  'Anhedonia (SHAPS-14)':                                 '/images/Blue_Exorcist/BE_Mephito_Pheles.png',
  'Multidimensional State Boredom (MSBM)':                '/images/Blue_Exorcist/BE_Osceola_Redarm.png',
  'Basic Psychological Needs (BPNS)':                     '/images/Blue_Exorcist/BE_Renzou.png',
  // ARC 3
  'Social Media & Smartphone Addiction (BSMAS + SAS-SV)': '/images/Blue_Exorcist/BE_Rin_Okumura.png',
  'Gaming Addiction & Emotion Regulation (GAS-7 + ERQ)':  '/images/Blue_Exorcist/BE_Rin_Okumura_V2.png',
  'Anime Addiction Scale (CLC)':                          '/images/Blue_Exorcist/BE_Rin_Okumura_V3.png',
  // ARC 4
  'Heartland Forgiveness Scale (HFS)':                    '/images/Blue_Exorcist/BE_Rin_Okumura_V4.png',
  'Self-Compassion Scale (SCS-SF)':                       '/images/Blue_Exorcist/BE_Ryuji_Suguro.png',
  'Compassion for Others (CS)':                           '/images/Blue_Exorcist/BE_Saburota_Todo.png',
  // ARC 5
  'Brief COPE (28 items)':                                '/images/Blue_Exorcist/BE_Shiemi_Moriyama.png',
  'Self-Expansion, Self-Suppression & Financial Stress':  '/images/Blue_Exorcist/BE_Shiro_Fujimoto.png',
  'Benevolent Childhood Experiences (BCE)':               '/images/Blue_Exorcist/BE_Shura_Kirigakure.png',
  'Hikikomori & Social Avoidance Scale':                  '/images/Blue_Exorcist/BE_Uwabami_Hojo.png',
  'Need to Belong (NTB)':                                 '/images/Blue_Exorcist/BE_Waro_Todo.png',
  // EPILOGUE
  'Anime Story World Engagement (ASWE)':                  '/images/Blue_Exorcist/BE_Rin_Okumura.png',
  'Narrative Identity in Anime (NISE-20)':                '/images/Blue_Exorcist/BE_Rin_Okumura.png',
};


export const Blue_Exorcist_IMAGES: Record<number, string> = {
  0: "/images/Characters/Blue_Exorcist/arthur_angel.png",
  1: "/images/Characters/Blue_Exorcist/cheng-long_liu.png",
  2: "/images/Characters/Blue_Exorcist/igor_neuhaus.png",   
  3: '/images/Characters/Blue_Exorcist/izumo_kamiki.png',        
  4: '/images/Characters/Blue_Exorcist/kawanaka.png',            
  5: '/images/Characters/Blue_Exorcist/kinzo_shima.png',
  6: "/images/Characters/Blue_Exorcist/konekomaru_miwa.png",
  7: "/images/Characters/Blue_Exorcist/lewin_light.png",
  8: "/images/Characters/Blue_Exorcist/lucifer.png",
  9: "/images/Characters/Blue_Exorcist/mephisto_pheles.png",
  10: "/images/Characters/Blue_Exorcist/michael_gedoin.png",
  11: "/images/Characters/Blue_Exorcist/nemu_takara.png",
  12: "/images/Characters/Blue_Exorcist/nishikawi.png",
  13: "/images/Characters/Blue_Exorcist/renzo_shima.png",
  14: "/images/Characters/Blue_Exorcist/rin_okumura.png",
  15: "/images/Characters/Blue_Exorcist/ryuji_suguro.png",
  16: "/images/Characters/Blue_Exorcist/saburota_todo.png",
  17: "/images/Characters/Blue_Exorcist/satan.png",
  18: "/images/Characters/Blue_Exorcist/seishiro_nagatomo.png",
  19: "/images/Characters/Blue_Exorcist/shiemi_moriyama.png",
  20: "/images/Characters/Blue_Exorcist/shiro_fujimoto.png",
  21: "/images/Characters/Blue_Exorcist/shura_kirigakure.png",
  22: "/images/Characters/Blue_Exorcist/tarsem_mahal.png",
  23: "/images/Characters/Blue_Exorcist/uwabami_hojo.png",
  24: "/images/Characters/Blue_Exorcist/yaozo_shima.png",
  25: "/images/Characters/Blue_Exorcist/yukio_okumura.png",
  26: "/images/Characters/Blue_Exorcist/arthur_angel.png",
  27: "/images/Characters/Blue_Exorcist/cheng-long_liu.png",
  28: "/images/Characters/Blue_Exorcist/igor_neuhaus.png",
  29: "/images/Characters/Blue_Exorcist/izumo_kamiki.png",
  30: "/images/Characters/Blue_Exorcist/juzo_shima.png",
  31: "/images/Characters/Blue_Exorcist/kawanaka.png",
  32: "/images/Characters/Blue_Exorcist/kinzo_shima.png",
  33: "/images/Characters/Blue_Exorcist/konekomaru_miwa.png",
  34: "/images/Characters/Blue_Exorcist/lewin_light.png"
};


const FALLBACK_IMAGE = "/images/Blue_Exorcist.jpg";
function getEpisodeImage(title: string): string {
  const match = title.match(/\d+/);
  if (!match) return FALLBACK_IMAGE;
  const episodeNumber = Number(match[0]);
  return Blue_Exorcist_IMAGES[episodeNumber] ?? FALLBACK_IMAGE;
}
...
const CATALOG: Arc[] = [
  {
    ...
    episodes: [
      ...
      },
      {
        ...
        subscales: [
          {
            label: 'Child of a Cursed Temple',
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items: [
  ...
  {
    title:"Arc 3 - First Exorcist Sword",
     episodes: [
      {
        title:"Episode 18",
        subscales:[{
  ...
  {
   title:"Arc 5 - Story of Teppo Rangu...",
     episodes: [
      {
        title:"Episode 26",
        subscales:[{
          label:"To the Heart Content",
  ...
  interface BlueExorcistQuizProps {
  onFinish: (sessionId: string) => void;
  onBack: () => void;
  demographics?:DemographicPayload
}
 
export default function BlueExorcistQuiz({ onFinish, onBack,demographics }: BlueExorcistQuizProps) {
