...
const THEME: ThemeTokens = {
  ...
  text:           'text-[#E6C687]',
  subText:        'text-[#A1B98B]',
  btnPrimary:     'bg-[#E6C687] text-[#1E1C1A] font-bold hover:bg-[#d4b069]',
  btnOutline:     'border-[#E6C687]/30 text-[#E6C687] hover:bg-[#E6C687]/10',
  itemBg:         'bg-[#E6C687]/5 border-[#E6C687]/10',
  itemBgAnswered: 'bg-[#A1B98B]/20 border-[#A1B98B]/40',
  ratingSelected: 'bg-[#E6C687] text-[#1E1C1A] font-bold scale-105 shadow-lg shadow-amber-900/40',
  ratingDefault:  'bg-[#E6C687]/10 text-[#E6C687] hover:bg-[#E6C687]/20',
  headerBorder:   'border-[#E6C687]/10',
  footerBorder:   'border-[#E6C687]/10',
  labelColor:     'text-[#E6C687]',
  accentColor:    '#E6C687',
...
export const Code_Geass_IMAGES: Record<number, string> = {
  0: "/images/Characters/Code_Geass/anya_alstreim.png", 
  1: "/images/Characters/Code_Geass/bismarck_waldstein.png", 
  2: "/images/Characters/Code_Geass/callis_al_britannia.png",   
  3: '/images/Characters/Code_Geass/cc.png',        
  4: '/images/Characters/Code_Geass/cecile_croomy.png',            
  5: '/images/Characters/Code_Geass/charles_zi_britannia.png',
  6: "/images/Characters/Code_Geass/cornelia_li_britannia.png",
  7: "/images/Characters/Code_Geass/diethard_reid.png",
  8: "/images/Characters/Code_Geass/euphemia_li_britannia.png",
  9: "/images/Characters/Code_Geass/gilbert_guilford.png",
  10: "/images/Characters/Code_Geass/gino_weinberg.png",
  11: "/images/Characters/Code_Geass/jeremiah_gottwald.png",
  12: "/images/Characters/Code_Geass/kaguya_sumeragi.png",
  13: "/images/Characters/Code_Geass/kallen_kozuki.png",
  14: "/images/Characters/Code_Geass/lelouch_lamperouge.png",
  15: "/images/Characters/Code_Geass/li_xingke.png",
  16: "/images/Characters/Code_Geass/lloyd_asplund.png",
  17: "/images/Characters/Code_Geass/mao.png",
  18: "/images/Characters/Code_Geass/marianne_vi_britannia.png",
  19: "/images/Characters/Code_Geass/milly_ashford.png",
  20: "/images/Characters/Code_Geass/monica_krushchevsky.png",
  21: "/images/Characters/Code_Geass/nina_einstein.png",
  22: "/images/Characters/Code_Geass/nonette_enneagram.png",
  23: "/images/Characters/Code_Geass/norland_von_lunebelg.png",
  24: "/images/Characters/Code_Geass/nunnally_vi_britannia.png",
  25: "/images/Characters/Code_Geass/ohgi_kaname.png",
  26: "/images/Characters/Code_Geass/rakshata_chawla.png",
  27: "/images/Characters/Code_Geass/rivalz_cardemonde.png",
  28: "/images/Characters/Code_Geass/rolo_lamperouge.png",
  29: "/images/Characters/Code_Geass/sakuya_sumeragi.png",
  30: "/images/Characters/Code_Geass/anya_alstreim.png", 
  31: "/images/Characters/Code_Geass/bismarck_waldstein.png", 
  32: "/images/Characters/Code_Geass/callis_al_britannia.png",   
  33: '/images/Characters/Code_Geass/cc.png',        
  34: '/images/Characters/Code_Geass/cecile_croomy.png',            
  35: '/images/Characters/Code_Geass/charles_zi_britannia.png',
...
function getEpisodeImage(title: string): string {
  ...
  return Code_Geass_IMAGES[episodeNumber] ?? FALLBACK_IMAGE;
}
...
const CATALOG: Arc[] = [
    ...
    episodes: [
       {
        ...
        subscales: [
          {
            label: 'Tranquility and the Beginning',
            ...
            items: [
              { id: 'mach_1', text: 'Its not wise to tell your secrets.' },
              ...
              { id: 'mach_5', text: 'Its wise to keep track of information that you can use against people later.' },
      ...
      },
      {
        ...
        subscales: [
          {
            label:"The Cat, Mask and Euphemia",
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items:[
  ...
  },
  {
    ...
    },
    {
      title:"Episode 14",
      subscales:[{
        label:"The Truth Behind the Death",
        items:[
    ...
    title:"Arc 3 - A Kinder World",
     episodes: [
      ...
      },
      {
        title:"Episode 19",
        subscales:[{
          label:"The Specially Administrated Zone of Japan",
          items:[
      ...
      },
      {
        title:"Episode 21",
        subscales:[{
          label:"The Cacophony of Collapse",
          items:[
  ...
  {
   title:"Arc 5 - Sky Fortress Damocles",
     episodes: [
      {
        title:"Episode 26",
        subscales:[{
          label:"Promised Place",
  ...
  {
    title:"Arc 6 - Black Knightmare",
    episodes:[
      
      {
        title:"Episode 31",
        subscales:[{
          label:"United Federation of Nations",
          items:[
  ...
  interface CodeGeassQuizProps {
  onFinish: (sessionId:string) => void;
  onBack: () => void;
  demographics?:DemographicPayload
}
 
export default function CodeGeassQuiz({ onFinish, onBack, demographics }: CodeGeassQuizProps) {
