...
const THEME: ThemeTokens = {
  ...
  btnOutline:     'border-white/20 text-white hover:bg-white/10',
  itemBg:         'bg-white/5 border-white/10',
  itemBgAnswered: 'bg-white/10 border-white/30',
  ratingSelected: 'bg-white text-black scale-105 shadow-lg shadow-white/20',
  ratingDefault:  'bg-white/5 text-white hover:bg-white/15',
  ...
  // ARC 1
  'Introduction':                                         '/images/Death_Note/Death_Note_Light_Ryuk.png',
  'Machiavellianism':                                     '/images/Death_Note/Death_Note_Light_Ryuk.png',
  'Narcissism':                                           '/images/Death_Note/Death_Note_Light.png',
  'Psychopathy':                                          '/images/Death_Note/Death_Note_Light_Ryuk.png',
  'Sadism':                                               '/images/Death_Note/Death_Note_Light.png',
  'BFI-2-XS: Extraversion & Agreeableness':               '/images/Death_Note/Death_Note_Mello.png',
  'Conscientiousness, Neuroticism & Openness':            '/images/Death_Note/Death_Note_Mello.png',
  'UPPS-P Impulsivity':                                   '/images/Death_Note/Death_Note_Mello_2.png',
  'Need for Cognition (NFC-18)':                          '/images/Death_Note/Death_Note_Mello_2.png',
  // ARC 2
  'Maladaptive Daydreaming (MDS-16)':                     '/images/Death_Note/Death_Note_Rem.png',
  'Cognitive Emotion Regulation (CERQ)':                  '/images/Death_Note/Death_Note_Rem.png',
  'Psychological Pain Scale (PPS-13)':                    '/images/Death_Note/Death_Note_Misa_Amane_2.png',
  'Depression & Stress (DASS-21)':                        '/images/Death_Note/Death_Note_Misa_Amane_3.png',
  'Anxiety & Insomnia (DASS-21 + ISI)':                   '/images/Death_Note/Death_Note_Misa_Amane_4.png',
  'Self-Esteem & Life Satisfaction (RSES + SWLS)':        '/images/Death_Note/Death_Note_Ryuk_on_cliff.png',
  'Anhedonia (SHAPS-14)':                                 '/images/Death_Note/Death_Note_Ryuk_on_cliff.png',
  'Multidimensional State Boredom (MSBM)':                '/images/Death_Note/Death_Note_Light_Ryuk.png',
  'Basic Psychological Needs (BPNS)':                     '/images/Death_Note/Death_Note_Light_Ryuk.png',
  // ARC 3
  'Social Media & Smartphone Addiction (BSMAS + SAS-SV)': '/images/Death_Note/Death_Note_Mello.png',
  'Gaming Addiction & Emotion Regulation (GAS-7 + ERQ)':  '/images/Death_Note/Death_Note_Near.png',
  'Anime Addiction Scale (CLC)':                          '/images/Death_Note/Death_Note_Near_2.png',
  // ARC 4
  'Heartland Forgiveness Scale (HFS)':                    '/images/Death_Note/Death_Note_Ryuk_on_cliff.png',
  'Self-Compassion Scale (SCS-SF)':                       '/images/Death_Note/Death_Note_Ryuk.png',
  'Compassion for Others (CS)':                           '/images/Death_Note/Death_Note_Ryuk_on_cliff.png',
  // ARC 5
  'Brief COPE (28 items)':                                '/images/Death_Note/Death_Note_Ryuk.png',
  'Self-Expansion, Self-Suppression & Financial Stress':  '/images/Death_Note/Death_Note_Misa_Amane.png',
  'Benevolent Childhood Experiences (BCE)':               '/images/Death_Note/Death_Note_Misa_Amane_2.png',
  'Hikikomori & Social Avoidance Scale':                  '/images/Death_Note/Death_Note_Misa_Amane_3.png',
  'Need to Belong (NTB)':                                 '/images/Death_Note/Death_Note_Mello.png',
  // EPILOGUE
  'Anime Story World Engagement (ASWE)':                  '/images/Death_Note/Death_Note_Light.png',
  'Narrative Identity in Anime (NISE-20)':                '/images/Death_Note/Death_Note_Light.png',
};



export const Death_Note_IMAGES: Record<number, string> = {
  0: "/images/Characters/Death_Note/anthony_Rester.png",
  1: "/images/Characters/Death_Note/halle_lidner.png",
  2: "/images/Characters/Death_Note/hirozaku_ukita.png",
  3: "/images/Characters/Death_Note/joe_mcenroe.png",
  4: "/images/Characters/Death_Note/kanzo_mochi.png",
  5: "/images/Characters/Death_Note/kiyomi_takada.png",
  6: "/images/Characters/Death_Note/l_lawliet.png",
  7: "/images/Characters/Death_Note/light_yagami.png",
  8: "/images/Characters/Death_Note/mello.png",
  9: "/images/Characters/Death_Note/misa_amane.png",
  10: "/images/Characters/Death_Note/naomi_misora.png",
  11: "/images/Characters/Death_Note/near.png",
  12: "/images/Characters/Death_Note/rem.png",
  13: "/images/Characters/Death_Note/ryuk.png",
  14: "/images/Characters/Death_Note/shuichi_aizawa.png",
  15: "/images/Characters/Death_Note/soichiro_yagami.png",
  16: "/images/Characters/Death_Note/stephen_gevanni.png",
  17: "/images/Characters/Death_Note/teru_mikami.png",
  18: "/images/Characters/Death_Note/touta_matsuda.png",
  19: "/images/Characters/Death_Note/watari.png",
  20: "/images/Characters/Death_Note/anthony_Rester.png",
  21: "/images/Characters/Death_Note/halle_lidner.png",
  22: "/images/Characters/Death_Note/hirozaku_ukita.png",
  23: "/images/Characters/Death_Note/joe_mcenroe.png",
  24: "/images/Characters/Death_Note/kanzo_mochi.png",
  25: "/images/Characters/Death_Note/kiyomi_takada.png",
  26: "/images/Characters/Death_Note/l_lawliet.png",
  27: "/images/Characters/Death_Note/light_yagami.png",
  28: "/images/Characters/Death_Note/mello.png",
  29: "/images/Characters/Death_Note/misa_amane.png",
  30: "/images/Characters/Death_Note/naomi_misora.png",
  31: "/images/Characters/Death_Note/near.png",
  32: "/images/Characters/Death_Note/rem.png",
  33: "/images/Characters/Death_Note/ryuk.png",
  34: "/images/Characters/Death_Note/shuichi_aizawa.png",
  35: "/images/Characters/Death_Note/soichiro_yagami.png",
  36: "/images/Characters/Death_Note/stephen_gevanni.png",
  37: "/images/Characters/Death_Note/teru_mikami.png",
  38: "/images/Characters/Death_Note/touta_matsuda.png",
  39: "/images/Characters/Death_Note/watari.png",
};

const FALLBACK_IMAGE = '/images/Death_Note/Death_Note_Ryuk_on_cliff.png';
function getEpisodeImage(title: string): string {
  const match = title.match(/\d+/);
  if (!match) return FALLBACK_IMAGE;
  const episodeNumber = Number(match[0]);
  return Death_Note_IMAGES[episodeNumber] ?? FALLBACK_IMAGE;
}
...
const CATALOG: Arc[] = [
  ...
  },
  {
    ...
    episodes:[
      
      {
        title:"Episode 31",
        subscales:[{
          label:"Madara, requiem for a dream",
          items:[
  ...
  interface DeathNoteQuizProps {
  onFinish: (sessionId: string) => void;
  onBack: () => void;
  demographics?:DemographicPayload
}
 
export default function DeathNoteQuiz({ onFinish, onBack, demographics }: DeathNoteQuizProps) {
