...
const THEME: ThemeTokens = {
  ...
  btnPrimary:     'bg-[#065F46] text-white hover:bg-[#047857]',
  btnOutline:     'border-white/20 text-white hover:bg-white/5',
  itemBg:         'bg-white/5 border-white/10',
  itemBgAnswered: 'bg-[#065F46]/20 border-[#065F46]/40',
  ratingSelected: 'bg-[#065F46] text-white scale-105 shadow-lg shadow-emerald-900/50',
...
export const Demon_Slayer_IMAGES: Record<number, string> = {
  0: "/images/Characters/Demon_Slayer/akaza.png",
  1: "/images/Characters/Demon_Slayer/daki.png",
  2: "/images/Characters/Demon_Slayer/doma.png",   
  3: '/images/Characters/Demon_Slayer/enmu.png',        
  4: '/images/Characters/Demon_Slayer/genya_shinazugawa.png',            
  5: '/images/Characters/Demon_Slayer/giyuu_tomioka.png',
  6: "/images/Characters/Demon_Slayer/gyokko.png",
  7: "/images/Characters/Demon_Slayer/gyomei_himejima.png",
  8: "/images/Characters/Demon_Slayer/gyutaro.png",
  9: "/images/Characters/Demon_Slayer/inosuke_hashibira.png",
  10: "/images/Characters/Demon_Slayer/kagaya_ubuyashiki.png",
  11: "/images/Characters/Demon_Slayer/kaigaku.png",
  12: "/images/Characters/Demon_Slayer/kanao_tsuyuri.png",
  13: "/images/Characters/Demon_Slayer/kiriya_ubuyashiki.png",
  14: "/images/Characters/Demon_Slayer/kyojuro_rengoku.png",
  15: "/images/Characters/Demon_Slayer/michitaku_tsugikuni.png",
  16: "/images/Characters/Demon_Slayer/mitsuri_kanroji.png",
  17: "/images/Characters/Demon_Slayer/muichiro_tokito.png",
  18: "/images/Characters/Demon_Slayer/muzan.png",
  19: "/images/Characters/Demon_Slayer/nezuko_kamado.png",
  20: "/images/Characters/Demon_Slayer/obanai_iguro.png",
  21: "/images/Characters/Demon_Slayer/sanemi_shinazugawa.png",
  22: "/images/Characters/Demon_Slayer/shinobu_kocho.png",
  23: "/images/Characters/Demon_Slayer/tamayo.png",
  24: "/images/Characters/Demon_Slayer/tengen_uzui.png",
  25: "/images/Characters/Demon_Slayer/yoriichi_tsugikuni.png",
  26: "/images/Characters/Demon_Slayer/zenitsu_agatsuma.png",
  27: "/images/Characters/Demon_Slayer/muichiro_tokito.png",
  28: "/images/Characters/Demon_Slayer/muzan.png",
  29: "/images/Characters/Demon_Slayer/nezuko_kamado.png",
  30: "/images/Characters/Demon_Slayer/obanai_iguro.png",
  31: "/images/Characters/Demon_Slayer/sanemi_shinazugawa.png",
  32: "/images/Characters/Demon_Slayer/shinobu_kocho.png",
  33: "/images/Characters/Demon_Slayer/tamayo.png",
  34: "/images/Characters/Demon_Slayer/tengen_uzui.png",
  35: "/images/Characters/Demon_Slayer/yoriichi_tsugikuni.png",
  36: "/images/Characters/Demon_Slayer/zenitsu_agatsuma.png"
};
...
function getEpisodeImage(title: string): string {
  ...
  return Demon_Slayer_IMAGES[episodeNumber] ?? FALLBACK_IMAGE;
}
...
const CATALOG: Arc[] = [
  ...
  {
    title:"Arc 2 - Assaulted by Memories",
     episodes: [
  ...
  {
    title:"Arc 3 - Flapping Butterflies Wings",
     episodes: [
      {
        title:"Episode 18",
        subscales:[{
          label:"Leaving the Warfront",
          items:[
  ...
  {
   title:"Arc 4 - The Path of Opening a Steadfast Heart",
     episodes: [
      {
       title:"Episode 23",
       subscales:[{
      ...
      },
      {
        title:"Episode 24",
        subscales:[{
          label:"Which One of Us is the Demon",
      ...
      },
      {
        title:"Episode 25",
        subscales:[{
          label:"The Wheel of Fate",
          likert:{min:1, max:10, step:1, type:"slider",values:[]},
          items:[
  ...
  {
    title:"Arc 6 - The Wheel of Fate",
    episodes:[
      
      {
        title:"Episode 31",
        subscales:[{
          label:"Voices of Encouragement",
          items:[
    ...
    title:"Epilogue 32-33",
     episodes: [
      ...
      },
      {
        title:"Episode 33",
        subscales:[{
          label:"Life Shining Across the Years",
  ...
  interface DemonSlayerQuizProps {
  onFinish: (sessionId:string) => void;
  onBack: () => void;
  demographics?:DemographicPayload
}
 
export default function DemonSlayerQuiz({ onFinish, onBack, demographics }: DemonSlayerQuizProps) {
