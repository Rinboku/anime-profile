...
const THEME: ThemeTokens = {
  ...
  text:           'text-[#F97316]',
  subText:        'text-[#22D3EE]',
  btnPrimary:     'bg-[#22D3EE] text-[#1E0A05] font-black hover:bg-[#06b6d4]',
  ...
  ratingSelected: 'bg-[#22D3EE] text-[#1E0A05] font-black scale-105 shadow-lg shadow-cyan-500/40',
...
export const Dr_Stone_IMAGES: Record<number, string> = {
  0: "/images/Characters/Dr_Stone/amaryllis.png",
  1: "/images/Characters/Dr_Stone/asagiri-gen.png",
  2: "/images/Characters/Dr_Stone/chelsea_childe.png",   
  3: '/images/Characters/Dr_Stone/chrome.png',       
  4: '/images/Characters/Dr_Stone/francois.png',            
  5: '/images/Characters/Dr_Stone/ginro.png',
  6: "/images/Characters/Dr_Stone/homura_momiji.png",
  7: "/images/Characters/Dr_Stone/hyoga.png",
  8: "/images/Characters/Dr_Stone/joel_gear.png",
  9: "/images/Characters/Dr_Stone/kaseki.png",
  10: "/images/Characters/Dr_Stone/kinro.png",
  11: "/images/Characters/Dr_Stone/kohaku.png",
  12: "/images/Characters/Dr_Stone/luna_wright.png",
  13: "/images/Characters/Dr_Stone/magma.png",
  14: "/images/Characters/Dr_Stone/max_adams.png",
  15: "/images/Characters/Dr_Stone/minami_hokutozai.png",
  16: "/images/Characters/Dr_Stone/moz.png",
  17: "/images/Characters/Dr_Stone/nikki_hanada.png",
  18: "/images/Characters/Dr_Stone/ruri.png",
  19: "/images/Characters/Dr_Stone/ryusui_nanami.png",
  20: "/images/Characters/Dr_Stone/sai_nanami.png",
  21: "/images/Characters/Dr_Stone/senku_ishigami.png",
  22: "/images/Characters/Dr_Stone/stanley_snyder.png",
  23: "/images/Characters/Dr_Stone/suika.png",
  24: "/images/Characters/Dr_Stone/tsukasa_shishio.png",
  25: "/images/Characters/Dr_Stone/ukyo_saionji.png",
  26: "/images/Characters/Dr_Stone/xeno.png",
  27: "/images/Characters/Dr_Stone/yo-uei.png",
  28: "/images/Characters/Dr_Stone/ukyo_saionji.png",
  29: "/images/Characters/Dr_Stone/kaseki.png",
  30: "/images/Characters/Dr_Stone/kinro.png",
  31: "/images/Characters/Dr_Stone/kohaku.png",
  32: "/images/Characters/Dr_Stone/luna_wright.png",
  33: "/images/Characters/Dr_Stone/magma.png",
  34: "/images/Characters/Dr_Stone/max_adams.png",
  35: "/images/Characters/Dr_Stone/minami_hokutozai.png",
  36: "/images/Characters/Dr_Stone/moz.png",
};
...
function getEpisodeImage(title: string): string {
  ...
  return Dr_Stone_IMAGES[episodeNumber] ?? FALLBACK_IMAGE;
}
...
const CATALOG: Arc[] = [
  {
    ...
    episodes: [
      ...
      },
      {
        ...
        subscales: [
          {
            label: 'Kings of the Stone World',
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items: [
      ...
      },
      {
        ...
        subscales: [
          {
            label:"Raise of the Smoke Signal",
  ...
  {
    title:"Arc 2 - Two Kingdoms of the Stone World",
     episodes: [
    ...
    },
    {
      title:"Episode 13",
      subscales:[{
        label:"Two Kingdoms of the Stone World",
        items:[
  ...
  },
  {
    title: "Episode 16",
    subscales:[{
      label:"Two Million Years of Being",
  ...
  {
    title:"Arc 3 - Where Two Million Years Have Gone",
     episodes: [
      {
        title:"Episode 18",
        subscales:[{
...

      {
        title:"Episode 22",
        subscales:[{
          label:"By These Hands the Light of Science",
  ...
  {
   title:"Arc 4 - Tale for the Ages",
     episodes: [
      {
       title:"Episode 23",
       subscales:[{
        label:"A Shallow Alliance",
      ...
      },
      {
        title:"Episode 24",
        subscales:[{
          label:"A Certain Scientist Wish",
   ...
   title:"Arc 5 - Final Battle",
     episodes: [
      ...
      },
      {
        title:"Episode 28",
        subscales:[{
          label:"Friends Have Each Other's Backs",
  ...
  {
    title:"Arc 6 - A Future to Get Excited About",
    episodes:[
      
      {
        title:"Episode 31",
        subscales:[{
          label:"Sneaky Ground Bout Strategy",
          items:[
    ...
    title:"Epilogue 32-33",
     episodes: [
      ...
      },
      {
        title:"Episode 33",
        subscales:[{
          label:"A Future to Get Excited About",
  ...
  interface DrStoneQuizProps {
  onFinish: (sessionId:string) => void;
  onBack: () => void;
  demographics?:DemographicPayload
}
 
export default function DrStoneQuiz({ onFinish, onBack, demographics }: DrStoneQuizProps) {
