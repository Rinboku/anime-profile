...
const ANIME_SLUG = "dragon_ball_super";
...
const THEME: ThemeTokens = {
  ...
  text:           'text-[#F1F5F9]',
  subText:        'text-[#FFE0B2]',
  btnPrimary:     'bg-[#FBBF24] text-black hover:bg-[#F59E0B]',
  btnOutline:     'border-[#F1F5F9]/20 text-[#F1F5F9] hover:bg-[#F1F5F9]/10',
  itemBg:         'bg-[#F1F5F9]/5 border-[#F1F5F9]/10',
  itemBgAnswered: 'bg-[#FBBF24]/20 border-[#FBBF24]/40',
  ratingSelected: 'bg-[#FBBF24] text-black scale-105 shadow-lg shadow-amber-500/30',
  ratingDefault:  'bg-[#F1F5F9]/10 text-[#F1F5F9] hover:bg-[#F1F5F9]/20',
  headerBorder:   'border-[#F1F5F9]/10',
  footerBorder:   'border-[#F1F5F9]/10',
...
export const DRAGON_BALL_IMAGES: Record<number, string> = {
  0: "/images/Characters/Dragon_Ball_Z/android_17.png",
  1: "/images/Characters/Dragon_Ball_Z/android_18.pngg",
  2: "/images/Characters/Dragon_Ball_Z/beerus.pngg",   // step 2
  3: '/images/Characters/Dragon_Ball_Z/broly.png',        // step 3
  4: '/images/Characters/Dragon_Ball_Z/cabba.png',            // step 4
  5: '/images/Characters/Dragon_Ball_Z/caulifla.png',
  6: "/images/Characters/Dragon_Ball_Z/champa.png",
  7: "/images/Characters/Dragon_Ball_Z/cheelai.png",
  8: "/images/Characters/Dragon_Ball_Z/chi_chi.png",
  9: "/images/Characters/Dragon_Ball_Z/chiaotzu.png",
  10: "/images/Characters/Dragon_Ball_Z/frieza.png",
  11: "/images/Characters/Dragon_Ball_Z/future_trunks.png",
  12: "/images/Characters/Dragon_Ball_Z/gohan.png",
  13: "/images/Characters/Dragon_Ball_Z/goku_black.png",
  14: "/images/Characters/Dragon_Ball_Z/goten.png",
  15: "/images/Characters/Dragon_Ball_Z/gowasu.png",
  16: "/images/Characters/Dragon_Ball_Z/grand_priest.png",
  17: "/images/Characters/Dragon_Ball_Z/hit.png",
  18: "/images/Characters/Dragon_Ball_Z/jiren.png",
  19: "/images/Characters/Dragon_Ball_Z/kale.png",
  20: "/images/Characters/Dragon_Ball_Z/krillin.png",
  21: "/images/Characters/Dragon_Ball_Z/master_roshi.png",
  22: "/images/Characters/Dragon_Ball_Z/monaka.png",
  23: "/images/Characters/Dragon_Ball_Z/mr_satan.png",
  24: "/images/Characters/Dragon_Ball_Z/pan.png",
  25: "/images/Characters/Dragon_Ball_Z/piccolo.png",
  26: "/images/Characters/Dragon_Ball_Z/son_goku.png",
  27: "/images/Characters/Dragon_Ball_Z/tien_shinhan.png",
  28: "/images/Characters/Dragon_Ball_Z/toppo.pngg",
  29: "/images/Characters/Dragon_Ball_Z/chiaotzu.png",
  30: "/images/Characters/Dragon_Ball_Z/frieza.png",
  31: "/images/Characters/Dragon_Ball_Z/future_trunks.png",
  32: "/images/Characters/Dragon_Ball_Z/gohan.png",
  33: "/images/Characters/Dragon_Ball_Z/goku_black.png",
  34: "/images/Characters/Dragon_Ball_Z/goten.png",
  35: "/images/Characters/Dragon_Ball_Z/gowasu.png",
  36: "/images/Characters/Dragon_Ball_Z/grand_priest.png",
  37: "/images/Characters/Dragon_Ball_Z/hit.png",
};
...
function getEpisodeImage(title: string): string {
  ...
  return DRAGON_BALL_IMAGES[episodeNumber] ?? FALLBACK_IMAGE;
}
...
const CATALOG: Arc[] = [
    ...
    episodes: [
       {
        ...
        subscales: [
          {
            label: 'A New Threat! The Sign of a God of Destruction!',
      ...
      },
      {
        ...
        subscales: [
          {
            label: 'Goku Hidden Power! A Fateful Encounter!',
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items: [
      ...
      },
      {
        ...
        subscales: [
          {
            label: 'Vegeta Fury! A Sayan Pride!',
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items: [
      ...
      },
      {
        ...
        subscales: [
          {
            label: 'An Impossible Enemy! The Battle Begins!',
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items: [
      ...
      },
      {
        ...
        subscales: [
          {
            label: 'The Ultimate Transformation! The Power of a God!',
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items: [
      ...
      },
      {
        ...
        subscales: [
          {
            label:"The Universe Trembles! Gods Clash!",
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items:[
      ...
      },
      {
        ...
        subscales: [
          {
            label:"A Mysterious Sayan Appears! Who is the Warrior?",
      ...
      },
      {
        ...
        subscales: [
          {
            label:"Vegeta Faces His Past! The Truth About the Sayans!",
  ...
  {
    title:"Arc 2 - Saiyan Invasion Arc",
     episodes: [
  
      {
        ...
        subscales: [
          {
            label:"Goku vs. the New Saiyan! The Rivalry Begins!",
      ...
      },
    {
      ...
      subscales:[
        {
          label:"Gohan Fury! His Hidden Power Awakens!",
    ...
    },
    {
      title:"Episode 11",
      subscales:[{
        label:"Warriors Unite! Earth Defenders Rise",
    ...
    },
    {
      title:"Episode 12",
      subscales:[{
        label:"The Final Technique! Goku Risks Everything!",
    ...
    },
    {
      title:"Episode 13",
      subscales:[{
        label:"The Empire Returns! An Enemy from the Shadows!",
        items:[
    ...
    },
    {
      title:"Episode 14",
      subscales:[{
        label:"Frieza is not Alone! The Dark Army Attacks!",
        items:[
...

  {
    title:"Episode 15",
    subscales:[{
      label:"Piccolo vs. the General! A Battle for Earth!",
  ...
  },
  {
    title: "Episode 16",
    subscales:[{
      label:"Vegeta Unleashed! His New Transformation!",
  ...
  },
  {
    title:"Episode 17",
    subscales:[{
      label:"Goku Arrives! The Decisive Battle Begins!",
  ...
  {
    title:"Arc 3 - Dark Empire Arc",
     episodes: [
      {
        title:"Episode 18",
        subscales:[{
          label:"The Tournament Begins! The Strongest Warriors Across the Universe!",
          items:[
      ...
      },
      {
        title:"Episode 19",
        subscales:[{
          label:"The First Clash! Goku Meets an Unexpected Opponent!",
          items:[
      ...
      },
      {
        title:"Episode 21",
        subscales:[{
          label:"Vegeta vs. the Champion! A Saiyan Pride!",
          items:[
...

      {
        title:"Episode 22",
        subscales:[{
          label:"Piccolo and Gohan! The Perfect Strategy!",
  ...
  {
   title:"Arc 4 - Cosmic Tournament Arc",
     episodes: [
      {
       title:"Episode 23",
       subscales:[{
        label:"An Invincible Warrior! Even Goku Cannot Stop Him!",
      ...
      },
      {
        title:"Episode 24",
        subscales:[{
          label:"Ultra Instinct?! A New Power Awakens!",
      ...
      },
      {
        title:"Episode 25",
        subscales:[{
          label:"The Final Match! The Entire Universe Watches!",
  ...
  {
   title:"Arc 5 - Multiversal War Arc",
     episodes: [
      {
        title:"Episode 26",
        subscales:[{
          label:"The Barriers Break! Warriors from Every Universe!",
      ...
      },
      {
        title:"Episode 27",
        subscales:[{
          label:"Goku vs, Goku?! The Impossible Encounter!",
          items:[
      ...
      },
      {
        title:"Episode 28",
        subscales:[{
          label:"Vegeta and His Ultimate Rival!",
      ...
      },
      {
        title:"Episode 29",
        subscales:[{
          label:"The Universe Begins to Banish! Time is Running Out!",
      ...
      },
      {
        title:"Episode 30",
        subscales:[{
          label:"An Impossible Alliance! Former Rivals Fight Together!",
  ...
  {
    title:"Arc 6 - God of Destruction Arc",
    episodes:[
      
      {
        title:"Episode 31",
        subscales:[{
          label:"The Power of Seven Universes! The Last Hope!",
          items:[
     ...
     episodes: [
      {
        title:"Episode 32",
        subscales:[{
          label:"The Truth About the Gods! A Power Older Than the Universe!",
      ...
      },
      {
        title:"Episode 33",
        subscales:[{
          label:"A New Beginning! Earth Warriors Look to the Stars!",
  ...
  interface DragonBallSuperQuizProps {
  onFinish: (sessionId:string) => void;
  onBack: () => void;
  demographics?:DemographicPayload
}
 
export default function DragonBallSuperQuiz({ onFinish, onBack, demographics }: DragonBallSuperQuizProps) {
