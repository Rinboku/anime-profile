...
const THEME: ThemeTokens = {
  ...
  itemBgAnswered: 'bg-[#EC4899]/20 border-[#EC4899]/40',
  ratingSelected: 'bg-[#EC4899] text-white scale-105 shadow-lg shadow-pink-900/30',
...
export const Fairy_Tail_IMAGES: Record<number, string> = {
  0: "/images/Characters/Fairy_Tail/gildarts_clive.png",
  1: "/images/Characters/Fairy_Tail/alzack_connell.png",
  2: "/images/Characters/Fairy_Tail/angel_sorano.png",   // step 2
  3: '/images/Characters/Fairy_Tail/aria.png',        // step 3
  4: '/images/Characters/Fairy_Tail/august.png',            // step 4
  5: '/images/Characters/Fairy_Tail/bacchus_groh.png',
  6: "/images/Characters/Fairy_Tail/bickslow.png",
  7: "/images/Characters/Fairy_Tail/bisca_mulan.png",
  8: "/images/Characters/Fairy_Tail/brain_zero.png",
  9: "/images/Characters/Fairy_Tail/cana_alberona.png",
  10: "/images/Characters/Fairy_Tail/chelia_blendy.png",
  11: "/images/Characters/Fairy_Tail/carla_alberona.png",
  12: "/images/Characters/Fairy_Tail/cobra_erik.png",
  13: "/images/Characters/Fairy_Tail/droy.png",
  14: "/images/Characters/Fairy_Tail/elfman_strauss.png",
  15: "/images/Characters/Fairy_Tail/erza_scarlet.png",
  16: "/images/Characters/Fairy_Tail/eve_tearm.png",
  17: "/images/Characters/Fairy_Tail/evergreen.png",
  18: "/images/Characters/Fairy_Tail/freed_justine.png",
  19: "/images/Characters/Fairy_Tail/gajeel_redfox.png",
  20: "/images/Characters/Fairy_Tail/gray_fullbuster.png",
  21: "/images/Characters/Fairy_Tail/hades_precht.png",
  22: "/images/Characters/Fairy_Tail/happy.png",
  23: "/images/Characters/Fairy_Tail/hibiki_lates.png",
  24: "/images/Characters/Fairy_Tail/ichiya_kotobuki.png",
  25: "/images/Characters/Fairy_Tail/jackal.png",
  26: "/images/Characters/Fairy_Tail/jet.png",
  27: "/images/Characters/Fairy_Tail/mavis_vermilion.png",
  28: "/images/Characters/Fairy_Tail/natsu_dragneel.png",
  29: "/images/Characters/Fairy_Tail/orga_nanagear.png",
  30: "/images/Characters/Fairy_Tail/mirajane_strauss.png",
  31: "/images/Characters/Fairy_Tail/silver_fullbuster.png",
  32: "/images/Characters/Fairy_Tail/angel_sorano.png",   
  33: '/images/Characters/Fairy_Tail/aria.png',        
  34: '/images/Characters/Fairy_Tail/august.png',            
  35: '/images/Characters/Fairy_Tail/bacchus_groh.png',
  36: "/images/Characters/Fairy_Tail/bickslow.png",
};
...
function getEpisodeImage(title: string): string {
  ...
  return Fairy_Tail_IMAGES[episodeNumber] ?? FALLBACK_IMAGE;
}
...
const CATALOG: Arc[] = [
    ...
    episodes: [
       {
        ...
        subscales: [
          {
            label: 'The Crimson Moon Rises! A New Mission for Fairy Tail!',
      ...
      },
      {
        ...
        subscales: [
          {
            label: 'The Mysterious Mage! An Enemy Appears!',
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items: [
      ...
      },
      {
        ...
        subscales: [
          {
            label: 'Natsu Fury! The Battle Begins!',
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items: [
      ...
      },
      {
        ...
        subscales: [
          {
            label: 'Lucy and the Forbidden Key!',
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items: [
      ...
      },
      {
        ...
        subscales: [
          {
            label: 'Gray vs. the Ice Mage! A Battle of Price!',
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items: [
      ...
      },
      {
        ...
        subscales: [
          {
            label:"Erza Crimson Armor! The Knight Counterattack!",
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items:[
      ...
      },
      {
        ...
        subscales: [
          {
            label:"The Dragon Roar! An Ancient Power Awakens",
      ...
      },
      {
        ...
        subscales: [
          {
            label:"A Lost Dragon Slayer! The Dragon Within!",
  ...
  },
  {
    title:"Arc 2 - The Lost Dragon",
     episodes: [
  
      {
        ...
        subscales: [
          {
            label:"Natsu Instinct! The Dragon Within!",
      ...
      },
    {
      ...
      subscales:[
        {
          label:"Wendy Determination! A New Sky Dragon Spell!",
    ...
    },
    {
      title:"Episode 11",
      subscales:[{
        label:"Gajeel and the Iron Dragon Challenge!",
    ...
    },
    {
      title:"Episode 12",
      subscales:[{
        label:"The Dragon Heart! Natsu Faces His Destiny!",
    ...
    },
    {
      title:"Episode 13",
      subscales:[{
        label:"A Dark Guild Appears! Fairy Tail is Targeted!",
        items:[
    ...
    },
    {
      title:"Episode 14",
      subscales:[{
        label:"The Shadow Assassin! Lucy is Trapped!",
        items:[
...

  {
    title:"Episode 15",
    subscales:[{
      label:"Gray Revenge! The Frozen Battlefield!",
  ...
  },
  {
    title: "Episode 16",
    subscales:[{
      label:"Mirajane Unleashed! Dragon Soul Awakens!",
  ...
  },
  {
    title:"Episode 17",
    subscales:[{
      label:"Laxus Returns! The Thunder Dragon Strikes!",
  ...
  {
    title:"Arc 3 - Shadow Guild",
     episodes: [
      {
        title:"Episode 18",
        subscales:[{
          label:"Fairy Tail Counterattack! The Guild Goes to War!",
          items:[
      ...
      },
      {
        title:"Episode 19",
        subscales:[{
          label:"The Celestial Gate Opens! A World in Chaos!",
          items:[
      ...
      },
      {
        title:"Episode 20",
        subscales:[{
          label:"Lucy and the Celestial Spirits! A Desperate Battle!",
      ...
      },
      {
        title:"Episode 21",
        subscales:[{
          label:"The Twelve Gates! The Stars Begin to Fall!",
          items:[
...

      {
        title:"Episode 22",
        subscales:[{
          label:"Natsu and Happy! Lost in the Celestial Worth!",
  ...
  {
   title:"Arc 4 - The Celestial War",
     episodes: [
      {
       title:"Episode 23",
       subscales:[{
        label:"Erza vs. Star Warrior! A Battle Among Gods",
      ...
      },
      {
        title:"Episode 24",
        subscales:[{
          label:"The Celestial King Descends!",
      ...
      },
      {
        title:"Episode 25",
        subscales:[{
          label:"One Last Summoning! Lucy Ultimate Spell!",
  ...
  {
   title:"Arc 5 - The Demon King",
     episodes: [
      {
        title:"Episode 26",
        subscales:[{
          label:"The Demon King Awakens! The End of Magic!",
      ...
      },
      {
        title:"Episode 27",
        subscales:[{
          label:"Zeref Legacy! A Forgotten Demon Returns!",
          items:[
      ...
      },
      {
        title:"Episode 28",
        subscales:[{
          label:"Natsu vs. the Demon King! Dragon Fire Against Darkness!",
      ...
      },
      {
        title:"Episode 29",
        subscales:[{
          label:"Gray Ice Devil! The Power of Destruction!",
      ...
      },
      {
        title:"Episode 30",
        subscales:[{
          label:"Erza Last Stand! The Strongest Woman in Fairy Tail!",
    ...
    title:"Epilogue 32-33",
     episodes: [
      ...
      },
      {
        title:"Episode 33",
        subscales:[{
          label:"A New Adventure Begins! Until We Meet Again!",
  ...
  interface FairyTailQuizProps {
  onFinish: (sessionId:string) => void;
  onBack: () => void;
  demographics?:DemographicPayload
}
 
export default function FairyTailQuiz({ onFinish, onBack, demographics }: FairyTailQuizProps) {
