...
const THEME: ThemeTokens = {
  ...
  text:           'text-[#DC2626]',
  subText:        'text-[#FBBF24]',
  btnPrimary:     'bg-[#DC2626] text-white font-black hover:bg-[#b91c1c]',
  btnOutline:     'border-[#DC2626]/30 text-[#DC2626] hover:bg-[#DC2626]/10',
  itemBg:         'bg-[#DC2626]/5 border-[#DC2626]/10',
  itemBgAnswered: 'bg-[#FBBF24]/20 border-[#FBBF24]/40',
  ratingSelected: 'bg-[#FBBF24] text-[#161920] font-black scale-105 shadow-lg shadow-amber-500/40',
  ratingDefault:  'bg-[#DC2626]/10 text-[#DC2626] hover:bg-[#DC2626]/20',
  headerBorder:   'border-[#DC2626]/10',
  footerBorder:   'border-[#DC2626]/10',
  ...
  // ARC 1
  'Introduction':                                         '/images/Food_Wars/FW_1.png',
  'Machiavellianism':                                     '/images/Food_Wars/FW_2.png',
  'Narcissism':                                           '/images/Food_Wars/FW_3.png',
  'Psychopathy':                                          '/images/Food_Wars/FW_4.png',
  'Sadism':                                               '/images/Food_Wars/FW_5.png',
  'BFI-2-XS: Extraversion & Agreeableness':               '/images/Food_Wars/FW_6.png',
  'Conscientiousness, Neuroticism & Openness':            '/images/Food_Wars/FW_7.png',
  'UPPS-P Impulsivity':                                   '/images/Food_Wars/FW_8.png',
  'Need for Cognition (NFC-18)':                          '/images/Food_Wars/FW_9.png',
  // ARC 2
  'Maladaptive Daydreaming (MDS-16)':                     '/images/Food_Wars/FW_10.png',
  'Cognitive Emotion Regulation (CERQ)':                  '/images/Food_Wars/FW_11.png',
  'Psychological Pain Scale (PPS-13)':                    '/images/Food_Wars/FW_12.png',
  'Depression & Stress (DASS-21)':                        '/images/Food_Wars/FW_13.png',
  'Anxiety & Insomnia (DASS-21 + ISI)':                   '/images/Food_Wars/FW_14.png',
  'Self-Esteem & Life Satisfaction (RSES + SWLS)':        '/images/Food_Wars/FW_15.png',
  'Anhedonia (SHAPS-14)':                                 '/images/Food_Wars/FW_16.png',
  'Multidimensional State Boredom (MSBM)':                '/images/Food_Wars/FW_17.png',
  'Basic Psychological Needs (BPNS)':                     '/images/Food_Wars/FW_18.png',
  // ARC 3
  'Social Media & Smartphone Addiction (BSMAS + SAS-SV)': '/images/Food_Wars/FW_19.png',
  'Gaming Addiction & Emotion Regulation (GAS-7 + ERQ)':  '/images/Food_Wars/FW_20.png',
  'Anime Addiction Scale (CLC)':                          '/images/Food_Wars/FW_21.png',
  // ARC 4
  'Heartland Forgiveness Scale (HFS)':                    '/images/Food_Wars/FW_22.png',
  'Self-Compassion Scale (SCS-SF)':                       '/images/Food_Wars/FW_23.png',
  'Compassion for Others (CS)':                           '/images/Food_Wars/FW_24.png',
  // ARC 5
  'Brief COPE (28 items)':                                '/images/Food_Wars/FW_25.png',
  'Self-Expansion, Self-Suppression & Financial Stress':  '/images/Food_Wars/FW_26.png',
  'Benevolent Childhood Experiences (BCE)':               '/images/Food_Wars/FW_27.png',
  'Hikikomori & Social Avoidance Scale':                  '/images/Food_Wars/FW_28.png',
  'Need to Belong (NTB)':                                 '/images/Food_Wars/FW_29.png',
  // EPILOGUE
  'Anime Story World Engagement (ASWE)':                  '/images/Food_Wars/FW_30.png',
  'Narrative Identity in Anime (NISE-20)':                '/images/Food_Wars/FW_31.png',
};



export const Food_Wars_IMAGES: Record<number, string> = {
  0: "/images/Characters/Food_Wars/akira_hayama.png",
  1: "/images/Characters/Food_Wars/alice_nakiri.png",
  2: "/images/Characters/Food_Wars/asahi_nakiri.png",   
  3: '/images/Characters/Food_Wars/azami_nakiri.png',        
  4: '/images/Characters/Food_Wars/donato_gotoda.png',            
  5: '/images/Characters/Food_Wars/eishi_tsukasa.png',
  6: "/images/Characters/Food_Wars/eizan_atsuya.png",
  7: "/images/Characters/Food_Wars/erina_nakiri.png",
  8: "/images/Characters/Food_Wars/fuyumi_mizuhara.png",
  9: "/images/Characters/Food_Wars/gin_dojima.png",
  10: "/images/Characters/Food_Wars/hinako_inui.png",
  11: "/images/Characters/Food_Wars/hisako_arato.png",
  12: "/images/Characters/Food_Wars/hitoshi_sekimori.png",
  13: "/images/Characters/Food_Wars/isami_aldini.png",
  14: "/images/Characters/Food_Wars/joichiro_yukihira.png",
  15: "/images/Characters/Food_Wars/jun_shiomi.png",
  16: "/images/Characters/Food_Wars/kojiro_shinomya.png",
  17: "/images/Characters/Food_Wars/megumi_tadokoro.png",
  18: "/images/Characters/Food_Wars/momo_akanegakubo.png",
  19: "/images/Characters/Food_Wars/nene_kinokuni.png",
  20: "/images/Characters/Food_Wars/rindou_kobayashi.png",
  21: "/images/Characters/Food_Wars/ryo_kurokiba.png",
  22: "/images/Characters/Food_Wars/ryoko_sakaki.png",
  23: "/images/Characters/Food_Wars/satoshi_isshiki.png",
  24: "/images/Characters/Food_Wars/senzaemon_nakiri.png",
  25: "/images/Characters/Food_Wars/soma_yukihira.png",
  26: "/images/Characters/Food_Wars/somei_saito.png",
  27: "/images/Characters/Food_Wars/sonoka_kikuchi.png",
  28: "/images/Characters/Food_Wars/taki_tsunozaki.png",
  29: "/images/Characters/Food_Wars/takumi_aldini.png",
  30: "/images/Characters/Food_Wars/terunori_kuga.png",
  31: "/images/Characters/Food_Wars/alice_nakiri.png",
  32: "/images/Characters/Food_Wars/asahi_nakiri.png",   
  33: '/images/Characters/Food_Wars/azami_nakiri.png',        
  34: '/images/Characters/Food_Wars/donato_gotoda.png',            
  35: '/images/Characters/Food_Wars/eishi_tsukasa.png',
  36: "/images/Characters/Food_Wars/eizan_atsuya.png",
  37: "/images/Characters/Food_Wars/erina_nakiri.png",
};

const FALLBACK_IMAGE = '/images/Food_Wars/FW_14.png';
function getEpisodeImage(title: string): string {
  const match = title.match(/\d+/);
  if (!match) return FALLBACK_IMAGE;
  const episodeNumber = Number(match[0]);
  return Food_Wars_IMAGES[episodeNumber] ?? FALLBACK_IMAGE;
}
...
const CATALOG: Arc[] = [
  {
    title: 'ARC 1 — The New Generation',
    episodes: [
       {
        title: 'Episode 1',
        ...
        subscales: [
          {
            label: 'A New Semester Begins! The Next Generation of Chefs!',
      ...
      },
      {
        ...
        subscales: [
          {
            label: 'The Ultimate Shokugeki! Soma Faces a New Rival!',
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items: [
      ...
      },
      {
        ...
        subscales: [
          {
            label: 'A Dish That Surpasses Imagination! The Battle Begins!',
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items: [
      ...
      },
      {
        ...
        subscales: [
          {
            label: 'Erina Challenge! The Queen New Creation!',
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items: [
      ...
      },
      {
        ...
        subscales: [
          {
            label: 'The Secret Ingredient! Soma Counterattack!',
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items: [
      ...
      },
      {
        ...
        subscales: [
          {
            label:"A New Elite Ten! The Strongest Chefs Assemble!",
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items:[
      ...
      },
      {
        ...
        subscales: [
          {
            label:"The Hidden Kitchen! A Shokugeki Beneath the City!",
      ...
      },
      {
        ...
        subscales: [
          {
            label:"The Underground Chef! A Master of Forbidden Cuisine!",
      ...
      }       // ← virgulă după ultimul episod
    ],         // ← închide episodes[]
  },
  {
    title:"Arc 2 - The Underground Gourmet",
     episodes: [
  
      {
        ...
        subscales: [
          {
            label:"Megumi Courage! A Dish Full of Memories!",
      ...
      },
    {
      ...
      subscales:[
        {
          label:"Takumi Italian Pride! The Twin Blades Clash!",
    ...
    },
    {
      title:"Episode 11",
      subscales:[{
        label:"Soma Secret Weapon! The Ultimate Comfort Food!",
    ...
    },
    {
      title:"Episode 13",
      subscales:[{
        label:"Chefs From Around the World! The Global Shokugeki Begins!",
        items:[
    ...
    },
    {
      title:"Episode 14",
      subscales:[{
        label:"French vs. Japanese Cuisine! A Clash of Masters!",
        items:[
...

  {
    title:"Episode 15",
    subscales:[{
      label:"The Spice Warrior! An Unpredictable Dish!",
  ...
  },
  {
    title: "Episode 16",
    subscales:[{
      label:"Erina God Tongue! Can Anyone Surpass Her?",
  ...
  },
  {
    title:"Episode 17",
    subscales:[{
      label:"The Perfect Menu! Soma Impossible Challenge!",
  ...
  {
    title:"Arc 3 - The World Chefs",
     episodes: [
      {
        title:"Episode 18",
        subscales:[{
          label:"A Dish Without Borders! The World Greatest Chefs!",
          items:[
      ...
      },
      {
        title:"Episode 19",
        subscales:[{
          label:"The Grand Shokugeki Begins! Only the Best Will Survive!",
          items:[
      ...
      },
      {
        title:"Episode 20",
        subscales:[{
          label:"First Round! The Battle of the Five Flavors!",
      ...
      },
      {
        title:"Episode 21",
        subscales:[{
          label:"Soma vs. the Prodigy! Talent Against Experience!",
          items:[
...

      {
        title:"Episode 22",
        subscales:[{
          label:"Megumi Breakthrough! A Chef is Born!",
  ...
  {
   title:"Arc 4 - The Grand Shokugeki",
     episodes: [
      {
       title:"Episode 23",
       subscales:[{
        label:"Takumi Ultimate Pasta! The Italian Masterpice!",
      ...
      },
      {
        title:"Episode 24",
        subscales:[{
          label:"Erina Revolution! The Birth of a New Cuisine!",
      ...
      },
      {
        title:"Episode 25",
        subscales:[{
          label:"The Semifinals! Four CHefs, One Dream!",
  ...
  {
   title:"Arc 5 - The Dark Cuisine",
     episodes: [
      {
        title:"Episode 26",
        subscales:[{
          label:"The Dark Chefs Arrive! A New Threat to Totsuki!",
      ...
      },
      {
        title:"Episode 27",
        subscales:[{
          label:"Forbidden Ingredients! The Cuisine of Darkness!",
          items:[
      ...
      },
      {
        title:"Episode 28",
        subscales:[{
          label:"Soma Greatest Defeat?! His Cooking is Rejected!",
      ...
      },
      {
        title:"Episode 29",
        subscales:[{
          label:"Erina Decision! The Queen Takes the Field!",
      ...
      },
      {
        title:"Episode 30",
        subscales:[{
          label:"The Dark Chef Masterpiece! A Dish That Controls the Senses!",
  ...
  {
    title:"Arc 6 - The Ultimate Chef",
    episodes:[
      
      {
        title:"Episode 31",
        subscales:[{
          label:"Soma Evolution! The Secret of His Cooking!",
          items:[
  ...
  {
    title:"Epilogue 32-33",
     episodes: [
      {
        title:"Episode 32",
        subscales:[{
          label:"The Final Kitchen! The Greatest Shokugeki in History!",
      ...
      },
      {
        title:"Episode 33",
        subscales:[{
          label:"The Next Generation! A New Era of Cuisine Begins!",
  ...
  interface FoodWarsQuizProps {
  onFinish: (sessionId:string) => void;
  onBack: () => void;
  demographics?:DemographicPayload
}
 
export default function FoodWarsQuiz({ onFinish, onBack, demographics }: FoodWarsQuizProps) {
