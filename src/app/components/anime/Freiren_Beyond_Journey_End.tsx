...
const THEME: ThemeTokens = {
  ...
  text:           'text-[#E0F2FE]',
  subText:        'text-[#E3C185]',
  btnPrimary:     'bg-[#7DD3FC] text-[#0B1E28] font-bold hover:bg-[#38BDF8]',
  btnOutline:     'border-[#E0F2FE]/20 text-[#E0F2FE] hover:bg-[#E0F2FE]/10',
  itemBg:         'bg-[#E0F2FE]/5 border-[#E0F2FE]/10',
  itemBgAnswered: 'bg-[#7DD3FC]/20 border-[#7DD3FC]/40',
  ratingSelected: 'bg-[#7DD3FC] text-[#0B1E28] font-bold scale-105 shadow-lg shadow-sky-500/20',
  ratingDefault:  'bg-[#E0F2FE]/10 text-[#E0F2FE] hover:bg-[#E0F2FE]/20',
  headerBorder:   'border-[#E0F2FE]/10',
  footerBorder:   'border-[#E0F2FE]/10',
  labelColor:     'text-[#E0F2FE]',
  accentColor:    '#7DD3FC',
...
export const Freiren_Beyond_IMAGES: Record<number, string> = {
  0: "/images/Characters/Frieren/aura.png",
  1: "/images/Characters/Frieren/blei.png",
  2: "/images/Characters/Frieren/denken.png",
  3: "/images/Characters/Frieren/draht.png",
  4: "/images/Characters/Frieren/dunste.png",
  5: "/images/Characters/Frieren/edel.png",
  6: "/images/Characters/Frieren/ehre.png",
  7: "/images/Characters/Frieren/eisen.png",
  8: "/images/Characters/Frieren/fern.png",
  9: "/images/Characters/Frieren/flamme.png",
  10: "/images/Characters/Frieren/frieren.png",
  11: "/images/Characters/Frieren/genau.png",
  12: "/images/Characters/Frieren/graf_granat.png",
  13: "/images/Characters/Frieren/heiter.png",
  14: "/images/Characters/Frieren/hero_of_the_south.png",
  15: "/images/Characters/Frieren/himmel.png",
  16: "/images/Characters/Frieren/kanne.png",
  17: "/images/Characters/Frieren/kraft.png",
  18: "/images/Characters/Frieren/land.png",
  19: "/images/Characters/Frieren/laufen.png",
  20: "/images/Characters/Frieren/lawine.png",
  21: "/images/Characters/Frieren/lernen.png",
  22: "/images/Characters/Frieren/linie.png",
  23: "/images/Characters/Frieren/lugner.png",
  24: "/images/Characters/Frieren/methode.png",
  25: "/images/Characters/Frieren/qual.png",
  26: "/images/Characters/Frieren/revolte.png",
  27: "/images/Characters/Frieren/richter.png",
  28: "/images/Characters/Frieren/scharf.png",
  29: "/images/Characters/Frieren/sein.png",
  30: "/images/Characters/Frieren/sense.png",
  31: "/images/Characters/Frieren/serie.png",
  32: "/images/Characters/Frieren/stark.png",
  33: "/images/Characters/Frieren/ton.png",
  34: "/images/Characters/Frieren/ubel.png",
  35: "/images/Characters/Frieren/wirbel.png",
};
...
function getEpisodeImage(title: string): string {
  ...
  return Freiren_Beyond_IMAGES[episodeNumber] ?? FALLBACK_IMAGE;
}
...
const CATALOG: Arc[] = [
  {
    title: 'ARC 1 — The Northern Journey',
    episodes: [
       {
        title: 'Episode 1',
      ...
      },
      {
        ...
        subscales: [
          {
            label: 'The Mage Who Walked Alone',
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items: [
      ...
      },
      {
        ...
        subscales: [
          {
            label: 'A Village Beneath the Snow',
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items: [
      ...
      },
      {
        ...
        subscales: [
          {
            label: 'The Magic of Forgotten Season',
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items: [
      ...
      },
      {
        ...
        subscales: [
          {
            label: 'A Small Spell for a Long Journey',
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items: [
      ...
      },
      {
        ...
        subscales: [
          {
            label:"The Demon in the Northern Forest",
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items:[
      ...
      },
      {
        ...
        subscales: [
          {
            label:"The City Where Magic Sleeps",
      ...
      },
      {
        ...
        subscales: [
          {
            label:"An Ancient Spell and a Familiar Name",
  ...
  {
    title:"Arc 2 - The City of Forgotten Magic",
     episodes: [
  
      {
        ...
        subscales: [
          {
            label:"The Mage Who Could Not Remember",
      ...
      },
    {
      ...
      subscales:[
        {
          label:"A Memory Hidden Beneath the Ruins",
    ...
    },
    {
      title:"Episode 11",
      subscales:[{
        label:"Fern First Lesson as a Mage",
    ...
    },
    {
      title:"Episode 12",
      subscales:[{
        label:"The Night the City Lost its Stars",
    ...
    },
    {
      title:"Episode 13",
      subscales:[{
        label:"The Demon Who Knew Frieren",
        items:[
    ...
    },
    {
      title:"Episode 14",
      subscales:[{
        label:"A Spell From The Age of Heroes",
        items:[
...

  {
    title:"Episode 15",
    subscales:[{
      label:"The Village That Feared the Moon",
  ...
  {
    title:"Arc 3 - Demon Legacy",
     episodes: [
      {
        title:"Episode 18",
        subscales:[{
          label:"The Demon Last Memory",
          items:[
      ...
      },
      {
        title:"Episode 19",
        subscales:[{
          label:"The Ruins of the Ancient Elves",
          items:[
      ...
      },
      {
        title:"Episode 20",
        subscales:[{
          label:"A Thousand-Year Old Magic",
...

      {
        title:"Episode 22",
        subscales:[{
          label:"A Story Written in the Stars",
  ...
  {
   title:"Arc 4 - The Elven Ruins",
     episodes: [
      {
       title:"Fern and Frieren Promise 23",
       subscales:[{
        label:"Motherly Love",
      ...
      },
      {
        title:"Episode 24",
        subscales:[{
          label:"The Magic of Those Who Have Passed Away",
      ...
      },
      {
        title:"Episode 25",
        subscales:[{
          label:"The Door at the End of the Ruins",
  ...
  {
   title:"Arc 5 - The Great Mage Trial Arc",
     episodes: [
      {
        title:"Episode 26",
        subscales:[{
          label:"The Great Mages Gather",
      ...
      },
      {
        title:"Episode 28",
        subscales:[{
          label:"The Strongest Mage in the North",
      ...
      },
      {
        title:"Episode 29",
        subscales:[{
          label:"Frieren Greatest Mistake",
      ...
      },
      {
        title:"Episode 30",
        subscales:[{
          label:"The Spell That Cannot Be Defeated",
  ...
  {
    title:"Arc 6 -The End of Journey",
    episodes:[
    ...
    title:"Epilogue 32-33",
     episodes: [
      ...
      },
      {
        title:"Episode 33",
        subscales:[{
          label:"Beyond the End of the Journey",
  ...
  interface FreirenQuizProps {
  onFinish: (sessionId:string) => void;
  onBack: () => void;
  demographics?:DemographicPayload
}
 
export default function FreirenBeyondQuiz({ onFinish, onBack, demographics}: FreirenQuizProps) {
