...
const ANIME_SLUG = "fma_brotherhood";
...
const THEME: ThemeTokens = {
  ...
  text:           'text-[#E2E8F0]',
  subText:        'text-[#E2E8F0]',
  btnPrimary:     'bg-[#D97706] text-white hover:bg-[#B45309]',
  btnOutline:     'border-[#E2E8F0]/20 text-[#E2E8F0] hover:bg-[#E2E8F0]/10',
  itemBg:         'bg-[#E2E8F0]/5 border-[#E2E8F0]/10',
  itemBgAnswered: 'bg-[#D97706]/20 border-[#D97706]/40',
  ratingSelected: 'bg-[#D97706] text-white scale-105 shadow-lg shadow-amber-900/30',
  ratingDefault:  'bg-[#E2E8F0]/10 text-[#E2E8F0] hover:bg-[#E2E8F0]/20',
  headerBorder:   'border-[#E2E8F0]/10',
  footerBorder:   'border-[#E2E8F0]/10',
...
export const Fullmetal_Alchemist_IMAGES: Record<number, string> = {
  0: "/images/Characters/Fullmetal_Alchemist_Brotherhood/alex_louis_armstrong.png",
  1: "/images/Characters/Fullmetal_Alchemist_Brotherhood/alphonse_elric.png",
  2: "/images/Characters/Fullmetal_Alchemist_Brotherhood/buccaneer.png",
  3: "/images/Characters/Fullmetal_Alchemist_Brotherhood/darius.png",
  4: "/images/Characters/Fullmetal_Alchemist_Brotherhood/edward_elric.png",
  5: "/images/Characters/Fullmetal_Alchemist_Brotherhood/envy.png",
  6: "/images/Characters/Fullmetal_Alchemist_Brotherhood/father.png",
  7: "/images/Characters/Fullmetal_Alchemist_Brotherhood/fu.png",
  8: "/images/Characters/Fullmetal_Alchemist_Brotherhood/gluttony.png",
  9: "/images/Characters/Fullmetal_Alchemist_Brotherhood/greed.png",
  10: "/images/Characters/Fullmetal_Alchemist_Brotherhood/heinkel.png",
  11: "/images/Characters/Fullmetal_Alchemist_Brotherhood/heymans_breda.png",
  12: "/images/Characters/Fullmetal_Alchemist_Brotherhood/izumi_curtis.png",
  13: "/images/Characters/Fullmetal_Alchemist_Brotherhood/jean_havoc.png",
  14: "/images/Characters/Fullmetal_Alchemist_Brotherhood/jerso.png",
  15: "/images/Characters/Fullmetal_Alchemist_Brotherhood/kain_fuery.png",
  16: "/images/Characters/Fullmetal_Alchemist_Brotherhood/lan_fan.png",
  17: "/images/Characters/Fullmetal_Alchemist_Brotherhood/ling_yao.png",
  18: "/images/Characters/Fullmetal_Alchemist_Brotherhood/lust.png",
  19: "/images/Characters/Fullmetal_Alchemist_Brotherhood/maes_hughes.png",
  20: "/images/Characters/Fullmetal_Alchemist_Brotherhood/maria_ross.png",
  21: "/images/Characters/Fullmetal_Alchemist_Brotherhood/may_chang.png",
  22: "/images/Characters/Fullmetal_Alchemist_Brotherhood/miles.png",
  23: "/images/Characters/Fullmetal_Alchemist_Brotherhood/olivier_armstrong.png",
  24: "/images/Characters/Fullmetal_Alchemist_Brotherhood/pride_selim.png",
  25: "/images/Characters/Fullmetal_Alchemist_Brotherhood/riza_hawkeye.png",
  26: "/images/Characters/Fullmetal_Alchemist_Brotherhood/roy_mustang.png",
  27: "/images/Characters/Fullmetal_Alchemist_Brotherhood/scar.png",
  28: "/images/Characters/Fullmetal_Alchemist_Brotherhood/solf_kimblee.png",
  29: "/images/Characters/Fullmetal_Alchemist_Brotherhood/van_hohenheim.png",
  30: "/images/Characters/Fullmetal_Alchemist_Brotherhood/vato_falman.png",
  31: "/images/Characters/Fullmetal_Alchemist_Brotherhood/winry_rockbell.png",
  32: "/images/Characters/Fullmetal_Alchemist_Brotherhood/wrath_bradley.png",
  33: "/images/Characters/Fullmetal_Alchemist_Brotherhood/yoki.png",
  34: "/images/Characters/Fullmetal_Alchemist_Brotherhood/zampano.png",
};
...
function getEpisodeImage(title: string): string {
  ...
  return Fullmetal_Alchemist_IMAGES[episodeNumber] ?? FALLBACK_IMAGE;
}
...
const CATALOG: Arc[] = [
  {
    title: 'ARC 1 — The Philosopher Legacy',
    episodes: [
       {
        title: 'Episode 1',
        ...
        subscales: [
          {
            label: 'A New Journey! The Alchemist Brothers Return',
      ...
      },
      {
        ...
        subscales: [
          {
            label: 'The Forgotten Philosopher Stone',
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items: [
      ...
      },
      {
        ...
        subscales: [
          {
            label: 'The Alchemist in the Shadows',
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items: [
      ...
      },
      {
        ...
        subscales: [
          {
            label: 'Edward Resolve! The Price of Truth!',
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items: [
      ...
      },
      {
        ...
        subscales: [
          {
            label:"A Stone That Should Never Exist",
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items:[
  ...
  {
    title:"Arc 2 - The Ishvalan Shadows",
     episodes: [
  
      {
        ...
        subscales: [
          {
            label:"The Alchemist who Refused to Kill",
      ...
      },
    {
      ...
      subscales:[
        {
          label:"Memories Written in Blood",
    ...
    },
    {
      title:"Episode 12",
      subscales:[{
        label:"Atonement! The Flames if the Past",
    ...
    },
    {
      title:"Episode 13",
      subscales:[{
        label:"The Enemy Within Central",
        items:[
    ...
    },
    {
      title:"Episode 14",
      subscales:[{
        label:"A New Homunculus Appears!",
        items:[
  ...
  },
  {
    title: "Episode 16",
    subscales:[{
      label:"Roy Mustang Counterattack!",
  ...
  },
  {
    title:"Episode 17",
    subscales:[{
      label:"The Ultimate Shield! Alchemy vs. Immortality!",
  ...
  {
    title:"Arc 3 - The Homunculus Conspiracy",
     episodes: [
      {
        title:"Episode 18",
        subscales:[{
          label:"The Truth Behind the Homunculi",
          items:[
      ...
      },
      {
        title:"Episode 19",
        subscales:[{
          label:"The Crimson Alchemist Returns",
          items:[
      ...
      },
      {
        title:"Episode 20",
        subscales:[{
          label:"A Forbidden Transmutation",
      ...
      },
      {
        title:"Episode 21",
        subscales:[{
          label:"Edward vs. the Crimson Alchemist!",
          items:[
...

      {
        title:"Episode 22",
        subscales:[{
          label:"Alphonse Soul Begins to Fade",
  ...
  {
   title:"Arc 4 - The Crimson Alchemist",
     episodes: [
      {
       title:"Episode 23",
       subscales:[{
        label:"Winry Choice! The Heart of a a Mechanic!",
      ...
      },
      {
        title:"Episode 24",
        subscales:[{
          label:"The Philosopher Stone Awakens!",
  ...
  {
   title:"Arc 5 - The Gate of Truth ",
     episodes: [
      {
        title:"Episode 26",
        subscales:[{
          label:"Beyond the Gate! The World of Truth",
      ...
      },
      {
        title:"Episode 29",
        subscales:[{
          label:"Edward and Alphonse! Brothers Against Fate!",
      ...
      },
      {
        title:"Episode 30",
        subscales:[{
          label:"The Truth Revealed! The Origin of Father!",
  ...
  {
    title:"Arc 6 - The Last Transmutation",
    episodes:[
      
      {
        title:"Episode 31",
        subscales:[{
          label:"The Sacrifice of an Alchemist",
          items:[
    ...
    title:"Epilogue 32-33",
     episodes: [
      ...
      },
      {
        title:"Episode 33",
        subscales:[{
          label:"Brothers! Beyond the Gate of Truth!",
  ...
  interface FullmetalQuizProps {
  onFinish: (sessionId:string) => void;
  onBack: () => void;
  demographics?:DemographicPayload
}
 
export default function FullmetalAlchemistQuiz({ onFinish, onBack, demographics }: FullmetalQuizProps) {
