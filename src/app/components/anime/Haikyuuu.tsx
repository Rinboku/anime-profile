...
const THEME: ThemeTokens = {
  ...
  text:           'text-[#F97316]',
  subText:        'text-[#38BDF8]',
  btnPrimary:     'bg-[#F97316] text-white font-bold hover:bg-[#ea580c]',
  btnOutline:     'border-[#F97316]/30 text-[#F97316] hover:bg-[#F97316]/10',
  itemBg:         'bg-[#F97316]/5 border-[#F97316]/10',
  itemBgAnswered: 'bg-[#F97316]/20 border-[#F97316]/40',
  ratingSelected: 'bg-[#F97316] text-white font-bold scale-105 shadow-lg shadow-orange-900/40',
  ratingDefault:  'bg-[#F97316]/10 text-[#F97316] hover:bg-[#F97316]/20',
  headerBorder:   'border-[#F97316]/10',
  footerBorder:   'border-[#F97316]/10',
...
export const HAIKYUU_IMAGES: Record<number, string> = {
  0: "/images/Characters/Haikyuu/akaashi_keiji.png",
  1: "/images/Characters/Haikyuu/aone_takanobu.png",
  2: "/images/Characters/Haikyuu/aran_ojiro.png",
  3: "/images/Characters/Haikyuu/asahi_azumane.png",
  4: "/images/Characters/Haikyuu/bokuto_koutarou.png",
  5: "/images/Characters/Haikyuu/daichi_sawamura.png",
  6: "/images/Characters/Haikyuu/ennoshita_chikara.png",
  7: "/images/Characters/Haikyuu/fukunaga_shohei.png",
  8: "/images/Characters/Haikyuu/futakuchi_kenji.png",
  9: "/images/Characters/Haikyuu/goshiki_tsutomu.png",
  10: "/images/Characters/Haikyuu/hanamaki_takahiro.png",
  11: "/images/Characters/Haikyuu/hinata_shoyo.png",
  12: "/images/Characters/Haikyuu/hoshiumi_kourai.png",
  13: "/images/Characters/Haikyuu/inuoka_sou.png",
  14: "/images/Characters/Haikyuu/iwaizumi_hajime.png",
  15: "/images/Characters/Haikyuu/kageyama_tobio.png",
  16: "/images/Characters/Haikyuu/kanoka_amanai.png",
  17: "/images/Characters/Haikyuu/kenma_kozume.png",
  18: "/images/Characters/Haikyuu/kindaichi_yuutarou.png",
  19: "/images/Characters/Haikyuu/kinoshita_hisashi.png",
  20: "/images/Characters/Haikyuu/kita_shinsuke.png",
  21: "/images/Characters/Haikyuu/kiyoko_shimizu.png",
  22: "/images/Characters/Haikyuu/komi_haruki.png",
  23: "/images/Characters/Haikyuu/konoha_akinori.png",
  24: "/images/Characters/Haikyuu/kunimi_akira.png",
  25: "/images/Characters/Haikyuu/kuroo_tetsurou.png",
  26: "/images/Characters/Haikyuu/lev_haiba.png",
  27: "/images/Characters/Haikyuu/matsukawa_issei.png",
  28: "/images/Characters/Haikyuu/miya_atsumu.png",
  29: "/images/Characters/Haikyuu/miya_osamu.png",
  30: "/images/Characters/Haikyuu/narita_kazuhito.png",
  31: "/images/Characters/Haikyuu/nekomata_yasufuni.png",
  32: "/images/Characters/Haikyuu/nishinoya_yu.png",
  33: "/images/Characters/Haikyuu/ohira_reon.png",
  34: "/images/Characters/Haikyuu/oikawa_tooru.png",
  35: "/images/Characters/Haikyuu/sakusa_kiyoomi.png",
  36: "/images/Characters/Haikyuu/sarukui_yamoto.png",
  37: "/images/Characters/Haikyuu/semi_eita.png",
  38: "/images/Characters/Haikyuu/shirabu_kenjirou.png",
  39: "/images/Characters/Haikyuu/sugawara_koshi.png"
};
...
function getEpisodeImage(title: string): string {
  ...
  return HAIKYUU_IMAGES[episodeNumber] ?? FALLBACK_IMAGE;
}
...
const CATALOG: Arc[] = [
    ...
    episodes: [
       {
        ...
        subscales: [
          {
            label: 'The Small Giant Successor!',
      ...
      },
      {
        ...
        subscales: [
          {
            label: 'A New Team Takes the Court',
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items: [
      ...
      },
      {
        ...
        subscales: [
          {
            label: 'The First Practice Match!',
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items: [
      ...
      },
      {
        ...
        subscales: [
          {
            label: 'The Setter and the Spiker',
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items: [
      ...
      },
      {
        ...
        subscales: [
          {
            label: 'A Quick Attack Born From Trust',
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items: [
      ...
      },
      {
        ...
        subscales: [
          {
            label:"The Rival Across the Net",
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items:[
      ...
      },
      {
        ...
        subscales: [
          {
            label:"The Battle Begins! Karasuno vs. Its Rival!",
  ...
  {
    title:"Arc 2 - The Rising Challengers",
     episodes: [
    ...
    },
    {
      title:"Episode 14",
      subscales:[{
        label:"The Road to Nationals Begins!",
        items:[
  ...
  },
  {
    title: "Episode 16",
    subscales:[{
      label:"The Battle of the Captains!",
  ...
  },
  {
    title:"Episode 17",
    subscales:[{
      label:"Karasuno Ultimate Combination!",
  ...
  {
    title:"Arc 3 - The Road to Nationals Arc",
     episodes: [
      {
        title:"Episode 18",
        subscales:[{
          label:"The Ace vs. The Wall",
          items:[
      ...
      },
      {
        title:"Episode 21",
        subscales:[{
          label:"Nationals! The Strongest Teams Gather!",
          items:[
...

      {
        title:"Episode 22",
        subscales:[{
          label:"The Monster on the Court",
  ...
  {
   title:"Arc 4 - The National Tournament",
     episodes: [
      {
       title:"Episode 23",
       subscales:[{
        label:"Hinata vs. Little Giant",
  ...
  {
   title:"Arc 5 - The Final Rivalry ",
     episodes: [
      {
        title:"Episode 26",
        subscales:[{
          label:"Kageyama Evolution!",
      ...
      },
      {
        title:"Episode 27",
        subscales:[{
          label:"The Point That Changes Everything",
          items:[
      ...
      },
      {
        title:"Episode 30",
        subscales:[{
          label:"A New Generation Takes Flight",
  ...
  {
    title:"Arc 6 - The Next Generation",
    episodes:[
      
      {
        title:"Episode 31",
        subscales:[{
          label:"The Court is Still Waiting!",
          items:[
  ...
  {
    title:"Epilogue 32-34",
     episodes: [
      {
        title:"Episode 32",
        subscales:[{
          label:"The Volleyball That Connects Us!",
      ...
      {
        title:"Until We Meet Again! The Ball is Still in the Air",
        subscales:[{
          label:"Seventh Hokage ceremony",
  ...
  interface HaikyuuQuizProps {
  onFinish: (sessionId:string) => void;
  onBack: () => void;
  demographics?:DemographicPayload
}
 
export default function HaikyuuQuiz({ onFinish, onBack, demographics }: HaikyuuQuizProps) {
