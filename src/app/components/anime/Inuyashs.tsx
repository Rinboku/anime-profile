...
const THEME: ThemeTokens = {
  ...
  text:           'text-[#DC2626]',
  subText:        'text-[#FCD34D]',
  btnPrimary:     'bg-[#DC2626] text-white font-bold hover:bg-[#b91c1c]',
  btnOutline:     'border-[#DC2626]/30 text-[#DC2626] hover:bg-[#DC2626]/10',
  itemBg:         'bg-[#DC2626]/5 border-[#DC2626]/10',
  itemBgAnswered: 'bg-[#FCD34D]/20 border-[#FCD34D]/40',
  ratingSelected: 'bg-[#DC2626] text-white font-bold scale-105 shadow-lg shadow-red-900/40',
...
export const INUYASHA_IMAGES: Record<number, string> = {
  0: "/images/Characters/Inuyasha/ayame.png",
  1: "/images/Characters/Inuyasha/bankotsu.png",
  2: "/images/Characters/Inuyasha/byakuya.png",
  3: "/images/Characters/Inuyasha/hakudoshi.png",
  4: "/images/Characters/Inuyasha/inuyasha.png",
  5: "/images/Characters/Inuyasha/izayoi.png",
  6: "/images/Characters/Inuyasha/juromaru.png",
  7: "/images/Characters/Inuyasha/kaede.png",
  8: "/images/Characters/Inuyasha/kagome_higurashi.png",
  9: "/images/Characters/Inuyasha/kagura.png",
  10: "/images/Characters/Inuyasha/kanna.png",
  11: "/images/Characters/Inuyasha/kikyo.png",
  12: "/images/Characters/Inuyasha/koga.png",
  13: "/images/Characters/Inuyasha/kohaku.png",
  14: "/images/Characters/Inuyasha/midoriko.png",
  15: "/images/Characters/Inuyasha/miroku.png",
  16: "/images/Characters/Inuyasha/myoga.png",
  17: "/images/Characters/Inuyasha/naraku.png",
  18: "/images/Characters/Inuyasha/rin.png",
  19: "/images/Characters/Inuyasha/sango.png",
  20: "/images/Characters/Inuyasha/seshomaru.png",
  21: "/images/Characters/Inuyasha/shippo.png",
  22: "/images/Characters/Inuyasha/toga.png",
  23: "/images/Characters/Inuyasha/totosai.png",
  24: "/images/Characters/Inuyasha/tsubaki.png",
  25: "/images/Characters/Inuyasha/inuyasha.png",
  26: "/images/Characters/Inuyasha/izayoi.png",
  27: "/images/Characters/Inuyasha/juromaru.png",
  28: "/images/Characters/Inuyasha/kaede.png",
  29: "/images/Characters/Inuyasha/kagome_higurashi.png",
  30: "/images/Characters/Inuyasha/kagura.png",
  31: "/images/Characters/Inuyasha/kanna.png",
  32: "/images/Characters/Inuyasha/kikyo.png",
  33: "/images/Characters/Inuyasha/koga.png",
  34: "/images/Characters/Inuyasha/kohaku.png",
  35: "/images/Characters/Inuyasha/midoriko.png",
};
...
function getEpisodeImage(title: string): string {
  ...
  return INUYASHA_IMAGES[episodeNumber] ?? FALLBACK_IMAGE;
}
...
const CATALOG: Arc[] = [
    ...
    episodes: [
       {
        ...
        subscales: [
          {
            label: 'The Well That Connects Two Worlds!',
      ...
      },
      {
        ...
        subscales: [
          {
            label: 'A Half-Demon Awakens! The Shikon Jewel Appears!',
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items: [
      ...
      },
      {
        ...
        subscales: [
          {
            label: 'Fragments of the Sacred Jewel!',
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items: [
      ...
      },
      {
        ...
        subscales: [
          {
            label: 'Inuyasha and Kagome! A Dangerous Alliance!',
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items: [
      ...
      },
      {
        ...
        subscales: [
          {
            label:"The Jewel Shatters! A New Journey Begins!",
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items:[
      ...
      },
      {
        ...
        subscales: [
          {
            label:"A Demon Clan Rises! The Battle for the Jewel!",
      ...
      },
      {
        ...
        subscales: [
          {
            label:"Sesshomaru Appears! Brothers in Conflict!",
  ...
  },
  {
      ...
      },
    {
      ...
      subscales:[
        {
          label:"A Wolf Demon Enters the Battle!",
    ...
    },
    {
      title:"Episode 11",
      subscales:[{
        label:"Kagome Sacred Arrow! A Purifying Light!",
    ...
    },
    {
      title:"Episode 12",
      subscales:[{
        label:"The Demon Within Inuyasha!",
    ...
    },
    {
      title:"Episode 13",
      subscales:[{
        label:"A Battle Beneath the Blood Moon!",
        items:[
    ...
    },
    {
      title:"Episode 14",
      subscales:[{
        label:"The Band of the Seven Returns",
        items:[
...

  {
    title:"Episode 15",
    subscales:[{
      label:"A Deadly Warrior! The Seven Begin Their Hunt!",
  ...
  },
  {
    title: "Episode 16",
    subscales:[{
      label:"Sango Determination! The Demon Slayer Battle!",
  ...
  },
  {
    title:"Episode 17",
    subscales:[{
      label:"Miroku Wind Tunnel! A Dangerous Gamble!",
  ...
  {
    title:"Arc 3 - The Band of the Seven",
     episodes: [
      {
        title:"Episode 18",
        subscales:[{
          label:"Koga vs. the band of Seven",
          items:[
      ...
      },
      {
        title:"Episode 20",
        subscales:[{
          label:"The Final Battle of the Seven",
      ...
      },
      {
        title:"Episode 21",
        subscales:[{
          label:"The Sacred Mountain! A Barrier of Light!",
          items:[
  ...
  {
   title:"Arc 4 - Sacred Mountains",
     episodes: [
      {
       title:"Episode 23",
       subscales:[{
        label:"Sesshomaru New Blade!",
      ...
      },
      {
        title:"Episode 24",
        subscales:[{
          label:"Kagoem Trapped in the Sacred Realm!",
      ...
      },
      {
        title:"Episode 25",
        subscales:[{
          label:"The Demon That Feeds on Souls!",
  ...
  {
   title:"Arc 5 - Naraku Conspiracy",
     episodes: [
      {
        title:"Episode 26",
        subscales:[{
          label:"Inuyasha vs. the Guardian of the Mountain!",
      ...
      },
      {
        title:"Episode 27",
        subscales:[{
          label:"The Sacred Jewel Dark Secret!",
          items:[
      ...
      },
      {
        title:"Episode 28",
        subscales:[{
          label:"Naraku Shadow! The Enemy Reveals Himself!",
      ...
      },
      {
        title:"Episode 29",
        subscales:[{
          label:"A Trap for Inuyasha and Kagome!",
      ...
      },
      {
        title:"Episode 30",
        subscales:[{
          label:"The Truth Behind the Sacred Jewel!",
  ...
  {
    title:"Arc 6 - Last Piece of the Jewel",
    episodes:[
      
      {
        title:"Episode 31",
        subscales:[{
          label:"The Shikon Jewel Awakens!",
          items:[
     ...
     episodes: [
      {
        title:"Episode 32",
        subscales:[{
          label:"The Final Battle! Inuyasha vs. Naraku!",
      ...
      },
      {
        title:"Episode 33",
        subscales:[{
          label:"Beyond the Well! A New Beginning!",
  ...
  interface InuyashaQuizProps {
  onFinish: (sessionId:string) => void;
  onBack: () => void;
  demographics?:DemographicPayload
}
 
export default function InuyashaQuiz({ onFinish, onBack, demographics }: InuyashaQuizProps) {
