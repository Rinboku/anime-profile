...
const ANIME_SLUG = "jojos-bizarre-adventure";
...
const THEME: ThemeTokens = {
  ...
  text:           'text-[#F43F93]',
  subText:        'text-[#EAB308]',
  btnPrimary:     'bg-[#EAB308] text-black font-black hover:bg-[#ca9b06]',
  btnOutline:     'border-[#F43F93]/30 text-[#F43F93] hover:bg-[#F43F93]/10',
  itemBg:         'bg-[#F43F93]/5 border-[#F43F93]/10',
  itemBgAnswered: 'bg-[#EAB308]/20 border-[#EAB308]/40',
  ratingSelected: 'bg-[#EAB308] text-black font-black scale-105 shadow-lg shadow-yellow-500/40',
  ratingDefault:  'bg-[#F43F93]/10 text-[#F43F93] hover:bg-[#F43F93]/20',
  headerBorder:   'border-[#F43F93]/10',
  footerBorder:   'border-[#F43F93]/10',
  labelColor:     'text-[#F43F93]',
  accentColor:    '#EAB308',
...
export const JOJO_IMAGES: Record<number, string> = {
  0: "/images/Characters/Jojo_Bizzarre_Adventures/akira-otoishi.png",
  1: "/images/Characters/Jojo_Bizzarre_Adventures/aya-tsuji.png",
  2: "/images/Characters/Jojo_Bizzarre_Adventures/bruno-bucciarati.png",
  3: "/images/Characters/Jojo_Bizzarre_Adventures/caesar-zeppeli.png",
  4: "/images/Characters/Jojo_Bizzarre_Adventures/cioccolata.png",
  5: "/images/Characters/Jojo_Bizzarre_Adventures/cioccolata.png",
  6: "/images/Characters/Jojo_Bizzarre_Adventures/daniel-j-darby.png",
  7: "/images/Characters/Jojo_Bizzarre_Adventures/diavolo.png",
  8: "/images/Characters/Jojo_Bizzarre_Adventures/diego-brando.png",
  9: "/images/Characters/Jojo_Bizzarre_Adventures/dio-brando.png",
  10: "/images/Characters/Jojo_Bizzarre_Adventures/donatella-una.png",
  11: "/images/Characters/Jojo_Bizzarre_Adventures/donatello-versus.png",
  12: "/images/Characters/Jojo_Bizzarre_Adventures/emporio-alnino.png",
  13: "/images/Characters/Jojo_Bizzarre_Adventures/enrico-pucci.png",
  14: "/images/Characters/Jojo_Bizzarre_Adventures/enya-the-hag.png",
  15: "/images/Characters/Jojo_Bizzarre_Adventures/erina-pendleton.png",
  16: "/images/Characters/Jojo_Bizzarre_Adventures/ermes-costello.png",
  17: "/images/Characters/Jojo_Bizzarre_Adventures/esidisi.png",
  18: "/images/Characters/Jojo_Bizzarre_Adventures/foo-fighters.png",
  19: "/images/Characters/Jojo_Bizzarre_Adventures/formaggio.png",
  20: "/images/Characters/Jojo_Bizzarre_Adventures/funny-valentine.png",
  21: "/images/Characters/Jojo_Bizzarre_Adventures/ghiaccio.png",
  22: "/images/Characters/Jojo_Bizzarre_Adventures/giorno-giovanna.png",
  23: "/images/Characters/Jojo_Bizzarre_Adventures/guido-mista.png",
  24: "/images/Characters/Jojo_Bizzarre_Adventures/gwess.png",
  25: "/images/Characters/Jojo_Bizzarre_Adventures/gyro-zeppeli.png",
  26: "/images/Characters/Jojo_Bizzarre_Adventures/hol-horse.png",
  27: "/images/Characters/Jojo_Bizzarre_Adventures/holy-kujo.png",
  28: "/images/Characters/Jojo_Bizzarre_Adventures/hot-pants.png",
  29: "/images/Characters/Jojo_Bizzarre_Adventures/iggy.png",
  30: "/images/Characters/Jojo_Bizzarre_Adventures/illuso.png",
  31: "/images/Characters/Jojo_Bizzarre_Adventures/jean-pierre-polnareff.png",
  32: "/images/Characters/Jojo_Bizzarre_Adventures/johnny-joestar.png",
  33: "/images/Characters/Jojo_Bizzarre_Adventures/jonathan-joestar.png",
  34: "/images/Characters/Jojo_Bizzarre_Adventures/joseph_joestar.png",
  35: "/images/Characters/Jojo_Bizzarre_Adventures/josuke-higashigata.png",
  36: "/images/Characters/Jojo_Bizzarre_Adventures/jotaro-kujo.png",
  37: "/images/Characters/Jojo_Bizzarre_Adventures/kars.png",
  38: "/images/Characters/Jojo_Bizzarre_Adventures/keicho-nijimura.png",
  39: "/images/Characters/Jojo_Bizzarre_Adventures/koichi-hirose.png",
  40: "/images/Characters/Jojo_Bizzarre_Adventures/leone-abbacchio.png",
  41: "/images/Characters/Jojo_Bizzarre_Adventures/lisa-lisa.png",
  42: "/images/Characters/Jojo_Bizzarre_Adventures/lucy-steel.png",
};
...
function getEpisodeImage(title: string): string {
  ...
  return JOJO_IMAGES[episodeNumber] ?? FALLBACK_IMAGE;
}
...
const CATALOG: Arc[] = [
  {
    title: 'ARC 1 — Phantom Bloodline Legacy',
    episodes: [
       {
        title: 'Episode 1',
        ...
        subscales: [
          {
            label: 'A Bizzarre Encounter! The Joestar Legacy Awakens!',
      ...
      },
      {
        ...
        subscales: [
          {
            label: 'A Mysterious Stranger! The First Stand Appears!',
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items: [
      ...
      },
      {
        ...
        subscales: [
          {
            label: 'The Power of Joestar Blood!',
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items: [
      ...
      },
      {
        ...
        subscales: [
          {
            label: 'All Enemy in the Shadows',
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items: [
      ...
      },
      {
        ...
        subscales: [
          {
            label: 'The Curse of the Ancient Mask!',
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items: [
      ...
      },
      {
        ...
        subscales: [
          {
            label:"The Battle of Two Destinies!",
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items:[
      ...
      },
      {
        ...
        subscales: [
          {
            label:"Stand Up! The Invisible Power!",
      ...
      },
      {
        ...
        subscales: [
          {
            label:"A Bizarre Ability! Nothing Is What It Seems!",
  ...
  {
    title:"Arc 2 - The Stand Awakening",
     episodes: [
    ...
    },
    {
      title:"Episode 11",
      subscales:[{
        label:"A Stand Battle in the Night!",
    ...
    },
    {
      title:"Episode 13",
      subscales:[{
        label:"The Ultimate Stand User Appears!",
        items:[
    ...
    },
    {
      title:"Episode 14",
      subscales:[{
        label:"The Crimson Emperor! Time Itself Is Defeated!",
        items:[
  ...
  },
  {
    title:"Episode 17",
    subscales:[{
      label:"A Friend Becomes an Enemy!",
  ...
  {
    title:"Arc 3 - Crimson Emperor ",
     episodes: [
      {
        title:"Episode 18",
        subscales:[{
          label:"The Joestar Counterattack!",
          items:[
      ...
      },
      {
        title:"Episode 19",
        subscales:[{
          label:"The Secret Behind the Crimson Stand!",
          items:[
...

      {
        title:"Episode 22",
        subscales:[{
          label:"A New Generation of Stand Users!",
  ...
  {
   title:"Arc 4 - Stone Ocean",
     episodes: [
      {
       title:"Episode 23",
       subscales:[{
        label:"The Green Baby! A Bizarre Mystery!",
      ...
      },
      {
        title:"Episode 24",
        subscales:[{
          label:"Gravity Turns Against Us!",
  ...
  {
   title:"Arc 5 - Steel Ball",
     episodes: [
      {
        title:"Episode 26",
        subscales:[{
          label:"A Stand Beyond Understanding!",
      ...
      },
      {
        title:"Episode 27",
        subscales:[{
          label:"The World Begins to Change!",
          items:[
      ...
      },
      {
        title:"Episode 28",
        subscales:[{
          label:"The Steel Ball! A New Journey Begins!",
      ...
      },
      {
        title:"Episode 29",
        subscales:[{
          label:"The Race Across the Continent!",
      ...
      },
      {
        title:"Episode 30",
        subscales:[{
          label:"A Rival From Another World!",
  ...
  {
    title:"Arc 6 - The Bizarre Destiny",
    episodes:[
      
      {
        title:"Episode 31",
        subscales:[{
          label:"The Final Stand! Destiny Collides!",
          items:[
     ...
     episodes: [
      {
        title:"Episode 32",
        subscales:[{
          label:"The Joestar Bloodline! One Last Battle!",
      ...
      },
      {
        title:"Episode 33",
        subscales:[{
          label:"To Be Continued...The Bizarre Adventure Lives On!",
  ...
  interface JojoQuizProps {
  onFinish: (sessionId:string) => void;
  onBack: () => void;
  demographics?:DemographicPayload
}
 
export default function JojoQuiz({ onFinish, onBack, demographics}: JojoQuizProps) {
