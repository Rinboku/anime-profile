...
const ANIME_SLUG = "jujutsu-kaisen";
...
const THEME: ThemeTokens = {
  ...
  text:           'text-black',
  subText:        'text-[#1E293B]',
  btnPrimary:     'bg-[#6D28D9] text-white hover:bg-[#5B21B6]',
  btnOutline:     'border-black/20 text-black hover:bg-black/5',
  itemBg:         'bg-black/5 border-black/10',
  itemBgAnswered: 'bg-[#6D28D9]/20 border-[#6D28D9]/40',
  ratingSelected: 'bg-[#6D28D9] text-white scale-105 shadow-lg shadow-purple-900/20',
...
export const JUJUTSU_KAISEN_IMAGES: Record<number, string> = {
  0: "/images/Jujutsu_Kaisen/JJ_Angel.png",
  1: "/images/Jujutsu_Kaisen/JJ_Aoi_Todo.png",
  2: "/images/Jujutsu_Kaisen/JJ_Atsuya_Kusakabe.png",
  3: "/images/Jujutsu_Kaisen/JJ_Choso.png",
  4: "/images/Jujutsu_Kaisen/JJ_Hajime_Kashimo.png",
  5: "/images/Jujutsu_Kaisen/JJ_Hanami.png",
  6: "/images/Jujutsu_Kaisen/JJ_Hiromi_Higuruma.png",
  7: "/images/Jujutsu_Kaisen/JJ_Jogo.png",
  8: "/images/Jujutsu_Kaisen/JJ_Kasumi_Miwa.png",
  9: "/images/Jujutsu_Kaisen/JJ_Kenjaku.png",
  10: "/images/Jujutsu_Kaisen/JJ_Kinji_Hakari.png",
  11: "/images/Jujutsu_Kaisen/JJ_Kirara_Hoshi.png",
  12: "/images/Jujutsu_Kaisen/JJ_Kiyotaka_Ijichi.png",
  13: "/images/Jujutsu_Kaisen/JJ_Kokichi_Muta.png",
  14: "/images/Jujutsu_Kaisen/JJ_Mahito.png",
  15: "/images/Jujutsu_Kaisen/JJ_Mai_Zenin.png",
  16: "/images/Jujutsu_Kaisen/JJ_Maki_Zenin.png",
  17: "/images/Jujutsu_Kaisen/JJ_Masamichi_Yaga.png",
  18: "/images/Jujutsu_Kaisen/JJ_Megumi_Fushiguro.png",
  19: "/images/Jujutsu_Kaisen/JJ_Mei_Mei.png",
  20: "/images/Jujutsu_Kaisen/JJ_Momo_Nishimiya.png",
  21: "/images/Jujutsu_Kaisen/JJ_Nanami_Kento.png",
  22: "/images/Jujutsu_Kaisen/JJ_Naobito_Zenin.png",
  23: "/images/Jujutsu_Kaisen/JJ_Naoya_Zenin.png",
  24: "/images/Jujutsu_Kaisen/JJ_Nobara_FKugisaki.png",
  25: "/images/Jujutsu_Kaisen/JJ_Noritoshi_Kamo.png",
  26: "/images/Jujutsu_Kaisen/JJ_Panda.png",
  27: "/images/Jujutsu_Kaisen/JJ_Ryomen_Sukuna.png",
  28: "/images/Jujutsu_Kaisen/JJ_Ryu_Ishigori.png",
  29: "/images/Jujutsu_Kaisen/JJ_Satorou_Gojo.png",
  30: "/images/Jujutsu_Kaisen/JJ_Takako_Uro.png",
  31: "/images/Jujutsu_Kaisen/JJ_Toge_Inumaki.png",
  32: "/images/Jujutsu_Kaisen/JJ_Toji_Fushiguro.png",
  33: "/images/Jujutsu_Kaisen/JJ_Yoko_Ieiri.png",
  34: "/images/Jujutsu_Kaisen/JJ_Yuji_Itadori.png",
  35: "/images/Jujutsu_Kaisen/JJ_Yuta_Okkotsu.png",
  36: "/images/Jujutsu_Kaisen/JJ_Hiromi_Higuruma.png",
  37: "/images/Jujutsu_Kaisen/JJ_Jogo.png",
  38: "/images/Jujutsu_Kaisen/JJ_Kasumi_Miwa.png",
  39: "/images/Jujutsu_Kaisen/JJ_Kenjaku.png",
  40: "/images/Jujutsu_Kaisen/JJ_Kinji_Hakari.png",
  41: "/images/Jujutsu_Kaisen/JJ_Kirara_Hoshi.png",
  42: "/images/Jujutsu_Kaisen/JJ_Kiyotaka_Ijichi.png",
  43: "/images/Jujutsu_Kaisen/JJ_Kokichi_Muta.png",
  44: "/images/Jujutsu_Kaisen/JJ_Mahito.png",
};
...
function getEpisodeImage(title: string): string {
  ...
  return JUJUTSU_KAISEN_IMAGES[episodeNumber] ?? FALLBACK_IMAGE;
}
...
const CATALOG: Arc[] = [
    ...
    episodes: [
       {
        ...
        subscales: [
          {
            label: 'A Cursed Object! Yuji Itadori Enters the World of Jujutsu!',
      ...
      },
      {
        ...
        subscales: [
          {
            label: 'Sukuna Awakens! The King of Curses!',
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items: [
      ...
      },
      {
        ...
        subscales: [
          {
            label: 'A New Mission! The Curse Beneath the School!',
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items: [
      ...
      },
      {
        ...
        subscales: [
          {
            label: 'The First Exorcism! Yuji Resolve!',
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items: [
      ...
      },
      {
        ...
        subscales: [
          {
            label:"The Vessel! A Pact With Sukuna!",
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items:[
      ...
      },
      {
        ...
        subscales: [
          {
            label:"The Kyoto Goodwill Event Begins!",
      ...
      },
      {
        ...
        subscales: [
          {
            label:"Sorcerers Clash! Tokyo vs. Kyoto!",
  ...
  },
  {
    title:"Arc 2 - Kyoto Exchange",
     episodes: [
  
      {
        ...
        subscales: [
          {
            label:"Todo Appears! What Is Your Type?",
      ...
      },
    {
      ...
      subscales:[
        {
          label:"Black Flash! Yuji Power Explodes!",
    ...
    },
    {
      title:"Episode 11",
      subscales:[{
        label:"The Cursed Spirit Attack!",
    ...
    },
    {
      title:"Episode 12",
      subscales:[{
        label:"Maki Heavenly Restriction!",
    ...
    },
    {
      title:"Episode 13",
      subscales:[{
        label:"The Exchange Event Ends! A New Threat Emerges!",
        items:[
    ...
    },
    {
      title:"Episode 14",
      subscales:[{
        label:"A Cursed Womb! Something Terrible is Born!",
        items:[
...

  {
    title:"Episode 15",
    subscales:[{
      label:"The Death Painting! A family of Curses!",
  ...
  },
  {
    title: "Episode 16",
    subscales:[{
      label:"Yuji and Nobara! The Perfect Team!",
  ...
  },
  {
    title:"Episode 17",
    subscales:[{
      label:"Resonance! Nobara Painful Counterattack!",
  ...
  {
    title:"Arc 3 - Cursed Womb",
     episodes: [
      {
        title:"Episode 18",
        subscales:[{
          label:"Brothers! The Death Paintings Awaken",
          items:[
      ...
      },
      {
        title:"Episode 19",
        subscales:[{
          label:"A Curse With Human Emotions!",
          items:[
      ...
      },
      {
        title:"Episode 21",
        subscales:[{
          label:"October 31st! Shibuya is Sealed!",
          items:[
...

      {
        title:"Episode 22",
        subscales:[{
          label:"The Curtain Falls! Sorcerers Enter Shibuya!",
  ...
  {
   title:"Arc 4 - Shibuya Incident",
     episodes: [
      {
       title:"Episode 23",
       subscales:[{
        label:"Gojo Satoru! The Strongest Enters the Battlefield!",
      ...
      },
      {
        title:"Episode 24",
        subscales:[{
          label:"Unlimited Void! The Prison Realm Activates",
  ...
  {
   title:"Arc 5 - Culling Game",
     episodes: [
      {
        title:"Episode 26",
        subscales:[{
          label:"Sukuna Unleashed! The City Burns",
      ...
      },
      {
        title:"Episode 27",
        subscales:[{
          label:"Mahito Final Transformation!",
          items:[
      ...
      },
      {
        title:"Episode 29",
        subscales:[{
          label:"Yuji Despair! The Battle Continues!",
      ...
      },
      {
        title:"Episode 30",
        subscales:[{
          label:"The King of Curses! Sukuna True Power!",
  ...
  {
    title:"Arc 6 - Final Sorcery War",
    episodes:[
      
      {
        title:"Episode 31",
        subscales:[{
          label:"Gojo vs. Sukuna! The Strongest in History!",
          items:[
     ...
     episodes: [
      {
        title:"Episode 32",
        subscales:[{
          label:"The Final Battle! Sorcerers Against the King of Curses!",
  ...
  interface JujutsuKaisenQuizProps {
  onFinish: (sessionId:string) => void;
  onBack: () => void;
  demographics?:DemographicPayload
}
 
export default function JujutsuKaisenQuiz({ onFinish, onBack, demographics }: JujutsuKaisenQuizProps) {
