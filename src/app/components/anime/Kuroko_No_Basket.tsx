...
const ANIME_SLUG = "kurokos-basketball";
...
const THEME: ThemeTokens = {
  ...
  btnPrimary:     'bg-white text-[#1C0F0B] font-bold hover:bg-gray-200',
  btnOutline:     'border-white/30 text-white hover:bg-white/10',
  itemBg:         'bg-white/5 border-white/10',
  itemBgAnswered: 'bg-white/20 border-white/40',
  ratingSelected: 'bg-white text-[#1C0F0B] font-bold scale-105 shadow-lg shadow-black/40',
...
export const KUROKO_NO_BASKET_IMAGES: Record<number, string> = {
  0: "/images/Characters/Kuroko_Basket/alexandra-garcia.png",
  1: "/images/Characters/Kuroko_Basket/atsushi-murasakibara.png",
  2: "/images/Characters/Kuroko_Basket/chihiro-mayuzumi.png",
  3: "/images/Characters/Kuroko_Basket/daiki-aomine.png",
  4: "/images/Characters/Kuroko_Basket/eikichi-nebuya.png",
  5: "/images/Characters/Kuroko_Basket/junpei-hyuga.png",
  6: "/images/Characters/Kuroko_Basket/kazunari-takao.png",
  7: "/images/Characters/Kuroko_Basket/kazuya-hara.png",
  8: "/images/Characters/Kuroko_Basket/kenichi-okamura.png",
  9: "/images/Characters/Kuroko_Basket/koji-kobori.png",
  10: "/images/Characters/Kuroko_Basket/kotaro-hayama.png",
  11: "/images/Characters/Kuroko_Basket/makoto-hanamiya.png",
  12: "/images/Characters/Kuroko_Basket/reo-mibuchi.png",
  13: "/images/Characters/Kuroko_Basket/riko-aida.png",
  14: "/images/Characters/Kuroko_Basket/rinnosuke-mitobe.png",
  15: "/images/Characters/Kuroko_Basket/ryosuke-sakurai.png",
  16: "/images/Characters/Kuroko_Basket/ryota-kise.png",
  17: "/images/Characters/Kuroko_Basket/satsuki-momoi.png",
  18: "/images/Characters/Kuroko_Basket/seijuro-akashi.png",
  19: "/images/Characters/Kuroko_Basket/shinsuke-kimura.png",
  20: "/images/Characters/Kuroko_Basket/shintaro-midorima.png",
  21: "/images/Characters/Kuroko_Basket/shoichi-imayoshi.png",
  22: "/images/Characters/Kuroko_Basket/shun-izuki.png",
  23: "/images/Characters/Kuroko_Basket/shuzo-nijimura.png",
  24: "/images/Characters/Kuroko_Basket/taiga-kagami.png",
  25: "/images/Characters/Kuroko_Basket/taisuke-otsubo.png",
  26: "/images/Characters/Kuroko_Basket/tatsuya-himuro.png",
  27: "/images/Characters/Kuroko_Basket/teppei-kiyoshi.png",
  28: "/images/Characters/Kuroko_Basket/tetsuya-kuroko.png",
  29: "/images/Characters/Kuroko_Basket/wakamatsu-kosuke.png",
  30: "/images/Characters/Kuroko_Basket/wei-liu.png",
  31: "/images/Characters/Kuroko_Basket/yukio-kasamatsu.png",
  32: "/images/Characters/Kuroko_Basket/chihiro-mayuzumi.png",
  33: "/images/Characters/Kuroko_Basket/daiki-aomine.png",
  34: "/images/Characters/Kuroko_Basket/eikichi-nebuya.png",
  35: "/images/Characters/Kuroko_Basket/junpei-hyuga.png",
  36: "/images/Characters/Kuroko_Basket/kazunari-takao.png",
  37: "/images/Characters/Kuroko_Basket/kazuya-hara.png",
  38: "/images/Characters/Kuroko_Basket/kenichi-okamura.png",
  39: "/images/Characters/Kuroko_Basket/koji-kobori.png",
  40: "/images/Characters/Kuroko_Basket/kotaro-hayama.png",
};
...
function getEpisodeImage(title: string): string {
  ...
  return KUROKO_NO_BASKET_IMAGES[episodeNumber] ?? FALLBACK_IMAGE;
}
...
const CATALOG: Arc[] = [
    ...
    episodes: [
       {
        ...
        subscales: [
          {
            label: 'A Shadow and a Light! The New Duo Takes the Court!',
      ...
      },
      {
        ...
        subscales: [
          {
            label: 'Kuroko Appears! The Phantom Sixth Man!',
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items: [
      ...
      },
      {
        ...
        subscales: [
          {
            label: 'Kagami Challenge! A New Rival Is Born!',
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items: [
      ...
      },
      {
        ...
        subscales: [
          {
            label: 'The Vanishing Pass! Kuroko Secret Weapon!',
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items: [
      ...
      },
      {
        ...
        subscales: [
          {
            label:"The Ace Awakens! Kagami's Incredible Jump!",
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items:[
      ...
      },
      {
        ...
        subscales: [
          {
            label:"The Generation of Miracles! Five Unbelievable Players!",
      ...
      },
      {
        ...
        subscales: [
          {
            label:"Aomine Appears! The Unstoppable Ace!",
  ...
  {
    title:"Arc 2 - The Generation of Miracles Arc",
     episodes: [
      ...
      },
    {
      ...
      subscales:[
        {
          label:"Midorima's Impossible Shot!",
    ...
    },
    {
      title:"Episode 11",
      subscales:[{
        label:"Murasakibara's Absolute Defense!",
    ...
    },
    {
      title:"Episode 13",
      subscales:[{
        label:"Kuroko vs. the Generation of Miracles!",
        items:[
    ...
    },
    {
      title:"Episode 14",
      subscales:[{
        label:"he Winter Cup Begins! Seirin Takes the Stage!",
        items:[
  ...
  },
  {
    title: "Episode 16",
    subscales:[{
      label:"The Phantom Shot! Kuroko's New Technique!",
  ...
  },
  {
    title:"Episode 17",
    subscales:[{
      label:"Kagami's Zone! The Door to Another Level!",
  ...
  {
    title:"Arc 3 - Winter Cup ",
     episodes: [
      {
        title:"Episode 18",
        subscales:[{
          label:"Seirin's Ultimate Combination!",
          items:[
      ...
      },
      {
        title:"Episode 19",
        subscales:[{
          label:"The Final Quarter! Everything Is on the Line!",
          items:[
      ...
      },
      {
        title:"Episode 20",
        subscales:[{
          label:"The Miracle That No One Expected!",
      ...
      },
      {
        title:"Episode 21",
        subscales:[{
          label:"The Uncrowned Kings Return!",
          items:[
  ...
  {
   title:"Arc 4 - Uncrowned Kings",
     episodes: [
      {
       title:"Episode 23",
       subscales:[{
        label:"he Iron Heart! A Battle of Willpower!",
      ...
      },
      {
        title:"Episode 25",
        subscales:[{
          label:"The Emperor vs. the Phantom!",
  ...
  {
   title:"Arc 5 -The Jabberwock ",
     episodes: [
      {
        title:"Episode 26",
        subscales:[{
          label:"The Zone Within the Zone!",
      ...
      },
      {
        title:"Episode 28",
        subscales:[{
          label:"A Foreign Challenge! Jabberwock Arrives!",
      ...
      },
      {
        title:"Episode 29",
        subscales:[{
          label:"Streetball vs. High School Basketball!",
      ...
      },
      {
        title:"Episode 30",
        subscales:[{
          label:"The Strongest Five! A New Generation Begins!",
  ...
  {
    title:"Arc 6 - Ultimate Rivalry",
    episodes:[
      
      {
        title:"Episode 31",
        subscales:[{
          label:"Kuroko's Ultimate Misdirection!",
          items:[
    ...
    title:"Epilogue 32-33",
     episodes: [
      ...
      },
      {
        title:"Episode",
        subscales:[{
          label:"The Last Buzzer! The Game Never Truly Ends!",
  ...
  interface KurokoNoBasketQuizProps {
  onFinish: (sessionId:string) => void;
  onBack: () => void;
  demographics?:DemographicPayload
}
 
export default function KurokoNoBasketQuiz({ onFinish, onBack, demographics }: KurokoNoBasketQuizProps) {
