...
const ANIME_SLUG = "mob-psycho-100";
...
const THEME: ThemeTokens = {
  ...
  text:           'text-[#EC4899]',
  subText:        'text-[#4ADE80]',
  btnPrimary:     'bg-[#EC4899] text-white font-bold hover:bg-[#db2777]',
  btnOutline:     'border-[#EC4899]/30 text-[#EC4899] hover:bg-[#EC4899]/10',
  itemBg:         'bg-[#EC4899]/5 border-[#EC4899]/10',
  itemBgAnswered: 'bg-[#4ADE80]/20 border-[#4ADE80]/40',
  ratingSelected: 'bg-[#EC4899] text-white font-bold scale-105 shadow-lg shadow-pink-900/40',
  ratingDefault:  'bg-[#EC4899]/10 text-[#EC4899] hover:bg-[#EC4899]/20',
  headerBorder:   'border-[#EC4899]/10',
  footerBorder:   'border-[#EC4899]/10',
...
export const MOB_PSYCHO_IMAGES: Record<number,string> = {
0:"/images/Mob_Psycho_100/Arataka_Reigen_2.png",
1:"/images/Mob_Psycho_100/Arataka_Reigen.png",
2:"/images/Mob_Psycho_100/Body_Improvement_Club.png",
3:"/images/Mob_Psycho_100/Dimple.png",
4:"/images/Mob_Psycho_100/Hideki_Yamamura.png",
5:"/images/Mob_Psycho_100/Katsuya_Serizawa.png",
6:"/images/Mob_Psycho_100/Keiji_Mogami.png",
7:"/images/Mob_Psycho_100/Kirin_Jyodo.png",
8:"/images/Mob_Psycho_100/Mob_Psycho_Poster.png",
9:"/images/Mob_Psycho_100/Mob_Rage.png",
10:"/images/Mob_Psycho_100/Musashi_Goda.png",
11:"/images/Mob_Psycho_100/Ritsu_Kageyama.png",
12:"/images/Mob_Psycho_100/Shigeo_Kageyama.png",
13:"/images/Mob_Psycho_100/Sho_Suzuki.png",
14:"/images/Mob_Psycho_100/Teruki_Hanazawa.png",
15:"/images/Mob_Psycho_100/Toichiro_Suzuki.png",
16:"/images/Mob_Psycho_100/Tome_Kurata.png",
17:"/images/Mob_Psycho_100/Tsuboni_Takane.png",
18:"/images/Mob_Psycho_100/Tsuchiya.png",
19:"/images/Mob_Psycho_100/Arataka_Reigen_2.png",
20:"/images/Mob_Psycho_100/Arataka_Reigen.png",
21:"/images/Mob_Psycho_100/Body_Improvement_Club.png",
22:"/images/Mob_Psycho_100/Dimple.png",
23:"/images/Mob_Psycho_100/Hideki_Yamamura.png",
24:"/images/Mob_Psycho_100/Katsuya_Serizawa.png",
25:"/images/Mob_Psycho_100/Keiji_Mogami.png",
26:"/images/Mob_Psycho_100/Kirin_Jyodo.png",
27:"/images/Mob_Psycho_100/Mob_Psycho_Poster.png",
28:"/images/Mob_Psycho_100/Mob_Rage.png",
29:"/images/Mob_Psycho_100/Musashi_Goda.png",
30:"/images/Mob_Psycho_100/Ritsu_Kageyama.png",
31:"/images/Mob_Psycho_100/Shigeo_Kageyama.png",
32:"/images/Mob_Psycho_100/Sho_Suzuki.png",
33:"/images/Mob_Psycho_100/Teruki_Hanazawa.png",
34:"/images/Mob_Psycho_100/Toichiro_Suzuki.png",
35:"/images/Mob_Psycho_100/Tome_Kurata.png",
36:"/images/Mob_Psycho_100/Tsuboni_Takane.png",
37:"/images/Mob_Psycho_100/Tsuchiya.png",
...
function getEpisodeImage(title: string): string {
  ...
  return MOB_PSYCHO_IMAGES[episodeNumber] ?? FALLBACK_IMAGE;
}
...
const CATALOG: Arc[] = [
    ...
    episodes: [
       {
        ...
        subscales: [
          {
            label: 'A Psychic Boy Appears! Shigeo Kageyama!',
      ...
      },
      {
        ...
        subscales: [
          {
            label: 'Reigen Arataka! The Greatest Psychic in the World?!',
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items: [
      ...
      },
      {
        ...
        subscales: [
          {
            label: 'Mob 10%! His Emotions Begin to Rise!',
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items: [
      ...
      },
      {
        ...
        subscales: [
          {
            label: 'The Telepathy Club! A Strange New Friendship!',
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items: [
      ...
      },
      {
        ...
        subscales: [
          {
            label: 'Ritsu Secret! The Brothers Psychic Power!',
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items: [
      ...
      },
      {
        ...
        subscales: [
          {
            label:"Mob vs. the Evil Spirit! A Battle of Exorcists!",
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items:[
      ...
      },
      {
        ...
        subscales: [
          {
            label:"Claw Appears! The World's Most Dangerous Espers!",
      ...
      },
      {
        ...
        subscales: [
          {
            label:"A Hundred Psychics! Mob Enters Enemy Territory!",
  ...
  },
  {
    title:"Arc 2 - Claw Rising",
     episodes: [
  
      {
        ...
        subscales: [
          {
            label:"Teruki Hanazawa! The Rival Returns!",
      ...
      },
    {
      ...
      subscales:[
        {
          label:"The Ultimate Esper! Mob's Power Explodes!",
    ...
    },
    {
      title:"Episode 12",
      subscales:[{
        label:"The Seventh Division! The Final Assault!",
    ...
    },
    {
      title:"Episode 13",
      subscales:[{
        label:"Mob's 100%! The Power He Fears!",
        items:[
    ...
    },
    {
      title:"Episode 14",
      subscales:[{
        label:"A Strange Presence! Something Is Wrong With Mob!",
        items:[
  ...
  },
  {
    title:"Episode 16",
    subscales:[{
      label:"Mob's Rage! The Barrier Breaks!",
     ...
     episodes: [
      {
        title:"Episode 18",
        subscales:[{
          label:"Everyone's Enemy! Mob Loses Control!",
          items:[
      ...
      },
      {
        title:"Episode 19",
        subscales:[{
          label:"Ritsu's Choice! A Brother's Promise!",
          items:[
      ...
      },
      {
        title:"Episode 21",
        subscales:[{
          label:"The Giant Tree! A New Psychic Phenomenon!",
          items:[
  ...
  {
   title:"Arc 4 - Divine Tree",
     episodes: [
      {
       title:"Episode 23",
       subscales:[{
        label:"Mob vs. the Psycho Helmet!",
      ...
      },
      {
        title:"Episode 24",
        subscales:[{
          label:"Dimple's Greatest Ambition!",
      ...
      },
      {
        title:"Episode 25",
        subscales:[{
          label:"God Dimple! The Ultimate Spiritual Power!",
  ...
  {
   title:"Arc 5 - Psychic World",
     episodes: [
      {
        title:"Episode 26",
        subscales:[{
          label:"A Friend or an Enemy?",
      ...
      },
      {
        title:"Episode 27",
        subscales:[{
          label:"The Tree Falls! The Truth Revealed!",
          items:[
      ...
      },
      {
        title:"Episode 28",
        subscales:[{
          label:"The World's Strongest Espers Gather!",
      ...
      },
      {
        title:"Episode 30",
        subscales:[{
          label:"Mob's Heart! The Final Conflict Begins!",
  ...
  {
    title:"Arc 6 - Hundred Percent",
    episodes:[
      
      {
        title:"Episode 31",
        subscales:[{
          label:"100%! Every Emotion Explodes!",
          items:[
    ...
    title:"Epilogue 32-33",
     episodes: [
      ...
      },
      {
        title:"Episode 33",
        subscales:[{
          label:"Shigeo Kageyama! A Normal Life Begins!",
  ...
  interface MobPsychoQuizProps {
  onFinish: (sessionId:string) => void;
  onBack: () => void;
  demographics?:DemographicPayload
}
 
export default function MobPsychoQuiz({ onFinish, onBack, demographics }: MobPsychoQuizProps) {
