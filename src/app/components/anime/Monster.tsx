...
const THEME: ThemeTokens = {
  ...
  text:           'text-[#E2E8F0]',
  subText:        'text-[#94A3B8]',
  btnPrimary:     'bg-[#475569] text-white hover:bg-[#334155]',
  btnOutline:     'border-[#E2E8F0]/20 text-[#E2E8F0] hover:bg-[#E2E8F0]/10',
  itemBg:         'bg-[#E2E8F0]/5 border-[#E2E8F0]/10',
  itemBgAnswered: 'bg-[#475569]/20 border-[#475569]/40',
  ratingSelected: 'bg-[#475569] text-white scale-105 shadow-lg shadow-slate-900/50',
...
0:"/images/Characters/Monster/baby.png",
1:"/images/Characters/Monster/christof-sievernich.png",
2:"/images/Characters/Monster/dieter.png",
3:"/images/Characters/Monster/dr-schumann.png",
4:"/images/Characters/Monster/egon-weissbach.png",
5:"/images/Characters/Monster/eva-heinemann.png",
6:"/images/Characters/Monster/franz-bonaparta.png",
7:"/images/Characters/Monster/fritz-vardemann.png",
8:"/images/Characters/Monster/hans-georg-schuwald.png",
9:"/images/Characters/Monster/hartmann.png",
10:"/images/Characters/Monster/heinrich-lunge.png",
11:"/images/Characters/Monster/hugo-bernhardt.png",
12:"/images/Characters/Monster/jacob-maurer.png",
13:"/images/Characters/Monster/jan-suk.png",
14:"/images/Characters/Monster/jaromir-lipsky.png",
15:"/images/Characters/Monster/johan-liebert.png",
16:"/images/Characters/Monster/julius-reichwein.png",
17:"/images/Characters/Monster/karl-neumann.png",
18:"/images/Characters/Monster/kenzo-tenma.png",
19:"/images/Characters/Monster/lotte-frank.png",
20:"/images/Characters/Monster/martin-reest.png",
21:"/images/Characters/Monster/michael-muller.png",
22:"/images/Characters/Monster/mikhail-petrov.png",
23:"/images/Characters/Monster/nina-fortner.png",
24:"/images/Characters/Monster/otto-heckler.png",
25:"/images/Characters/Monster/petr-capek.png",
26:"/images/Characters/Monster/richard-braun.png",
27:"/images/Characters/Monster/roberto.png",
28:"/images/Characters/Monster/rosso.png",
29:"/images/Characters/Monster/rudy-gillen.png",
30:"/images/Characters/Monster/rung.png",
31:"/images/Characters/Monster/udo-heinemann.png",
32:"/images/Characters/Monster/vera-cerna.png",
33:"/images/Characters/Monster/wolfgang-grimmer.png",
34:"/images/Characters/Monster/heinrich-lunge.png",
35:"/images/Characters/Monster/hugo-bernhardt.png",
36:"/images/Characters/Monster/jacob-maurer.png",
37:"/images/Characters/Monster/jan-suk.png",
38:"/images/Characters/Monster/jaromir-lipsky.png",
39:"/images/Characters/Monster/johan-liebert.png",
40:"/images/Characters/Monster/julius-reichwein.png",
}
...
function getEpisodeImage(title: string): string {
  ...
  return Monster_IMAGES[episodeNumber] ?? FALLBACK_IMAGE;
}
...
const CATALOG: Arc[] = [
    ...
    episodes: [
       {
        ...
        subscales: [
          {
            label: 'A Doctor Choice! The Boy on the Operating Table',
      ...
      },
      {
        ...
        subscales: [
          {
            label:"A Doctor Begins His Search",
      ...
      },
      {
        ...
        subscales: [
          {
            label:"The Man Who Follows the Dead",
  ...
  },
  {
      ...
      },
    {
      ...
      subscales:[
        {
          label:"The Witness Who Saw Too Much",
  ...
  },
  {
    title: "Episode 16",
    subscales:[{
      label:"A Childhood Without Love",
  ...
  {
    title:"Arc 3 - Red Rose Mansion",
     episodes: [
      {
        title:"Episode 18",
        subscales:[{
          label:"A Story Written in Blood",
          items:[
      ...
      },
      {
        title:"Episode 20",
        subscales:[{
          label:"The Girl Who Remembered Everything",
...

      {
        title:"Episode 22",
        subscales:[{
          label:"511 Kinderheim! The House of Monsters",
  ...
  {
   title:"Arc 4 - 511 Kinderheim",
     episodes: [
      {
       title:"Episode 23",
       subscales:[{
        label:"Children Without Names",
      ...
      },
      {
        title:"Episode 24",
        subscales:[{
          label:"The Boy Who Controlled Everyone",
  ...
  {
   title:"Arc 5 - Ruhenheim",
     episodes: [
      {
        title:"Episode 26",
        subscales:[{
          label:"The Last Survivor",
      ...
      },
      {
        title:"Episode 28",
        subscales:[{
          label:"The Truth About the Monster",
      ...
      },
      {
        title:"Episode 29",
        subscales:[{
          label:"Ruhenheim! A Quiet Town at the End of the World",
      ...
      },
      {
        title:"Episode 30",
        subscales:[{
          label:"The Stranger in the Forest",
     ...
     episodes: [
      {
        title:"Episode 32",
        subscales:[{
          label:"The Nameless Monster's Story",
      ...
      },
      {
        title:"Episode 33",
        subscales:[{
          label:"The Monster Without a Name",
  ...
  interface MonsterQuizProps {
  onFinish: (sessionId:string) => void;
  onBack: () => void;
  demographics?:DemographicPayload
}
 
export default function MonsterQuiz({ onFinish, onBack, demographics }: MonsterQuizProps) {
