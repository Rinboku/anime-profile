...
const ANIME_SLUG = "mushoku-tensei";
...
const THEME: ThemeTokens = {
  ...
  text:           'text-[#F59E0B]',
  subText:        'text-[#38BDF8]',
  btnPrimary:     'bg-[#F59E0B] text-[#151118] font-bold hover:bg-[#d97706]',
  btnOutline:     'border-[#F59E0B]/30 text-[#F59E0B] hover:bg-[#F59E0B]/10',
  itemBg:         'bg-[#F59E0B]/5 border-[#F59E0B]/10',
  itemBgAnswered: 'bg-[#38BDF8]/20 border-[#38BDF8]/40',
  ratingSelected: 'bg-[#F59E0B] text-[#151118] font-bold scale-105 shadow-lg shadow-amber-900/40',
  ratingDefault:  'bg-[#F59E0B]/10 text-[#F59E0B] hover:bg-[#F59E0B]/20',
  headerBorder:   'border-[#F59E0B]/10',
  footerBorder:   'border-[#F59E0B]/10',
...
export const Mushoku_Tensei_IMAGES:Record<number,string> = {
0:"/images/Mushoku_Tensei/Aisha_Greyrat.png",
1:"/images/Mushoku_Tensei/Ariel_Anemoi_Asura.png",
2:"/images/Mushoku_Tensei/Badigagi.png",
3:"/images/Mushoku_Tensei/Cliff_Grimoire.png",
4:"/images/Mushoku_Tensei/Eris_1.png",
5:"/images/Mushoku_Tensei/Eris_2.png",
6:"/images/Mushoku_Tensei/Gal.png",
7:"/images/Mushoku_Tensei/Isolde_Cluel.png",
8:"/images/Mushoku_Tensei/Lilia_Greyrat.png",
9:"/images/Mushoku_Tensei/Luke_Notos_Greyrat.png",
10:"/images/Mushoku_Tensei/Nanahoshi_Shizuka.png",
11:"/images/Mushoku_Tensei/Nina_Briths.png",
12:"/images/Mushoku_Tensei/Norn_Greyrat.png",
13:"/images/Mushoku_Tensei/Paul_Greyrat.png",
14:"/images/Mushoku_Tensei/Pursenia_Adorudia.png",
15:"/images/Mushoku_Tensei/Reida_Lia.png",
16:"/images/Mushoku_Tensei/Roxy_mIGURDIA.png",
17:"/images/Mushoku_Tensei/Rudeus.png",
18:"/images/Mushoku_Tensei/Sylphiette.png",
19:"/images/Mushoku_Tensei/Zanoba.png",
20:"/images/Mushoku_Tensei/Zenith_Greyrat.png",
21:"/images/Mushoku_Tensei/Ariel_Anemoi_Asura.png",
22:"/images/Mushoku_Tensei/Badigagi.png",
23:"/images/Mushoku_Tensei/Cliff_Grimoire.png",
24:"/images/Mushoku_Tensei/Eris_1.png",
25:"/images/Mushoku_Tensei/Eris_2.png",
26:"/images/Mushoku_Tensei/Gal.png",
27:"/images/Mushoku_Tensei/Isolde_Cluel.png",
28:"/images/Mushoku_Tensei/Lilia_Greyrat.png",
29:"/images/Mushoku_Tensei/Luke_Notos_Greyrat.png",
30:"/images/Mushoku_Tensei/Nanahoshi_Shizuka.png",
31:"/images/Mushoku_Tensei/Nina_Briths.png",
32:"/images/Mushoku_Tensei/Norn_Greyrat.png",
33:"/images/Mushoku_Tensei/Paul_Greyrat.png",
34:"/images/Mushoku_Tensei/Pursenia_Adorudia.png",
35:"/images/Mushoku_Tensei/Reida_Lia.png",
36:"/images/Mushoku_Tensei/Roxy_mIGURDIA.png",
37:"/images/Mushoku_Tensei/Rudeus.png",
38:"/images/Mushoku_Tensei/Sylphiette.png",
39:"/images/Mushoku_Tensei/Zanoba.png",
40:"/images/Mushoku_Tensei/Zenith_Greyrat.png",
}
...
function getEpisodeImage(title: string): string {
  ...
  return Mushoku_Tensei_IMAGES[episodeNumber] ?? FALLBACK_IMAGE;
}
...
const CATALOG: Arc[] = [
    ...
    episodes: [
       {
        ...
        subscales: [
          {
            label: 'A Life Given Another Chance',
      ...
      },
      {
        ...
        subscales: [
          {
            label: 'Lessons Beneath the Blue Sky',
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items: [
      ...
      },
      {
        ...
        subscales: [
          {
            label:"The First Step Into the World",
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items:[
      ...
      },
      {
        ...
        subscales: [
          {
            label:"Strangers in a Distant Land",
  ...
  {
    title:"Arc 2 - Great Teleportation",
     episodes: [
    ...
    },
    {
      title:"Episode 13",
      subscales:[{
        label:"A Sword Beneath the Setting Sun",
        items:[
  ...
  },
  {
    title: "Episode 16",
    subscales:[{
      label:"The City of Wandering Souls",
  ...
  {
    title:"Arc 3 - Long Road Home",
     episodes: [
      {
        title:"Episode 18",
        subscales:[{
          label:"The Road Toward Home",
          items:[
...

      {
        title:"Episode 22",
        subscales:[{
          label:"Memories That Refuse to Fade",
  ...
  {
   title:"Arc 4 - Magic Academy",
     episodes: [
      {
       title:"Episode 23",
       subscales:[{
        label:"The Youngest Great Mage",
      ...
      },
      {
        title:"Episode 24",
        subscales:[{
          label:"When the Past Comes Knocking",
  ...
  {
   title:"Arc 5 - Labyrinth of Destiny",
     episodes: [
      {
        title:"Episode 26",
        subscales:[{
          label:"The Labyrinth’s Secret",
      ...
      },
      {
        title:"Episode 30",
        subscales:[{
          label:"A Future Written in Blood",
  ...
  {
    title:"Arc 6 - Dragon God’s Shadow",
    episodes:[
      
      {
        title:"Episode 31",
        subscales:[{
          label:"The World on the Edge",
          items:[
     ...
     episodes: [
      {
        title:"Episode 32",
        subscales:[{
          label:"The Choice That Changes Everything",
  ...
  interface MushokuTenseiQuizProps {
  onFinish: (sessionId:string) => void;
  onBack: () => void;
  demographics?:DemographicPayload
}
 
export default function MushokuTenseiQuiz({ onFinish, onBack, demographics }: MushokuTenseiQuizProps) {
