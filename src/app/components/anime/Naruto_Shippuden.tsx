...
// ─────────────────────────────────────────────────────────────────────────
const ANIME_SLUG = "naruto_shippuden";
...
const THEME: ThemeTokens = {
  ...
  btnPrimary:     'bg-[#FF6B00] text-white hover:bg-[#e05e00]',
  btnOutline:     'border-white/20 text-white hover:bg-white/5',
  itemBg:         'bg-white/5 border-white/10',
  itemBgAnswered: 'bg-[#FF6B00]/10 border-[#FF6B00]/30',
  ratingSelected: 'bg-[#FF6B00] text-white scale-105 shadow-lg shadow-orange-500/20',
...
const NARUTO_IMAGES: Record<string, string> = {
  'Introduction':                                         '/images/Naruto_Folder/NARUTO_KONOHAKAGURE.png',
  'Machiavellianism':                                     '/images/Naruto_Folder/Naruto_Deidara.png',
  'Narcissism':                                           '/images/Naruto_Folder/Hidan_Sadism.jpg',
  'Psychopathy':                                          '/images/Naruto_Folder/Kakuzu_Psihopatie.jpg',
  'Sadism':                                               '/images/Naruto_Folder/Naruto_Six_Paths_of_Pain.png',
  'BFI-2-XS: Extraversion & Agreeableness':              '/images/Naruto_Folder/Naruto_Asuma_Sarutobi.png',
  'Conscientiousness, Neuroticism & Openness':            '/images/Naruto_Folder/Naruto_Hiruzen_Sarutobi.png',
  'UPPS-P Impulsivity':                                   '/images/Naruto_Folder/Naruto_Ino_Yamanka.png',
  'Need for Cognition (NFC-18)':                          '/images/Naruto_Folder/Naruto_Kakashi_Hatake.png',
  'Maladaptive Daydreaming (MDS-16)':                     '/images/Naruto_Folder/Naruto_Hinata_Hyuga.png',
  'Cognitive Emotion Regulation (CERQ)':                  '/images/Naruto_Folder/Naruto_Jiraya_and_Gamabunda.png',
  'Psychological Pain Scale (PPS-13)':                    '/images/Naruto_Folder/Naruto_Kakshi_Hatake_Suiton.png',
  'Depression & Stress (DASS-21)':                        '/images/Naruto_Folder/Naruto_Kiba_Kuramaru.png',
  'Anxiety & Insomnia (DASS-21 + ISI)':                   '/images/Naruto_Folder/Naruto_Killer_Bee.png',
  'Self-Esteem & Life Satisfaction (RSES + SWLS)':        '/images/Naruto_Folder/Naruto_Kisame_Hoshigaki.png',
  'Anhedonia (SHAPS-14)':                                 '/images/Naruto_Folder/Naruto_Kurenai_Yuhi.png',
  'Multidimensional State Boredom (MSBM)':                '/images/Naruto_Folder/Naruto_Shikamaru_Nara.png',
  'Basic Psychological Needs (BPNS)':                     '/images/Naruto_Folder/Naruto_Minato_Namikaze.png',
  'Social Media & Smartphone Addiction (BSMAS + SAS-SV)': '/images/Naruto_Folder/Naruto_Tobirama_Senju.png',
  'Gaming Addiction & Emotion Regulation (GAS-7 + ERQ)':  '/images/Naruto_Folder/Naruto_Zabuza_Momochi.png',
  'Anime Addiction Scale (CLC)':                          '/images/Naruto_Folder/Naruto_Shino_Aburame.png',
  'Heartland Forgiveness Scale (HFS)':                    '/images/Naruto_Folder/Naruto_Rock_Lee.png',
  'Self-Compassion Scale (SCS-SF)':                       '/images/Naruto_Folder/Naruto_Konan.png',
  'Compassion for Others (CS)':                           '/images/Naruto_Folder/Naruto_Sakura_Haruno.png',
  'Brief COPE (28 items)':                                '/images/Naruto_Folder/Naruto_Yugito_Nii.png',
  'Self-Expansion, Self-Suppression & Financial Stress':  '/images/Naruto_Folder/Naruto_Tsunade_Senju.png',
  'Benevolent Childhood Experiences (BCE)':               '/images/Naruto_Folder/Naruto_Haku.png',
  'Hikikomori & Social Avoidance Scale':                  '/images/Naruto_Folder/Naruto_Choji_Akimichi.png',
  'Need to Belong (NTB)':                                 '/images/Naruto_Folder/Naruto_Mei_Terumi.png',
  'Anime Story World Engagement (ASWE)':                  '/images/Naruto_Folder/Naruto_Mighty_Guy.png',
  'Narrative Identity in Anime (NISE-20)':                '/images/Naruto_Folder/Naruto_Itachi.png',
};


export const Naruto_Shippuden_IMAGES: Record<number, string> = {
  2: "/images/Characters/Naruto_Shippuden/anko_mitarashi.png",
  3: '/images/Characters/Naruto_Shippuden/ao.png',
  4: '/images/Characters/Naruto_Shippuden/asuma_sarutobi.png',
  5: '/images/Characters/Naruto_Shippuden/baki.png',
  6: "/images/Characters/Naruto_Shippuden/cee.png",
  7: "/images/Characters/Naruto_Shippuden/chiyo.png",
  8: "/images/Characters/Naruto_Shippuden/choji_akimichi.png",
  9: "/images/Characters/Naruto_Shippuden/danzo_shimura.png",
  10: "/images/Characters/Naruto_Shippuden/darui.png",
  11: "/images/Characters/Naruto_Shippuden/deidara.png",
  12: "/images/Characters/Naruto_Shippuden/ebisu.png",
  13: "/images/Characters/Naruto_Shippuden/fourth_raikage.png",
  14: "/images/Characters/Naruto_Shippuden/fu-yamanaka.png",
  15: "/images/Characters/Naruto_Shippuden/fuu_takigakure.png",
  16: "/images/Characters/Naruto_Shippuden/gaara.png",
  17: "/images/Characters/Naruto_Shippuden/gengetsu_hozuki.png",
  18: "/images/Characters/Naruto_Shippuden/genma_shiranui.png",
  19: "/images/Characters/Naruto_Shippuden/ginkaku.png",
  20: "/images/Characters/Naruto_Shippuden/hagoromo_otsutsuki.png",
  21: "/images/Characters/Naruto_Shippuden/haku.png",
  22: "/images/Characters/Naruto_Shippuden/han.png",
  23: "/images/Characters/Naruto_Shippuden/hanzo_the_salamander.png",
  24: "/images/Characters/Naruto_Shippuden/hashirama_senju.png",
  25: "/images/Characters/Naruto_Shippuden/hidan.png",
  26: "/images/Characters/Naruto_Shippuden/hiruzen_sarutobi.png",
  27: "/images/Characters/Naruto_Shippuden/ibiki_morino.png",
  28: "/images/Characters/Naruto_Shippuden/inoichi-yamanaka.png",
  29: "/images/Characters/Naruto_Shippuden/iruka.png",
  30: "/images/Characters/Naruto_Shippuden/itachi_uchiha.png",
  31: "/images/Characters/Naruto_Shippuden/izumo_kamizuki.png",
  32: "/images/Characters/Naruto_Shippuden/jiraya.png",
  33: "/images/Characters/Naruto_Shippuden/jirobo.png",
  34: "/images/Characters/Naruto_Shippuden/kabuto_yakushi.png"
};

const FALLBACK_IMAGE = '/images/Naruto_Folder/Naruto_Rasengan.png';

function getEpisodeImage(title: string): string {
  const match = title.match(/\d+/);
  if (!match) return FALLBACK_IMAGE;
  const episodeNumber = Number(match[0]);
  return Naruto_Shippuden_IMAGES[episodeNumber] ?? FALLBACK_IMAGE;
}
...
const CATALOG: Arc[] = [
  {
    ...
    episodes: [
      ...
      },
      {
        ...
        subscales: [
          {
            label: 'The Sand Fallen Kazekage',
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items: [
  ...
  },
  {
    ...
    },
    {
      title:"Episode 11",
      subscales:[{
        label:"The Battle in the Hideout",
    ...
    },
    {
      title:"Episode 12",
      subscales:[{
        label:"Brothers Beneath the Moon",
    ...
    },
    {
      title:"Episode 13",
      subscales:[{
        label:"The Truth Behind the Mangekyō",
        items:[
    ...
    },
    {
      title:"Episode 14",
      subscales:[{
        label:"A Revenge Born From Pain",
        items:[
  ...
  },
  {
    title: "Episode 16",
    subscales:[{
      label:"The Destruction of Konoha",
  ...
  {
    title:"Arc 3 - Pain of the Shinobi",
     episodes: [
      {
        title:"Episode 18",
        subscales:[{
          label:"Naruto's Final Lesson",
          items:[
      ...
      },
      {
        title:"Episode 19",
        subscales:[{
          label:"The Battle of the Nine-Tails",
          items:[
...

      {
        title:"Episode 22",
        subscales:[{
          label:"The Allied Shinobi Forces",
  ...
  {
   title:"Arc 4 - Fourth Great Ninja War",
     episodes: [
      {
       title:"Episode 23",
       subscales:[{
        label:"The Army of the Dead",
  ...
  {
   title:"Arc 5 - Sage of Six Paths",
     episodes: [
      {
        title:"Episode 26",
        subscales:[{
          label:"The Brothers of the Battlefield",
      ...
      },
      {
        title:"Episode 27",
        subscales:[{
          label:"The Fourth Hokage Returns",
          items:[
  ...
  {
    title:"Arc 6 -Final Valley",
    episodes:[
      
      {
        title:"Episode 31",
        subscales:[{
          label:"The Final Team Seven",
          items:[
    ...
    title:"Epilogue 32-33",
     episodes: [
      ...
      },
      {
        title:"Episode 33",
        subscales:[{
          label:"The Shinobi Who Changed the World",
