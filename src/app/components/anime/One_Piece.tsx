...
const THEME: ThemeTokens = {
  ...
  btnPrimary:     'bg-[#D42D2D] text-white hover:bg-[#b02525]',
  btnOutline:     'border-white/20 text-white hover:bg-white/5',
  itemBg:         'bg-white/5 border-white/10',
  itemBgAnswered: 'bg-[#D42D2D]/10 border-[#D42D2D]/30',
  ratingSelected: 'bg-[#D42D2D] text-white scale-105 shadow-lg shadow-red-900/50',
...
export const ONE_PIECE_IMAGES: Record<number, string> = {
  0: "/images/Characters/One_Piece/caesar-clown.png",
  1: "/images/Characters/One_Piece/cavendish.png",
  2: "/images/Characters/One_Piece/eustass-kid.png",
  3: "/images/Characters/One_Piece/enel.png",
  4: "/images/Characters/One_Piece/donquixote-doflamingo.png",
  5: "/images/Characters/One_Piece/dracule-mihawk.png",
  6: "/images/Characters/One_Piece/edward-newgate.png",
  7: "/images/Characters/One_Piece/franky.png",
  8: "/images/Characters/One_Piece/gecko-moria.png",
  9: "/images/Characters/One_Piece/buggy.png",
  10: "/images/Characters/One_Piece/brook.png",
  11: "/images/Characters/One_Piece/borsalino.png",
  12: "/images/Characters/One_Piece/boa-hancock.png",
  13: "/images/Characters/One_Piece/black-maria.png",
  14: "/images/Characters/One_Piece/ben-beckman.png",
  15: "/images/Characters/One_Piece/basil-hawkins.png",
  16: "/images/Characters/One_Piece/aramaki.png",
  17: "/images/Characters/One_Piece/karasu.png",
  18: "/images/Characters/One_Piece/jewelry-bonney.png",
  19: "/images/Characters/One_Piece/izo.png",
  20: "/images/Characters/One_Piece/helmeppo.png",
  21: "/images/Characters/One_Piece/killer.png",
  22: "/images/Characters/One_Piece/kikunojo.png",
  23: "/images/Characters/One_Piece/koby.png",
  24: "/images/Characters/One_Piece/kuzan.png",
  25: "/images/Characters/One_Piece/marshall-d-teach.png",
  26: "/images/Characters/One_Piece/marco.png",
  27: "/images/Characters/One_Piece/magellan.png",
  28: "/images/Characters/One_Piece/monkey-d-garp.png",
  29: "/images/Characters/One_Piece/monkey-d-luffy.png",
  30: "/images/Characters/One_Piece/nami.png",
  31: "/images/Characters/One_Piece/pedro.png",
  32: "/images/Characters/One_Piece/portgas-d-ace.png",
  33: "/images/Characters/One_Piece/rob-lucci.png",
  34: "/images/Characters/One_Piece/roronoa-zoro.png",
};
...
function getEpisodeImage(title: string): string {
  ...
  return ONE_PIECE_IMAGES[episodeNumber] ?? FALLBACK_IMAGE;
}
...
const CATALOG: Arc[] = [
    ...
    episodes: [
       {
        ...
        subscales: [
          {
            label: 'The Boy Who Would Become Pirate King',
      ...
      },
      {
        ...
        subscales: [
          {
            label: 'A Swordsman With Three Swords',
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items: [
      ...
      },
      {
        ...
        subscales: [
          {
            label: 'The Navigator of the Sea',
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items: [
      ...
      },
      {
        ...
        subscales: [
          {
            label: 'The Liar Who Dreamed of Giants',
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items: [
      ...
      },
      {
        ...
        subscales: [
          {
            label: 'The Cook of the Floating Restaurant',
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items: [
      ...
      },
      {
        ...
        subscales: [
          {
            label:"The Straw Hat Crew Sets Sail",
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items:[
      ...
      },
      {
        ...
        subscales: [
          {
            label:"Welcome to the Grand Line",
      ...
      },
      {
        ...
        subscales: [
          {
            label:"The Kingdom of a Thousand Sands",
  ...
  },
  {
    title:"Arc 2 - Grand Line",
     episodes: [
  
      {
        ...
        subscales: [
          {
            label:"The Princess Who Carried a Secret",
      ...
      },
    {
      ...
      subscales:[
        {
          label:"The Shadow of the Warlords",
    ...
    },
    {
      title:"Episode 11",
      subscales:[{
        label:"A Storm Over the Grand Line",
    ...
    },
    {
      title:"Episode 14",
      subscales:[{
        label:"The Man Who Builds Dreams",
        items:[
  ...
  },
  {
    title: "Episode 16",
    subscales:[{
      label:"The Betrayal of the Going Merry",
  ...
  },
  {
    title:"Episode 17",
    subscales:[{
      label:"The Cipher Pol Assassins",
  ...
  {
    title:"Arc 3 -Water Seven",
     episodes: [
      {
        title:"Episode 18",
        subscales:[{
          label:"I Will Become Stronger",
          items:[
      ...
      },
      {
        title:"Episode 20",
        subscales:[{
          label:"The Great Prison Impel Down",
...

      {
        title:"Episode 22",
        subscales:[{
          label:"The Man Who Stood Against the Navy",
  ...
  {
   title:"Arc 4 - Paramount War",
     episodes: [
      {
       title:"Episode 23",
       subscales:[{
        label:"The War of the Greatest",
  ...
  {
   title:"Arc 5 - New World",
     episodes: [
      {
        title:"Episode 26",
        subscales:[{
          label:"The Age of the New Pirates",
  ...
  {
    title:"Arc 6 - Final Voyage",
    episodes:[
      
      {
        title:"Episode 31",
        subscales:[{
          label:"The Voice of the Void Century",
          items:[
  ...
  interface OnePieceQuizProps {
  onFinish: (sessionId:string) => void;
  onBack: () => void;
  demographics?:DemographicPayload
}
 
export default function OnePiezeQuiz({ onFinish, onBack, demographics }: OnePieceQuizProps) {
