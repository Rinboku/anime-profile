...
const ANIME_SLUG = "parasyte-the-maxim";
...
const THEME: ThemeTokens = {
  ...
  text:           'text-[#EF4444]',
  subText:        'text-[#93C5FD]',
  btnPrimary:     'bg-[#EF4444] text-white font-bold hover:bg-[#dc2626]',
  btnOutline:     'border-[#EF4444]/30 text-[#EF4444] hover:bg-[#EF4444]/10',
  itemBg:         'bg-[#EF4444]/5 border-[#EF4444]/10',
  itemBgAnswered: 'bg-[#93C5FD]/20 border-[#93C5FD]/40',
  ratingSelected: 'bg-[#EF4444] text-white font-bold scale-105 shadow-lg shadow-red-900/40',
  ratingDefault:  'bg-[#EF4444]/10 text-[#EF4444] hover:bg-[#EF4444]/20',
  headerBorder:   'border-[#EF4444]/10',
  footerBorder:   'border-[#EF4444]/10',
...
export const PARASYTE_IMAGES: Record<number, string> = {
  0: "/images/Characters/Parasyte/gotou.png",
  1: "/images/Characters/Parasyte/hideo-shimada.png",
  2: "/images/Characters/Parasyte/kana-kimishima.png",
  3: "/images/Characters/Parasyte/kazuyuki-izumi.png",
  4: "/images/Characters/Parasyte/kuramori.png",
  5: "/images/Characters/Parasyte/migi.png",
  6: "/images/Characters/Parasyte/miki.png",
  7: "/images/Characters/Parasyte/mitsuo.png",
  8: "/images/Characters/Parasyte/nobuko-izumi.png",
  9: "/images/Characters/Parasyte/ryoko-tamiya.png",
  10: "/images/Characters/Parasyte/satomi-murano.png",
  11: "/images/Characters/Parasyte/shinichi-izumi.png",
  12: "/images/Characters/Parasyte/yamagishi.png",
  13: "/images/Characters/Parasyte/yuko-tachikawa.png",
  14: "/images/Characters/Parasyte/gotou.png",
  15: "/images/Characters/Parasyte/hideo-shimada.png",
  16: "/images/Characters/Parasyte/kana-kimishima.png",
  17: "/images/Characters/Parasyte/kazuyuki-izumi.png",
  18: "/images/Characters/Parasyte/kuramori.png",
  19: "/images/Characters/Parasyte/migi.png",
  20: "/images/Characters/Parasyte/miki.png",
  21: "/images/Characters/Parasyte/mitsuo.png",
  22: "/images/Characters/Parasyte/nobuko-izumi.png",
  23: "/images/Characters/Parasyte/ryoko-tamiya.png",
  24: "/images/Characters/Parasyte/satomi-murano.png",
  25: "/images/Characters/Parasyte/shinichi-izumi.png",
  26: "/images/Characters/Parasyte/yamagishi.png",
  27: "/images/Characters/Parasyte/yuko-tachikawa.png",
  28: "/images/Characters/Parasyte/gotou.png",
  29: "/images/Characters/Parasyte/hideo-shimada.png",
  30: "/images/Characters/Parasyte/kana-kimishima.png",
  31: "/images/Characters/Parasyte/kazuyuki-izumi.png",
  32: "/images/Characters/Parasyte/kuramori.png",
  33: "/images/Characters/Parasyte/migi.png",
  34: "/images/Characters/Parasyte/miki.png",
  35: "/images/Characters/Parasyte/mitsuo.png",
  36: "/images/Characters/Parasyte/nobuko-izumi.png",
  37: "/images/Characters/Parasyte/ryoko-tamiya.png",
  38: "/images/Characters/Parasyte/satomi-murano.png",
  39: "/images/Characters/Parasyte/shinichi-izumi.png",
  40: "/images/Characters/Parasyte/yamagishi.png",
  41: "/images/Characters/Parasyte/yuko-tachikawa.png",
};
...
function getEpisodeImage(title: string): string {
  ...
  return PARASYTE_IMAGES[episodeNumber] ?? FALLBACK_IMAGE;
}
...
const CATALOG: Arc[] = [
  {
    ...
    episodes: [
      ...
      },
      {
        ...
        subscales: [
          {
            label: 'The One Everyone Notices',
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items: [
      ...
      },
      {
        ...
        subscales: [
          {
            label: 'Cold Blood in the Corridor',
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items: [
  ...
  {
    title:"Arc 2 — The School Invasion",
     episodes: [
      ...
      },
    {
      ...
      subscales:[
        {
          label:"When the Body Betrays You",
    ...
    },
    {
      title:"Episode 14",
      subscales:[{
        label:"Looking at Your Own Face",
        items:[
 ...
 
  {
    title:"Episode 15",
    subscales:[{
      label:"Small Joys of Being Human",
  ...
  },
  {
    title:"Episode 17",
    subscales:[{
      label:"Bonds That Keep You Human",
  ...
  {
    title:"Arc 3 — The Hunt Begins",
     episodes: [
      {
        title:"Episode 18",
        subscales:[{
          label:"Voices on the News",
          items:[
 ...
 
      {
        title:"Episode 22",
        subscales:[{
          label:"The World Behind the Eyes",
  ...
  {
   title:"Arc 4 — East Fukuyama",
     episodes: [
      {
       title:"Episode 23",
       subscales:[{
        label:"Letting Go of the Hate",
      ...
      },
      {
        title:"Episode 25",
        subscales:[{
          label:"Understanding the Other Side",
  ...
  {
   title:"Arc 5 — Human and Parasite",
     episodes: [
      {
        title:"Episode 26",
        subscales:[{
          label:"Getting Through the Days",
  ...
  {
    title:"Arc 6 — The Final Confrontation",
    episodes:[
      
      {
        title:"Episode 31",
        subscales:[{
          label:"Riddles of the Mind",
          items:[
  ...
  {
    title:"Epilogue — What Remains Human",
     episodes: [
      {
        title:"Episode 32",
        subscales:[{
      ...
      },
      {
        title:"Episode 33",
        subscales:[{
          label:"What the Journey Left Behind",
  ...
  interface ParasyteTheMaximQuizProps {
  onFinish: (sessionId:string) => void;
  onBack: () => void;
  demographics?:DemographicPayload
}
 
export default function ParasyteTheMaximQuiz({ onFinish, onBack, demographics }: ParasyteTheMaximQuizProps) {
