...
const THEME: ThemeTokens = {
  ...
  text:           'text-[#F8FAFC]',
  subText:        'text-[#10B981]',
  btnPrimary:     'bg-[#10B981] text-[#040D0A] font-black hover:bg-[#059669]',
  btnOutline:     'border-[#10B981]/30 text-[#10B981] hover:bg-[#10B981]/10',
  itemBg:         'bg-[#F8FAFC]/5 border-[#F8FAFC]/10',
  itemBgAnswered: 'bg-[#10B981]/20 border-[#10B981]/40',
  ratingSelected: 'bg-[#10B981] text-[#040D0A] font-black scale-105 shadow-lg shadow-emerald-900/40',
...
export const PSYCHOPASS_IMAGES: Record<number, string> = {
  0: "/images/Characters/Psycho_pASS/aiko_kurokawa.png",
  1: "/images/Characters/Psycho_pASS/akane-tsunemori.png",
  2: "/images/Characters/Psycho_pASS/akira_karasuma.png",
  3: "/images/Characters/Psycho_pASS/arata_shindo.png",
  4: "/images/Characters/Psycho_pASS/atsushi-shindo.png",
  5: "/images/Characters/Psycho_pASS/ayaka_takami.png",
  6: "/images/Characters/Psycho_pASS/desmond_rutaganda.png",
  7: "/images/Characters/Psycho_pASS/frederica-hanashiro.png",
  8: "/images/Characters/Psycho_pASS/gu-sung_choe.png",
  9: "/images/Characters/Psycho_pASS/haruki_enomiya.png",
  10: "/images/Characters/Psycho_pASS/haruki-shirogane.png",
  11: "/images/Characters/Psycho_pASS/harumi_Hosorogi.png",
  12: "/images/Characters/Psycho_pASS/joji-saiga.png",
  13: "/images/Characters/Psycho_pASS/joshu_kasei.png",
  14: "/images/Characters/Psycho_pASS/junmei_ito.png",
  15: "/images/Characters/Psycho_pASS/karina-komiya.png",
  16: "/images/Characters/Psycho_pASS/kazumichi_irie.png",
  17: "/images/Characters/Psycho_pASS/kei_mikhail_ignatov.png",
  18: "/images/Characters/Psycho_pASS/kirito_kamui.png",
  19: "/images/Characters/Psycho_pASS/kozaburo_toma.png",
  20: "/images/Characters/Psycho_pASS/kyoka_tsujikai.png",
  21: "/images/Characters/Psycho_pASS/kyoko_saionji.png",
  22: "/images/Characters/Psycho_pASS/mika-shimotsuki.png",
  23: "/images/Characters/Psycho_pASS/mizue_shisui.png",
  24: "/images/Characters/Psycho_pASS/nicholas_wong.png",
  25: "/images/Characters/Psycho_pASS/nobuchika-ginoza.png",
  26: "/images/Characters/Psycho_pASS/rikako_oryo.png",
  27: "/images/Characters/Psycho_pASS/risa_aoyanagi.png",
  28: "/images/Characters/Psycho_pASS/rodion_matsuki.png",
  29: "/images/Characters/Psycho_pASS/sakuya-togane.png",
  30: "/images/Characters/Psycho_pASS/shiniya-kogami.png",
  31: "/images/Characters/Psycho_pASS/shion_haranomori.png",
  32: "/images/Characters/Psycho_pASS/shizuka-homura.png",
  33: "/images/Characters/Psycho_pASS/sho-hinakawa.png",
  34: "/images/Characters/Psycho_pASS/shogo-makishima.png",
  35: "/images/Characters/Psycho_pASS/shusei-kagari.png",
  36: "/images/Characters/Psycho_pASS/teppei-sugo.png",
  37: "/images/Characters/Psycho_pASS/tetsuya_sasagawa.png",
  38: "/images/Characters/Psycho_pASS/tomomi-masaoka.png",
};
...
function getEpisodeImage(title: string): string {
  ...
  return PSYCHOPASS_IMAGES[episodeNumber] ?? FALLBACK_IMAGE;
}
...
const CATALOG: Arc[] = [
  {
    title: 'Arc 1 — The Crime Coefficient',
    episodes: [
       {
        title: 'Episode 1',
        ...
        subscales: [
          {
            label: 'Data Kept Off the Record',
      ...
      },
      {
        ...
        subscales: [
          {
            label: 'The Inspector Everyone Notices',
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items: [
  ...
  {
    title:"Arc 2 — Specimen Case Files",
     episodes: [
  
      {
        ...
        subscales: [
          {
            label:"Drifting From the Real World",
      ...
      },
    {
      ...
      subscales:[
        {
          label:"When the Case Falls Apart",
    ...
    },
    {
      title:"Episode 14",
      subscales:[{
        label:"Reading Your Own Coefficient",
        items:[
  ...
  },
  {
    title:"Episode 17",
    subscales:[{
      label:"Bonds Within the Division",
  ...
  {
    title:"Arc 3 — The Helmet Killers",
     episodes: [
      {
        title:"Episode 18",
        subscales:[{
          label:"Voices on the Network",
          items:[
 ...
 
      {
        title:"Episode 22",
        subscales:[{
          label:"The World Behind the Scan",
  ...
  {
   title:"Arc 4 — The Sybil Question",
     episodes: [
      {
       title:"Episode 23",
       subscales:[{
        label:"Letting Go of an Old Case",
      ...
      },
      {
        title:"Episode 25",
        subscales:[{
          label:"Understanding the Suspect",
  ...
  {
   title:"Arc 5 — Inspector and Enforcer",
     episodes: [
      {
        title:"Episode 26",
        subscales:[{
          label:"Getting Through the Investigation",
      ...
      },
      {
        title:"Episode 29",
        subscales:[{
          label:"The One Who Won’t Go Out",
  ...
  {
    title:"Arc 6 — The Final Judgement",
    episodes:[
      
      {
        title:"Episode 31",
        subscales:[{
          label:"Riddles of the Analyst",
          items:[
  ...
  {
    title:"Epilogue — After the Verdict",
     episodes: [
      {
        title:"Episode 32",
        subscales:[{
      ...
      },
      {
        title:"Episode 33",
        subscales:[{
          label:"Looking Back on the Case",
  ...
  interface PsychoPassQuizProps {
  onFinish: (sessionId:string) => void;
  onBack: () => void;
  demographics?:DemographicPayload
}
 
export default function PsychoPassQuiz({ onFinish, onBack, demographics }: PsychoPassQuizProps) {
