...
const ANIME_SLUG = "solo-leveling";
...
const THEME: ThemeTokens = {
  ...
  text:           'text-[#22D3EE]',
  subText:        'text-[#D8B4FE]',
  btnPrimary:     'bg-[#22D3EE] text-black font-bold hover:bg-[#06b6d4]',
  btnOutline:     'border-[#22D3EE]/30 text-[#22D3EE] hover:bg-[#22D3EE]/10',
  itemBg:         'bg-[#22D3EE]/5 border-[#22D3EE]/20',
  itemBgAnswered: 'bg-[#22D3EE]/20 border-[#22D3EE]/40',
  ratingSelected: 'bg-[#22D3EE] text-black font-bold scale-105 shadow-lg shadow-cyan-500/30',
  ratingDefault:  'bg-[#0B0914] border border-[#22D3EE]/30 text-[#22D3EE] hover:bg-[#22D3EE]/10',
  headerBorder:   'border-[#22D3EE]/20',
  footerBorder:   'border-[#22D3EE]/20',
...
export const SOLO_LEVELLING_IMAGES: Record<number, string> = {
  0: "/images/Characters/Solo_Leveling/antares.png",
  1: "/images/Characters/Solo_Leveling/baek-yoonho.png",
  2: "/images/Characters/Solo_Leveling/cha-hae-in.png",
  3: "/images/Characters/Solo_Leveling/choi-jong-in.png",
  4: "/images/Characters/Solo_Leveling/christopher-reed.png",
  5: "/images/Characters/Solo_Leveling/go-gun-hee.png",
  6: "/images/Characters/Solo_Leveling/han-song-yi.png",
  7: "/images/Characters/Solo_Leveling/hwang-dongsoo.png",
  8: "/images/Characters/Solo_Leveling/hwang-dongsuk.png",
  9: "/images/Characters/Solo_Leveling/igris.png",
  10: "/images/Characters/Solo_Leveling/jung-yoontae.png",
  11: "/images/Characters/Solo_Leveling/kang-taeshik.png",
  12: "/images/Characters/Solo_Leveling/kim-chul.png",
  13: "/images/Characters/Solo_Leveling/kim-sangshik.png",
  14: "/images/Characters/Solo_Leveling/laura.png",
  15: "/images/Characters/Solo_Leveling/lee-joohee.png",
  16: "/images/Characters/Solo_Leveling/lee-minsung.png",
  17: "/images/Characters/Solo_Leveling/lim-tae-gyu.png",
  18: "/images/Characters/Solo_Leveling/liu-zhigang.png",
  19: "/images/Characters/Solo_Leveling/min-byung-gyu.png",
  20: "/images/Characters/Solo_Leveling/park-beom-shik.png",
  21: "/images/Characters/Solo_Leveling/park-heejin.png",
  22: "/images/Characters/Solo_Leveling/park-jongsoo.png",
  23: "/images/Characters/Solo_Leveling/park-kyung-hye.png",
  24: "/images/Characters/Solo_Leveling/son-chi-yul.png",
  25: "/images/Characters/Solo_Leveling/sung-jinah.png",
  26: "/images/Characters/Solo_Leveling/sung-jinwoo.png",
  27: "/images/Characters/Solo_Leveling/the-beast-monarch.png",
  28: "/images/Characters/Solo_Leveling/the-frost-monarch.png",
  29: "/images/Characters/Solo_Leveling/the-plague-monarch.png",
  30: "/images/Characters/Solo_Leveling/thomas-andre.png",
  31: "/images/Characters/Solo_Leveling/woo-jinchul.png",
  32: "/images/Characters/Solo_Leveling/yoo-jinho.png",
  33: "/images/Characters/Solo_Leveling/yoo-soohyun.png",
  34: "/images/Characters/Solo_Leveling/thomas-andre.png",
};
...
function getEpisodeImage(title: string): string {
  ...
  return SOLO_LEVELLING_IMAGES[episodeNumber] ?? FALLBACK_IMAGE;
}
...
const CATALOG: Arc[] = [
  {
    title: 'Arc 1 — The Double Dungeon',
    episodes: [
       {
        title: 'Episode 1',
      ...
      },
      {
        ...
        subscales: [
          {
            label: 'The Hunter Everyone Watches',
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items: [
      ...
      },
      {
        ...
        subscales: [
          {
            label: 'Cold Steel in the Dungeon',
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items: [
      ...
      },
      {
        ...
        subscales: [
          {
            label: 'Members of the Raid Party',
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items: [
      ...
      },
      {
        ...
        subscales: [
          {
            label:"The Long Grind of Levels",
 ...
 
  {
    title:"Episode 15",
    subscales:[{
      label:"Small Joys Between Gates",
  ...
  {
    title:"Arc 3 — The Red Gate",
     episodes: [
      {
        title:"Episode 18",
        subscales:[{
          label:"Signals From the Association",
          items:[
 ...
 
      {
        title:"Episode 22",
        subscales:[{
          label:"The World Inside the System",
  ...
  {
   title:"Arc 4 — The Jeju Island Raid",
     episodes: [
      {
       title:"Episode 23",
       subscales:[{
      ...
      },
      {
        title:"Episode 25",
        subscales:[{
          label:"Seeing Another Hunter Struggle",
  ...
  {
   title:"Arc 5 — Shadow and Monarch",
     episodes: [
      {
        title:"Episode 26",
        subscales:[{
      ...
      },
      {
        title:"Episode 29",
        subscales:[{
          label:"The Hunter Who Stays Inside",
  ...
  {
    title:"Arc 6 — The Final Gate",
    episodes:[
      
      {
        title:"Episode 31",
        subscales:[{
          label:"Riddles of the System",
          items:[
  ...
  {
    title:"Epilogue — The System’s Record",
     episodes: [
      {
        title:"Episode 32",
        subscales:[{
  ...
  interface SoloLevelingQuizProps {
  onFinish: (sessionId:string) => void;
  onBack: () => void;
  demographics?:DemographicPayload
}
 
export default function SoloLevellingQuiz({ onFinish, onBack, demographics }: SoloLevelingQuizProps) {
