...
const THEME: ThemeTokens = {
  ...
  text:           'text-[#D4A34F]',
  subText:        'text-[#A83232]',
  btnPrimary:     'bg-[#A83232] text-white hover:bg-[#852828]',
  btnOutline:     'border-[#D4A34F]/20 text-[#D4A34F] hover:bg-[#D4A34F]/10',
  itemBg:         'bg-[#D4A34F]/5 border-[#D4A34F]/10',
  itemBgAnswered: 'bg-[#A83232]/20 border-[#A83232]/40',
  ratingSelected: 'bg-[#A83232] text-white scale-105 shadow-lg shadow-red-900/30',
  ratingDefault:  'bg-[#D4A34F]/10 text-[#D4A34F] hover:bg-[#D4A34F]/20',
  headerBorder:   'border-[#D4A34F]/10',
  footerBorder:   'border-[#D4A34F]/10',
  labelColor:     'text-[#D4A34F]',
  accentColor:    '#A83232',
...
export const SPY_X_FAMILY_IMAGES: Record<number, string> = {
  0: "/images/Characters/Spy_X_Family/anya-forger.png",
  1: "/images/Characters/Spy_X_Family/becky-blackbell.png",
  2: "/images/Characters/Spy_X_Family/bill_watkins_2.png",
  3: "/images/Characters/Spy_X_Family/camilla_2.png",
  4: "/images/Characters/Spy_X_Family/damian-desmond.png",
  5: "/images/Characters/Spy_X_Family/daybreak_2.png",
  6: "/images/Characters/Spy_X_Family/demetrius-desmond.png",
  7: "/images/Characters/Spy_X_Family/dominic_2.png",
  8: "/images/Characters/Spy_X_Family/donovan-desmond.png",
  9: "/images/Characters/Spy_X_Family/emile-elman.png",
  10: "/images/Characters/Spy_X_Family/ewen-egeberg.png",
  11: "/images/Characters/Spy_X_Family/fiona-frost.png",
  12: "/images/Characters/Spy_X_Family/franky-franklin.png",
  13: "/images/Characters/Spy_X_Family/henry-henderson.png",
  14: "/images/Characters/Spy_X_Family/loid-forger.png",
  15: "/images/Characters/Spy_X_Family/melinda-desmond.png",
  16: "/images/Characters/Spy_X_Family/ELLE_SHARON.png",
  17: "/images/Characters/Spy_X_Family/sylvia-sherwood.png",
  18: "/images/Characters/Spy_X_Family/yor-forger.png",
  19: "/images/Characters/Spy_X_Family/yuri-briar.png",
  20: "/images/Characters/Spy_X_Family/becky-blackbell.png",
  21: "/images/Characters/Spy_X_Family/bill_watkins_2.png",
  22: "/images/Characters/Spy_X_Family/camilla_2.png",
  23: "/images/Characters/Spy_X_Family/damian-desmond.png",
  24: "/images/Characters/Spy_X_Family/daybreak_2.png",
  25: "/images/Characters/Spy_X_Family/demetrius-desmond.png",
  26: "/images/Characters/Spy_X_Family/dominic_2.png",
  27: "/images/Characters/Spy_X_Family/donovan-desmond.png",
  28: "/images/Characters/Spy_X_Family/emile-elman.png",
  29: "/images/Characters/Spy_X_Family/ewen-egeberg.png",
  30: "/images/Characters/Spy_X_Family/fiona-frost.png",
  31: "/images/Characters/Spy_X_Family/franky-franklin.png",
  32: "/images/Characters/Spy_X_Family/henry-henderson.png",
  33: "/images/Characters/Spy_X_Family/loid-forger.png",
  34: "/images/Characters/Spy_X_Family/melinda-desmond.png",
  35: "/images/Characters/Spy_X_Family/ELLE_SHARON.png",
  36: "/images/Characters/Spy_X_Family/sylvia-sherwood.png",
  37: "/images/Characters/Spy_X_Family/yor-forger.png",
  38: "/images/Characters/Spy_X_Family/yuri-briar.png",
};
...
function getEpisodeImage(title: string): string {
  ...
  return SPY_X_FAMILY_IMAGES[episodeNumber] ?? FALLBACK_IMAGE;
}
...
const CATALOG: Arc[] = [
    ...
    episodes: [
       {
        ...
        subscales: [
          {
            label: 'Things Never Told at Dinner',
      ...
      },
      {
        ...
        subscales: [
          {
            label: 'The Student Everyone Notices',
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items: [
  ...
  },
  {
    ...
    },
    {
      title:"Episode 11",
      subscales:[{
        label:"An Old Wound Beneath the Smile",
    ...
    },
    {
      title:"Episode 14",
      subscales:[{
        label:"Looking at Your Own Role",
        items:[
  ...
  {
    title:"Arc 3 — The Cruise Mission",
     episodes: [
      {
        title:"Episode 18",
        subscales:[{
          label:"Voices on the Broadcast",
          items:[
      ...
      },
      {
        title:"Episode 19",
        subscales:[{
          label:"Short Clips, Long Evenings",
          items:[
 ...
 
      {
        title:"Episode 22",
        subscales:[{
          label:"The World Behind the Cover Story",
  ...
  {
   title:"Arc 4 — The Imperial Scholars",
     episodes: [
      {
       title:"Episode 23",
       subscales:[{
      ...
      },
      {
        title:"Episode 25",
        subscales:[{
          label:"Seeing Another’s Struggle",
  ...
  {
   title:"Arc 5 — Handler and Agent",
     episodes: [
      {
        title:"Episode 26",
        subscales:[{
          label:"Getting Through the Term",
      ...
      },
      {
        title:"Episode 29",
        subscales:[{
          label:"The One Who Stays Inside",
  ...
  {
    title:"Arc 6 — The Final Briefing",
    episodes:[
      
      {
        title:"Episode 31",
        subscales:[{
          label:"Riddles at the Academy",
          items:[
  ...
  {
    title:"Epilogue — The Family Record",
     episodes: [
      {
        title:"Episode 32",
        subscales:[{
  ...
  interface SpyXFamilyQuizProps {
  onFinish: (sessionId:string) => void;
  onBack: () => void;
  demographics?:DemographicPayload
}
 
export default function SpyXFamilyQuiz({ onFinish, onBack, demographics }: SpyXFamilyQuizProps) {
