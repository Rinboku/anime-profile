...
const THEME: ThemeTokens = {
  ...
  text:           'text-[#38BDF8]',
  subText:        'text-[#FDE047]',
  btnPrimary:     'bg-[#FDE047] text-[#0E1927] font-bold hover:bg-[#eab308]',
  btnOutline:     'border-[#38BDF8]/30 text-[#38BDF8] hover:bg-[#38BDF8]/10',
  itemBg:         'bg-[#38BDF8]/5 border-[#38BDF8]/10',
  itemBgAnswered: 'bg-[#FDE047]/20 border-[#FDE047]/40',
  ratingSelected: 'bg-[#FDE047] text-[#0E1927] font-bold scale-105 shadow-lg shadow-yellow-500/30',
...
export const STEINS_GATE_IMAGES:Record<number,string> = {
0:"public/images/Characters/Steins_Gate/kagari-shiina.png",
1:"public/images/Characters/Steins_Gate/kurisu-makise.png",
2:"public/images/Characters/Steins_Gate/luka-urushibara.png",
3:"public/images/Characters/Steins_Gate/maho-hiyajo.png",
4:"public/images/Characters/Steins_Gate/mayuri-shiina.png",
5:"public/images/Characters/Steins_Gate/moeka-kiryu.png",
6:"public/images/Characters/Steins_Gate/nae-tennoji.png",
7:"public/images/Characters/Steins_Gate/rintaro-okabe.png",
8:"public/images/Characters/Steins_Gate/suzuha-amane.png",
9:"public/images/Characters/Steins_Gate/yugo-tennoji.png",
10:"public/images/Characters/Steins_Gate/yuki-amane.png",
11:"public/images/Characters/Steins_Gate/kagari-shiina.png",
12:"public/images/Characters/Steins_Gate/kurisu-makise.png",
13:"public/images/Characters/Steins_Gate/luka-urushibara.png",
14:"public/images/Characters/Steins_Gate/maho-hiyajo.png",
15:"public/images/Characters/Steins_Gate/mayuri-shiina.png",
16:"public/images/Characters/Steins_Gate/moeka-kiryu.png",
17:"public/images/Characters/Steins_Gate/nae-tennoji.png",
18:"public/images/Characters/Steins_Gate/rintaro-okabe.png",
19:"public/images/Characters/Steins_Gate/suzuha-amane.png",
20:"public/images/Characters/Steins_Gate/yugo-tennoji.png",
21:"public/images/Characters/Steins_Gate/yuki-amane.png",
22:"public/images/Characters/Steins_Gate/kagari-shiina.png",
23:"public/images/Characters/Steins_Gate/kurisu-makise.png",
24:"public/images/Characters/Steins_Gate/luka-urushibara.png",
25:"public/images/Characters/Steins_Gate/maho-hiyajo.png",
26:"public/images/Characters/Steins_Gate/mayuri-shiina.png",
27:"public/images/Characters/Steins_Gate/moeka-kiryu.png",
28:"public/images/Characters/Steins_Gate/nae-tennoji.png",
29:"public/images/Characters/Steins_Gate/rintaro-okabe.png",
30:"public/images/Characters/Steins_Gate/suzuha-amane.png",
31:"public/images/Characters/Steins_Gate/yugo-tennoji.png",
32:"public/images/Characters/Steins_Gate/yuki-amane.png",
33:"public/images/Characters/Steins_Gate/kagari-shiina.png",
34:"public/images/Characters/Steins_Gate/kurisu-makise.png",
}
...
function getEpisodeImage(title: string): string {
  ...
  return STEINS_GATE_IMAGES[episodeNumber] ?? FALLBACK_IMAGE;
}
...
const CATALOG: Arc[] = [
  {
    ...
    episodes: [
      ...
      },
      {
        ...
        subscales: [
          {
            label: 'The One Who Wants Recognition',
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items: [
  ...
  {
    title:"Arc 2 — The D-Mail Experiments",
     episodes: [
  
      {
        ...
        subscales: [
          {
            label:"Drifting Between Worldlines",
      ...
      },
    {
      ...
      subscales:[
        {
          label:"When the Timeline Breaks",
    ...
    },
    {
      title:"Episode 14",
      subscales:[{
        label:"Looking at Your Own Record",
        items:[
  ...
  },
  {
    title: "Episode 16",
    subscales:[{
      label:"The Waiting Between Jumps",
  ...
  {
    title:"Arc 3 — Divergence",
     episodes: [
      {
        title:"Episode 18",
        subscales:[{
          label:"Signals on the Network",
          items:[
 ...
 
      {
        title:"Episode 22",
        subscales:[{
          label:"The World Inside the Simulation",
  ...
  {
   title:"Arc 4 — The Beta Worldline",
     episodes: [
      {
       title:"Episode 23",
       subscales:[{
        label:"Letting Go of the Old Timeline",
      ...
      },
      {
        title:"Episode 25",
        subscales:[{
          label:"Understanding Another’s Loss",
  ...
  {
   title:"Arc 5 — Mentor and Lab Member",
     episodes: [
      {
        title:"Episode 26",
        subscales:[{
          label:"Getting Through the Experiment",
      ...
      },
      {
        title:"Episode 29",
        subscales:[{
          label:"The One Who Won’t Leave the Lab",
      ...
      },
      {
        title:"Episode 30",
        subscales:[{
          label:"A Place Among the Members",
  ...
  {
    title:"Arc 6 — Operation Skuld",
    episodes:[
      
      {
        title:"Episode 31",
        subscales:[{
          label:"Riddles of the Mad Scientist",
          items:[
  ...
  {
    title:"Epilogue — The Final Worldline",
     episodes: [
      {
        title:"Episode 32",
        subscales:[{
      ...
      },
      {
        title:"Episode 33",
        subscales:[{
          label:"The Final Worldline Remembered",
  ...
  interface SteinsGateQuizProps {
  onFinish: (sessionId:string) => void;
  onBack: () => void;
  demographics?:DemographicPayload
}
 
export default function SteinsGateQuiz({ onFinish, onBack, demographics }: SteinsGateQuizProps) {
