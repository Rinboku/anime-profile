...
const ANIME_SLUG = "sword-art-online";
...
const THEME: ThemeTokens = {
  ...
  text:           'text-[#E2EFFE]',
  subText:        'text-[#F3B05C]',
  btnPrimary:     'bg-[#38BDF8] text-[#1A2E40] font-bold hover:bg-[#0EA5E9]',
  btnOutline:     'border-[#E2EFFE]/20 text-[#E2EFFE] hover:bg-[#E2EFFE]/10',
  itemBg:         'bg-[#E2EFFE]/5 border-[#E2EFFE]/10',
  itemBgAnswered: 'bg-[#38BDF8]/20 border-[#38BDF8]/40',
  ratingSelected: 'bg-[#38BDF8] text-[#1A2E40] font-bold scale-105 shadow-lg shadow-sky-500/30',
  ratingDefault:  'bg-[#E2EFFE]/10 text-[#E2EFFE] hover:bg-[#E2EFFE]/20',
  headerBorder:   'border-[#E2EFFE]/10',
  footerBorder:   'border-[#E2EFFE]/10',
  labelColor:     'text-[#E2EFFE]',
  accentColor:    '#38BDF8',
...
export const SWORD_ART_ONLINE_IMAGES: Record<number, string> = {
  0: "/images/Characters/Sword_Art_Online/administrator.png",
  1: "/images/Characters/Sword_Art_Online/agil.png",
  2: "/images/Characters/Sword_Art_Online/alice-zuberg.png",
  3: "/images/Characters/Sword_Art_Online/alicia-rue.png",
  4: "/images/Characters/Sword_Art_Online/asuna-yuuki.png",
  5: "/images/Characters/Sword_Art_Online/bercouli-synthesis-one.png",
  6: "/images/Characters/Sword_Art_Online/cardinal.png",
  7: "/images/Characters/Sword_Art_Online/dyne.png",
  8: "/images/Characters/Sword_Art_Online/eldrie-synthesis-thirty-one.png",
  9: "/images/Characters/Sword_Art_Online/eugene.png",
  10: "/images/Characters/Sword_Art_Online/eugeo.png",
  11: "/images/Characters/Sword_Art_Online/fanatio-synthesis-two.png",
  12: "/images/Characters/Sword_Art_Online/gabriel-miller.png",
  13: "/images/Characters/Sword_Art_Online/heathcliff.png",
  14: "/images/Characters/Sword_Art_Online/iskahn.png",
  15: "/images/Characters/Sword_Art_Online/jun-konno.png",
  16: "/images/Characters/Sword_Art_Online/kazuto-kirigaya.png",
  17: "/images/Characters/Sword_Art_Online/klein.png",
  18: "/images/Characters/Sword_Art_Online/kyouji-shinkawa.png",
  19: "/images/Characters/Sword_Art_Online/lisbeth.png",
  20: "/images/Characters/Sword_Art_Online/nobuyuki-sugou.png",
  21: "/images/Characters/Sword_Art_Online/pitohui.png",
  22: "/images/Characters/Sword_Art_Online/recon.png",
  23: "/images/Characters/Sword_Art_Online/renly-synthesis-twenty-seven.png",
  24: "/images/Characters/Sword_Art_Online/ronye-arabel.png",
  25: "/images/Characters/Sword_Art_Online/pitohui.png",
  26: "/images/Characters/Sword_Art_Online/sheyta.png",
  27: "/images/Characters/Sword_Art_Online/shino-asada.png",
  28: "/images/Characters/Sword_Art_Online/shouichi-shinkawa.png",
  29: "/images/Characters/Sword_Art_Online/silica.png",
  30: "/images/Characters/Sword_Art_Online/suguha-kirigaya.png",
  31: "/images/Characters/Sword_Art_Online/tiese-shtolienen.png",
  32: "/images/Characters/Sword_Art_Online/vassago-casals.png",
  33: "/images/Characters/Sword_Art_Online/yuuki-konno.png",
  34: "/images/Characters/Sword_Art_Online/renly-synthesis-twenty-seven.png",
  35: "/images/Characters/Sword_Art_Online/jun-konno.png",
  36: "/images/Characters/Sword_Art_Online/cardinal.png",
  37: "/images/Characters/Sword_Art_Online/heathcliff.png",
  38: "/images/Characters/Sword_Art_Online/nobuyuki-sugou.png",
  39: "/images/Characters/Sword_Art_Online/klein.png",
  40: "/images/Characters/Sword_Art_Online/asuna-yuuki.png",
};
...
function getEpisodeImage(title: string): string {
  ...
  return SWORD_ART_ONLINE_IMAGES[episodeNumber] ?? FALLBACK_IMAGE;
}
...
const CATALOG: Arc[] = [
  {
    ...
    episodes: [
      ...
      },
      {
        ...
        subscales: [
          {
            label: 'The Player Everyone Follows',
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items: [
      ...
      },
      {
        ...
        subscales: [
          {
            label:"Reading the Boss Pattern",
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items:[
  ...
  },
  {
    title:"Arc 2 — The Middle Floors",
     episodes: [
  
      {
        ...
        subscales: [
          {
            label:"Daydreams Between Floors",
    ...
    },
    {
      title:"Episode 13",
      subscales:[{
        label:"Nights Without Logging Off",
        items:[
 ...
 
  {
    title:"Episode 15",
    subscales:[{
      label:"Small Joys in the Town of Beginnings",
  ...
  {
    title:"Arc 3 — Fairy Dance",
     episodes: [
      {
        title:"Episode 18",
        subscales:[{
          label:"Messages Across the Server",
          items:[
 ...
 
      {
        title:"Episode 22",
        subscales:[{
          label:"The World Inside the Game",
   ...
   title:"Arc 4 — Phantom Bullet",
     episodes: [
      ...
      },
      {
        title:"Episode 25",
        subscales:[{
          label:"Seeing Another Player Struggle",
  ...
  {
   title:"Arc 5 — Mentor and Player",
     episodes: [
      {
        title:"Episode 26",
        subscales:[{
          label:"Getting Through the Raid",
      ...
      },
      {
        title:"Episode 28",
        subscales:[{
          label:"The Home You Left Behind",
      ...
      },
      {
        title:"Episode 29",
        subscales:[{
          label:"The Player Who Won’t Log Out",
  ...
  {
    title:"Arc 6 — The Final Boss",
    episodes:[
      
      {
        title:"Episode 31",
        subscales:[{
          label:"Riddles of the Game Master",
          items:[
  ...
  {
    title:"Epilogue — After Logout",
     episodes: [
      {
        title:"Episode 32",
        subscales:[{
          label:"Drawn Into the Story",
  ...
  interface SwordArtOnlineQuizProps {
  onFinish: (sessionId:string) => void;
  onBack: () => void;
  demographics?:DemographicPayload
}
 
export default function SwordArtOnline({ onFinish, onBack, demographics }: SwordArtOnlineQuizProps) {
