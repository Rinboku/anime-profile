...
const ANIME_SLUG = "the-apothecary-diaries";
...
const THEME: ThemeTokens = {
  ...
  text:           'text-[#10B981]',
  subText:        'text-[#FBBF24]',
  btnPrimary:     'bg-[#10B981] text-[#0E132B] font-bold hover:bg-[#059669]',
  btnOutline:     'border-[#10B981]/30 text-[#10B981] hover:bg-[#10B981]/10',
  itemBg:         'bg-[#10B981]/5 border-[#10B981]/10',
  itemBgAnswered: 'bg-[#FBBF24]/20 border-[#FBBF24]/40',
  ratingSelected: 'bg-[#10B981] text-[#0E132B] font-bold scale-105 shadow-lg shadow-emerald-900/40',
  ratingDefault:  'bg-[#10B981]/10 text-[#10B981] hover:bg-[#10B981]/20',
  headerBorder:   'border-[#10B981]/10',
  footerBorder:   'border-[#10B981]/10',
...
export const APOTHECARY_DIARIES_IMAGES: Record<number, string> = {
  0: "/images/Characters/The_Apothecary_Diaries/basen.png",
  1: "/images/Characters/The_Apothecary_Diaries/fengming.png",
  2: "/images/Characters/The_Apothecary_Diaries/gaoshun.png",
  3: "/images/Characters/The_Apothecary_Diaries/guiyuan.png",
  4: "/images/Characters/The_Apothecary_Diaries/gyokuyou.png",
  5: "/images/Characters/The_Apothecary_Diaries/hongniang.png",
  6: "/images/Characters/The_Apothecary_Diaries/jinshi.png",
  7: "/images/Characters/The_Apothecary_Diaries/joka.png",
  8: "/images/Characters/The_Apothecary_Diaries/kyou-u.png",
  9: "/images/Characters/The_Apothecary_Diaries/lakan.png",
  10: "/images/Characters/The_Apothecary_Diaries/lihua.png",
  11: "/images/Characters/The_Apothecary_Diaries/lishu.png",
  12: "/images/Characters/The_Apothecary_Diaries/loulan.png",
  13: "/images/Characters/The_Apothecary_Diaries/luomen.png",
  14: "/images/Characters/The_Apothecary_Diaries/maomao.png",
  15: "/images/Characters/The_Apothecary_Diaries/meimei.png",
  16: "/images/Characters/The_Apothecary_Diaries/pairin.png",
  17: "/images/Characters/The_Apothecary_Diaries/shenlu.png",
  18: "/images/Characters/The_Apothecary_Diaries/shisui.png",
  19: "/images/Characters/The_Apothecary_Diaries/suirei.png",
  20: "/images/Characters/The_Apothecary_Diaries/suiren.png",
  21: "/images/Characters/The_Apothecary_Diaries/xiaolan.png",
  22: "/images/Characters/The_Apothecary_Diaries/yinghua.png",
  23: "/images/Characters/The_Apothecary_Diaries/guiyuan.png",
  24: "/images/Characters/The_Apothecary_Diaries/gyokuyou.png",
  25: "/images/Characters/The_Apothecary_Diaries/hongniang.png",
  26: "/images/Characters/The_Apothecary_Diaries/jinshi.png",
  27: "/images/Characters/The_Apothecary_Diaries/joka.png",
  28: "/images/Characters/The_Apothecary_Diaries/kyou-u.png",
  29: "/images/Characters/The_Apothecary_Diaries/lakan.png",
  30: "/images/Characters/The_Apothecary_Diaries/lihua.png",
  31: "/images/Characters/The_Apothecary_Diaries/lishu.png",
  32: "/images/Characters/The_Apothecary_Diaries/loulan.png",
  33: "/images/Characters/The_Apothecary_Diaries/luomen.png",
  34: "/images/Characters/The_Apothecary_Diaries/maomao.png",
  35: "/images/Characters/The_Apothecary_Diaries/meimei.png",
  36: "/images/Characters/The_Apothecary_Diaries/pairin.png",
  37: "/images/Characters/The_Apothecary_Diaries/shenlu.png",
};
...
function getEpisodeImage(title: string): string {
  ...
  return APOTHECARY_DIARIES_IMAGES[episodeNumber] ?? FALLBACK_IMAGE;
}
...
const CATALOG: Arc[] = [
  {
    title: 'Arc 1 — Into the Rear Palace',
    episodes: [
       {
        title: 'Episode 1',
        ...
        subscales: [
          {
            label: 'Things Kept From the Court',
      ...
      },
      {
        ...
        subscales: [
          {
            label: 'The Concubine Everyone Watches',
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items: [
      ...
      },
      {
        ...
        subscales: [
          {
            label: 'Cold Eyes in the Corridor',
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items: [
      ...
      },
      {
        ...
        subscales: [
          {
            label: 'People of the Rear Palace',
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items: [
  ...
  {
    title:"Arc 2 — The Garden Banquet",
     episodes: [
  
      {
        ...
        subscales: [
          {
            label:"Daydreams in the Herb Garden",
      ...
      },
    {
      ...
      subscales:[
        {
          label:"When the Diagnosis Fails",
    ...
    },
    {
      title:"Episode 13",
      subscales:[{
        label:"Nights in the Apothecary",
        items:[
    ...
    },
    {
      title:"Episode 14",
      subscales:[{
        label:"Looking at Your Own Standing",
        items:[
 ...
 
  {
    title:"Episode 15",
    subscales:[{
      label:"Small Joys in the Garden",
  ...
  },
  {
    title: "Episode 16",
    subscales:[{
      label:"The Idle Hours of the Court",
  ...
  {
    title:"Arc 3 — The Outer Court",
     episodes: [
      {
        title:"Episode 18",
        subscales:[{
          label:"Whispers Through the Halls",
          items:[
 ...
 
      {
        title:"Episode 22",
        subscales:[{
          label:"The World Behind the Screen",
  ...
  {
   title:"Arc 4 — The Poisoned Cup",
     episodes: [
      {
       title:"Episode 23",
       subscales:[{
        label:"Letting Go of an Old Slight",
      ...
      },
      {
        title:"Episode 25",
        subscales:[{
          label:"Understanding Another’s Pain",
  ...
  {
   title:"Arc 5 — Physician and Apprentice",
     episodes: [
      {
        title:"Episode 26",
        subscales:[{
          label:"Getting Through the Season",
      ...
      },
      {
        title:"Episode 28",
        subscales:[{
          label:"The Home That Raised You",
      ...
      },
      {
        title:"Episode 29",
        subscales:[{
          label:"The One Who Stays in Her Room",
  ...
  {
    title:"Arc 6 — The Final Diagnosis",
    episodes:[
      
      {
        title:"Episode 31",
        subscales:[{
          label:"Riddles of the Strategist",
          items:[
  ...
  {
    title:"Epilogue — The Apothecary’s Notes",
     episodes: [
      {
        title:"Episode 32",
        subscales:[{
          label:"Drawn Into the Tale",
      ...
      },
      {
        title:"Episode 33",
        subscales:[{
          label:"The Apothecary’s Last Entry",
  ...
  interface TheApothecaryDiariesQuizProps {
  onFinish: (sessionId:string) => void;
  onBack: () => void;
  demographics?:DemographicPayload
}
 
export default function TheApothecaryDiariesQuiz({ onFinish, onBack, demographics }: TheApothecaryDiariesQuizProps) {
