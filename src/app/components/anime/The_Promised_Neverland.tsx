...
const ANIME_SLUG = "the-promised-neverland";
...
const THEME: ThemeTokens = {
  ...
  text:           'text-[#FACC15]',
  subText:        'text-[#D97706]',
  btnPrimary:     'bg-[#FACC15] text-[#0A0907] font-bold hover:bg-[#eab308]',
  btnOutline:     'border-[#FACC15]/30 text-[#FACC15] hover:bg-[#FACC15]/10',
  itemBg:         'bg-[#FACC15]/5 border-[#FACC15]/10',
  itemBgAnswered: 'bg-[#D97706]/20 border-[#D97706]/40',
  ratingSelected: 'bg-[#FACC15] text-[#0A0907] font-bold scale-105 shadow-lg shadow-yellow-900/40',
  ratingDefault:  'bg-[#FACC15]/10 text-[#FACC15] hover:bg-[#FACC15]/20',
  headerBorder:   'border-[#FACC15]/10',
  footerBorder:   'border-[#FACC15]/10',
...
export const PROMISED_IMAGES:Record<number,string> = {
0:"/images/The_Promised_Neverland/Alicia.png",
1:"/images/The_Promised_Neverland/Anna.png",
2:"/images/The_Promised_Neverland/Conny.png",
3:"/images/The_Promised_Neverland/Don.png",
4:"/images/The_Promised_Neverland/Emma.png",
5:"/images/The_Promised_Neverland/Gilda.png",
6:"/images/The_Promised_Neverland/Irma.png",
7:"/images/The_Promised_Neverland/Isabella.png",
8:"/images/The_Promised_Neverland/James_Ratri.png",
9:"/images/The_Promised_Neverland/Lannion.png",
10:"/images/The_Promised_Neverland/Nat.png",
11:"/images/The_Promised_Neverland/Norman.png",
12:"/images/The_Promised_Neverland/Ray.png",
13:"/images/The_Promised_Neverland/Thoma.png",
14:"/images/The_Promised_Neverland/Yvette.png",
15:"/images/The_Promised_Neverland/Alicia.png",
16:"/images/The_Promised_Neverland/Anna.png",
17:"/images/The_Promised_Neverland/Conny.png",
18:"/images/The_Promised_Neverland/Don.png",
19:"/images/The_Promised_Neverland/Emma.png",
20:"/images/The_Promised_Neverland/Gilda.png",
21:"/images/The_Promised_Neverland/Irma.png",
22:"/images/The_Promised_Neverland/Isabella.png",
23:"/images/The_Promised_Neverland/James_Ratri.png",
24:"/images/The_Promised_Neverland/Lannion.png",
25:"/images/The_Promised_Neverland/Nat.png",
26:"/images/The_Promised_Neverland/Norman.png",
27:"/images/The_Promised_Neverland/Ray.png",
28:"/images/The_Promised_Neverland/Thoma.png",
29:"/images/The_Promised_Neverland/Yvette.png",
30:"/images/The_Promised_Neverland/Thoma.png",
31:"/images/The_Promised_Neverland/Yvette.png",
32:"/images/The_Promised_Neverland/Alicia.png",
33:"/images/The_Promised_Neverland/Anna.png",
34:"/images/The_Promised_Neverland/Conny.png",
35:"/images/The_Promised_Neverland/Don.png",
36:"/images/The_Promised_Neverland/Emma.png",
}
...
function getEpisodeImage(title: string): string {
  ...
  return PROMISED_IMAGES[episodeNumber] ?? FALLBACK_IMAGE;
}
...
const CATALOG: Arc[] = [
  {
    ...
    episodes: [
      ...
      },
      {
        ...
        subscales: [
          {
            label: 'The Child Everyone Praises',
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items: [
      ...
      },
      {
        ...
        subscales: [
          {
            label: 'The Children of the House',
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items: [
  ...
  },
  {
    title:"Arc 2 — The Escape",
     episodes: [
  
      {
        ...
        subscales: [
          {
            label:"Daydreams Beyond the Wall",
    ...
    },
    {
      title:"Episode 13",
      subscales:[{
        label:"Nights Before the Escape",
        items:[
    ...
    },
    {
      title:"Episode 14",
      subscales:[{
        label:"Looking at Your Own Number",
        items:[
  ...
  },
  {
    title:"Episode 17",
    subscales:[{
      label:"Bonds Between the Children",
  ...
  {
    title:"Arc 3 — The Forest",
     episodes: [
      {
        title:"Episode 18",
        subscales:[{
          label:"Voices Beyond the Gate",
          items:[
 ...
 
      {
        title:"Episode 22",
        subscales:[{
          label:"The World Beyond the Wall",
  ...
  {
   title:"Arc 4 — Goldy Pond",
     episodes: [
      {
       title:"Episode 23",
       subscales:[{
        label:"Letting Go of the Blame",
      ...
      },
      {
        title:"Episode 25",
        subscales:[{
          label:"Understanding Mother’s Reasons",
  ...
  {
   title:"Arc 5 — Mother and Child",
     episodes: [
      {
        title:"Episode 26",
        subscales:[{
          label:"Getting Through the Escape",
      ...
      },
      {
        title:"Episode 28",
        subscales:[{
          label:"The House That Raised You",
      ...
      },
      {
        title:"Episode 29",
        subscales:[{
          label:"The Child Who Won’t Leave the Room",
      ...
      },
      {
        title:"Episode 30",
        subscales:[{
          label:"A Place Among the Family",
  ...
  {
    title:"Arc 6 — The Final Promise",
    episodes:[
      
      {
        title:"Episode 31",
        subscales:[{
          label:"Riddles of the Exam",
          items:[
  ...
  {
    title:"Epilogue — Beyond the Wall",
     episodes: [
      {
        title:"Episode 32",
        subscales:[{
      ...
      },
      {
        title:"Episode 33",
        subscales:[{
          label:"Looking Back Beyond the Wall",
  ...
  interface ThePromisedNeverlandQuizProps {
  onFinish: (sessionId:string) => void;
  onBack: () => void;
  demographics?:DemographicPayload
}
 
export default function ThePromisedNeverlandQuiz({ onFinish, onBack, demographics }: ThePromisedNeverlandQuizProps) {
