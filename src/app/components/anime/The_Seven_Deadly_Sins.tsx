...
const ANIME_SLUG = "the-seven-deadly-sins";
...
const THEME: ThemeTokens = {
  ...
  text:           'text-[#D92323]',
  subText:        'text-[#F6C753]',
  btnPrimary:     'bg-[#F6C753] text-[#140C1F] font-bold hover:bg-[#e0b445]',
  btnOutline:     'border-[#D92323]/30 text-[#D92323] hover:bg-[#D92323]/10',
  itemBg:         'bg-[#D92323]/5 border-[#D92323]/10',
  itemBgAnswered: 'bg-[#F6C753]/20 border-[#F6C753]/40',
  ratingSelected: 'bg-[#F6C753] text-[#140C1F] font-bold scale-105 shadow-lg shadow-yellow-900/40',
  ratingDefault:  'bg-[#D92323]/10 text-[#D92323] hover:bg-[#D92323]/20',
  headerBorder:   'border-[#D92323]/10',
  footerBorder:   'border-[#D92323]/10',
  labelColor:     'text-[#D92323]',
  accentColor:    '#F6C753',
...
export const SEVEN_DEADLY_IMAGES:Record<number,string> = {
0:"/images/The Seven Deadly Sins/SDS_Ban.png",
1:"/images/The Seven Deadly Sins/SDS_Ban_2.png",
2:"/images/The Seven Deadly Sins/SDS_Bartra_Lioness.png",
3:"/images/The Seven Deadly Sins/SDS_Chandler.png",
4:"/images/The Seven Deadly Sins/SDS_Cusack.png",
5:"/images/The Seven Deadly Sins/SDS_Derieri.png",
6:"/images/The Seven Deadly Sins/SDS_Diane_2.png",
7:"/images/The Seven Deadly Sins/SDS_Diane.png",
8:"/images/The Seven Deadly Sins/SDS_Dreyfus.png",
9:"/images/The Seven Deadly Sins/SDS_Drole.png",
10:"/images/The Seven Deadly Sins/SDS_Elizabeth_Lioness_2.png",
11:"/images/The Seven Deadly Sins/SDS_Elizabeth_Lioness.png",
12:"/images/The Seven Deadly Sins/SDS_Escanor.png",
13:"/images/The Seven Deadly Sins/SDS_Estarossa.png",
14:"/images/The Seven Deadly Sins/SDS_Fraudrin.png",
15:"/images/The Seven Deadly Sins/SDS_Galand.png",
16:"/images/The Seven Deadly Sins/SDS_Gilthunder_2.png",
17:"/images/The Seven Deadly Sins/SDS_Gilthunder.png",
18:"/images/The Seven Deadly Sins/SDS_Gloxinia.png",
19:"/images/The Seven Deadly Sins/SDS_Gowther_2.png",
20:"/images/The Seven Deadly Sins/SDS_Gowther.png",
21:"/images/The Seven Deadly Sins/SDS_Grayroad.png",
22:"/images/The Seven Deadly Sins/SDS_Griamore.png",
23:"/images/The Seven Deadly Sins/SDS_Hendrickson.png",
24:"/images/The Seven Deadly Sins/SDS_Howzer.png",
25:"/images/The Seven Deadly Sins/SDS_King_2.png",
26:"/images/The Seven Deadly Sins/SDS_King.png",
27:"/images/The Seven Deadly Sins/SDS_Ludociel.png",
28:"/images/The Seven Deadly Sins/SDS_Melascula.png",
29:"/images/The Seven Deadly Sins/SDS_Meliodas_2.png",
30:"/images/The Seven Deadly Sins/SDS_Meliodas.png",
31:"/images/The Seven Deadly Sins/SDS_Merlin.png",
32:"/images/The Seven Deadly Sins/SDS_Monspeet.png",
33:"/images/The Seven Deadly Sins/SDS_Nanatsu.png",
34:"/images/The Seven Deadly Sins/SDS_Veronica_Liones.png",
35:"/images/The Seven Deadly Sins/SDS_Zeldris.png"
...
function getEpisodeImage(title: string): string {
  ...
  return SEVEN_DEADLY_IMAGES[episodeNumber] ?? FALLBACK_IMAGE;
}
...
const CATALOG: Arc[] = [
  {
    title: 'Arc 1 — The Boar Hat Tavern',
    episodes: [
       {
        title: 'Episode 1',
        ...
        subscales: [
          {
            label: 'Secrets Behind the Tavern',
      ...
      },
      {
        ...
        subscales: [
          {
            label: 'The Knight Everyone Admires',
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items: [
      ...
      },
      {
        ...
        subscales: [
          {
            label: 'Cold Steel Under the Armour',
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items: [
      ...
      },
      {
        ...
        subscales: [
          {
            label: 'Companions at the Tavern',
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items: [
  ...
  {
    title:"Arc 2 — Gathering the Sins",
     episodes: [
 ...
 
  {
    title:"Episode 15",
    subscales:[{
      label:"Small Joys at the Tavern",
  ...
  {
    title:"Arc 3 — The Holy War Begins",
     episodes: [
      {
        title:"Episode 18",
        subscales:[{
          label:"Voices Across the Kingdom",
          items:[
 ...
 
      {
        title:"Episode 22",
        subscales:[{
          label:"The World Inside the Dream",
  ...
  {
   title:"Arc 4 — The Ten Commandments",
     episodes: [
      {
       title:"Episode 23",
       subscales:[{
      ...
      },
      {
        title:"Episode 25",
        subscales:[{
          label:"Seeing the Enemy’s Sorrow",
  ...
  {
   title:"Arc 5 — Captain and Companion",
     episodes: [
      {
        title:"Episode 26",
        subscales:[{
          label:"Weathering the Holy War",
      ...
      },
      {
        title:"Episode 28",
        subscales:[{
          label:"The Kingdom That Raised You",
  ...
  {
    title:"Arc 6 — The Final Battle",
    episodes:[
      
      {
        title:"Episode 31",
        subscales:[{
          label:"Riddles of the Old Sage",
          items:[
  ...
  {
    title:"Epilogue — After the Holy War",
     episodes: [
      {
        title:"Episode 32",
        subscales:[{
          label:"Drawn Into the Legend",
...
interface DemographicPayload {
  ...
  interface TheSevenDeadlySinsQuizProps {
  onFinish: (sessionId:string) => void;
  onBack: () => void;
  demographics?:DemographicPayload
}
 
export default function TheSevenDeadlySinsQuiz({ onFinish, onBack, demographics }: TheSevenDeadlySinsQuizProps) {
