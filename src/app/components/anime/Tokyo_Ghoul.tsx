...
const THEME: ThemeTokens = {
  ...
  text:           'text-[#FFFFFF]',
  subText:        'text-[#BA262B]',
  btnPrimary:     'bg-[#BA262B] text-white hover:bg-[#991B1F]',
  btnOutline:     'border-white/20 text-white hover:bg-white/5',
  itemBg:         'bg-white/5 border-white/10',
  itemBgAnswered: 'bg-[#BA262B]/20 border-[#BA262B]/40',
  ratingSelected: 'bg-[#BA262B] text-white scale-105 shadow-lg shadow-red-900/30',
...
export const TOKYO_IMAGES: Record<number, string> = {
  0: "/images/Characters/Tokyo_Ghoul/akira-mado.png",
  1: "/images/Characters/Tokyo_Ghoul/arata-kirishima.png",
  2: "/images/Characters/Tokyo_Ghoul/ayato-kirishima.png",
  3: "/images/Characters/Tokyo_Ghoul/donato-porpora.png",
  4: "/images/Characters/Tokyo_Ghoul/enji-koma.png",
  5: "/images/Characters/Tokyo_Ghoul/eto-yoshimura.png",
  6: "/images/Characters/Tokyo_Ghoul/furuta-nimura.png",
  7: "/images/Characters/Tokyo_Ghoul/ginshi-shirazu.png",
  8: "/images/Characters/Tokyo_Ghoul/hairu-ihei.png",
  9: "/images/Characters/Tokyo_Ghoul/hideyoshi-nagachika.png",
  10: "/images/Characters/Tokyo_Ghoul/hinami-fueguchi.png",
  11: "/images/Characters/Tokyo_Ghoul/itori.png",
  12: "/images/Characters/Tokyo_Ghoul/juuzou-suzuya.png",
  13: "/images/Characters/Tokyo_Ghoul/kanae-von-rosewald.png",
  14: "/images/Characters/Tokyo_Ghoul/kaya-irimi.png",
  15: "/images/Characters/Tokyo_Ghoul/ken-kaneki.png",
  16: "/images/Characters/Tokyo_Ghoul/kishou-arima.png",
  17: "/images/Characters/Tokyo_Ghoul/koutarou-amon.png",
  18: "/images/Characters/Tokyo_Ghoul/kuki-urie.png",
  19: "/images/Characters/Tokyo_Ghoul/kureo-mado.png",
  20: "/images/Characters/Tokyo_Ghoul/kurona-yasuhisa.png",
  21: "/images/Characters/Tokyo_Ghoul/matsumae.png",
  22: "/images/Characters/Tokyo_Ghoul/miza-kusakari.png",
  23: "/images/Characters/Tokyo_Ghoul/naki.png",
  24: "/images/Characters/Tokyo_Ghoul/nashiro-yasuhisa.png",
  25: "/images/Characters/Tokyo_Ghoul/nishiki-nishio.png",
  26: "/images/Characters/Tokyo_Ghoul/noko.png",
  27: "/images/Characters/Tokyo_Ghoul/renji-yomo.png",
  28: "/images/Characters/Tokyo_Ghoul/rio.png",
  29: "/images/Characters/Tokyo_Ghoul/rize-kamishiro.png",
  30: "/images/Characters/Tokyo_Ghoul/roma-haito.png",
  31: "/images/Characters/Tokyo_Ghoul/saiko-yonebayashi.png",
  32: "/images/Characters/Tokyo_Ghoul/seidou-takizawa.png",
  33: "/images/Characters/Tokyo_Ghoul/shuu-tsukiyama.png",
  34: "/images/Characters/Tokyo_Ghoul/tatara.png",
  35: "/images/Characters/Tokyo_Ghoul/tooru-mutsuki.png",
  36: "/images/Characters/Tokyo_Ghoul/touka-kirishima.png",
  37: "/images/Characters/Tokyo_Ghoul/ui-koori.png",
  38: "/images/Characters/Tokyo_Ghoul/uta.png",
  39: "/images/Characters/Tokyo_Ghoul/yoshimura.png",
  40: "/images/Characters/Tokyo_Ghoul/yukinori-shinohara.png",
};
...
function getEpisodeImage(title: string): string {
  ...
  return TOKYO_IMAGES[episodeNumber] ?? FALLBACK_IMAGE;
}
...
const CATALOG: Arc[] = [
  {
    title: 'Arc 1 — The Twentieth Ward',
    episodes: [
       {
        title: 'Episode 1',
        ...
        subscales: [
          {
            label: 'Things Hidden Behind the Mask',
      ...
      },
      {
        ...
        subscales: [
          {
            label: 'The One Everyone Watches',
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items: [
 ...
 
  {
    title:"Episode 15",
    subscales:[{
      label:"Small Joys of an Ordinary Day",
  ...
  },
  {
    title:"Episode 17",
    subscales:[{
      label:"Bonds That Keep You Whole",
    ...
    title:"Arc 3 — Aogiri Tree",
     episodes: [
 ...
 
      {
        title:"Episode 22",
        subscales:[{
          label:"The World Behind the Mask",
  ...
  {
   title:"Arc 5 — Mentor and Half-Ghoul",
     episodes: [
      {
        title:"Episode 26",
        subscales:[{
          label:"Getting Through the Nights",
  ...
  {
    title:"Arc 6 — The Final Mask",
    episodes:[
      
      {
        title:"Episode 31",
        subscales:[{
          label:"Riddles of the Investigator",
          items:[
  ...
  {
    title:"Epilogue — What Was Left Behind",
     episodes: [
      {
        title:"Episode 32",
        subscales:[{
      ...
      },
      {
        title:"Episode 33",
        subscales:[{
          label:"What the Story Left Behind",
  ...
  interface TokyoGhoulQuizProps {
  onFinish: (sessionId:string) => void;
  onBack: () => void;
  demographics?:DemographicPayload
}
 
export default function TokyoGhoulQuiz({ onFinish, onBack, demographics }: TokyoGhoulQuizProps) {
