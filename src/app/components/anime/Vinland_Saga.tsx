...
const THEME: ThemeTokens = {
  ...
  text:           'text-[#9E1616]',
  subText:        'text-[#D1C2A5]',
  btnPrimary:     'bg-[#D1C2A5] text-[#110D0D] font-bold hover:bg-[#b8a98f]',
  btnOutline:     'border-[#9E1616]/30 text-[#9E1616] hover:bg-[#9E1616]/10',
  itemBg:         'bg-[#9E1616]/5 border-[#9E1616]/10',
  itemBgAnswered: 'bg-[#D1C2A5]/20 border-[#D1C2A5]/40',
  ratingSelected: 'bg-[#D1C2A5] text-[#110D0D] font-bold scale-105 shadow-lg shadow-amber-900/40',
  ratingDefault:  'bg-[#9E1616]/10 text-[#9E1616] hover:bg-[#9E1616]/20',
  headerBorder:   'border-[#9E1616]/10',
  footerBorder:   'border-[#9E1616]/10',
  labelColor:     'text-[#9E1616]',
  accentColor:    '#D1C2A5',
...
export const VINLAND_IMAGES: Record<number, string> = {
  0: "/images/Characters/Vinland_Saga/arnheid.png",
  1: "/images/Characters/Vinland_Saga/asgeir.png",
  2: "/images/Characters/Vinland_Saga/askeladd.png",
  3: "/images/Characters/Vinland_Saga/atli.png",
  4: "/images/Characters/Vinland_Saga/bjorn.png",
  5: "/images/Characters/Vinland_Saga/canute.png",
  6: "/images/Characters/Vinland_Saga/einar.png",
  7: "/images/Characters/Vinland_Saga/floki.png",
  8: "/images/Characters/Vinland_Saga/helga.png",
  9: "/images/Characters/Vinland_Saga/leif-erikson.png",
  10: "/images/Characters/Vinland_Saga/olmar.png",
  11: "/images/Characters/Vinland_Saga/ragnar_2.png",
  12: "/images/Characters/Vinland_Saga/snake.png",
  13: "/images/Characters/Vinland_Saga/sweyn-forkbeard_2.png",
  14: "/images/Characters/Vinland_Saga/thorfinn.png",
  15: "/images/Characters/Vinland_Saga/thorkell.png",
  16: "/images/Characters/Vinland_Saga/thors.png",
  17: "/images/Characters/Vinland_Saga/torgil.png",
  18: "/images/Characters/Vinland_Saga/torgrim.png",
  19: "/images/Characters/Vinland_Saga/wulf.png",
  20: "/images/Characters/Vinland_Saga/ylva.png",
  21: "/images/Characters/Vinland_Saga/asgeir.png",
  22: "/images/Characters/Vinland_Saga/askeladd.png",
  23: "/images/Characters/Vinland_Saga/atli.png",
  24: "/images/Characters/Vinland_Saga/bjorn.png",
  25: "/images/Characters/Vinland_Saga/canute.png",
  26: "/images/Characters/Vinland_Saga/einar.png",
  27: "/images/Characters/Vinland_Saga/floki.png",
  28: "/images/Characters/Vinland_Saga/helga.png",
  29: "/images/Characters/Vinland_Saga/leif-erikson.png",
  30: "/images/Characters/Vinland_Saga/olmar.png",
  31: "/images/Characters/Vinland_Saga/ragnar_2.png",
  32: "/images/Characters/Vinland_Saga/snake.png",
  33: "/images/Characters/Vinland_Saga/sweyn-forkbeard_2.png",
  34: "/images/Characters/Vinland_Saga/thorfinn.png",
  35: "/images/Characters/Vinland_Saga/thorkell.png",
  36: "/images/Characters/Vinland_Saga/thors.png",
  37: "/images/Characters/Vinland_Saga/torgil.png",
  38: "/images/Characters/Vinland_Saga/torgrim.png",
  39: "/images/Characters/Vinland_Saga/wulf.png",
  40: "/images/Characters/Vinland_Saga/ylva.png",
};
...
function getEpisodeImage(title: string): string {
  ...
  return VINLAND_IMAGES[episodeNumber] ?? FALLBACK_IMAGE;
}
...
const CATALOG: Arc[] = [
  {
    title: 'Arc 1 — The Village of Iceland',
    episodes: [
       {
        title: 'Episode 1',
      ...
      },
      {
        ...
        subscales: [
          {
            label: 'The Warrior Everyone Follows',
            likert: {min: 1, max: 5, step: 1, type: "buttons", values:[{value: 1, label:"Strongly disagree"}, {value: 2, label:"Disagree" }, {value: 3, label:"Neutral"},{value: 4, label:"Agree"},{value:5, label:"Strongly Agree"}]},
            items: [
  ...
  {
    title:"Arc 2 — The Mercenary Band",
     episodes: [
  
      {
        ...
        subscales: [
          {
            label:"Dreaming of a Land Far West",
    ...
    },
    {
      title:"Episode 14",
      subscales:[{
        label:"Looking at the Man You Became",
        items:[
  ...
  {
    title:"Arc 3 — The English Campaign",
     episodes: [
      {
        title:"Episode 18",
        subscales:[{
          label:"Voices From Distant Shores",
          items:[
 ...
 
      {
        title:"Episode 22",
        subscales:[{
          label:"The World Beyond the Sea",
  ...
  {
   title:"Arc 4 — The Farmland Years",
     episodes: [
      {
       title:"Episode 23",
       subscales:[{
        label:"Laying Down an Old Grudge",
      ...
      },
      {
        title:"Episode 25",
        subscales:[{
          label:"Seeing the Enemy’s Wound",
  ...
  {
   title:"Arc 5 — Master and Slave",
     episodes: [
      {
        title:"Episode 26",
        subscales:[{
          label:"Weathering the Long Winter",
      ...
      },
      {
        title:"Episode 28",
        subscales:[{
          label:"The Village That Raised You",
      ...
      },
      {
        title:"Episode 29",
        subscales:[{
          label:"The One Who Won’t Leave the House",
  ...
  {
    title:"Arc 6 — The Last Battle",
    episodes:[
      
      {
        title:"Episode 31",
        subscales:[{
          label:"Riddles of the Old Man",
          items:[
  ...
  {
    title:"Epilogue — Toward Vinland",
     episodes: [
      {
        title:"Episode 32",
        subscales:[{
          label:"Drawn Into the Saga",
  ...
  interface VinlandSagaQuizProps {
  onFinish: (sessionId:string) => void;
  onBack: () => void;
  demographics?:DemographicPayload
}
 
export default function VinlandSagaQuiz({ onFinish, onBack, demographics }: VinlandSagaQuizProps) {
